          ...
          <div className="border border-white/10 bg-[#141414]/90 backdrop-blur-sm">
            ...
            <div className="px-6 pb-6 space-y-3">
              <div className="relative">
                ...
                <div className="relative flex justify-center text-[10px] uppercase font-mono"><span className="bg-[#141414] px-2 text-[#404040]">Or continue with</span></div>
              </div>

              <div className="grid grid-cols-2 gap-3">
                <a href={`${process.env.REACT_APP_BACKEND_URL || ''}/api/auth/github/login`}
                  className="flex items-center justify-center gap-2 bg-white/5 hover:bg-white/10 border border-white/10 py-2.5 text-[11px] font-mono text-[#A0A0A0] hover:text-white transition-all">
