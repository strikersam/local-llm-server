...
6. Update `AGENTS.md` (root or module-level) if the operating instructions changed.

## AGENTS.md Update Rules

Root `AGENTS.md` changes when:
- Key commands change
...
- [ ] AGENTS.md updated if operating instructions changed
