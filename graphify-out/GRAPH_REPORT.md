# Graph Report - autonomous-ai-agency  (2026-09-05)

## Corpus Check
- 1493 files · ~2,165,324 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 30212 nodes · 56444 edges · 1279 communities (1114 shown, 110 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 3327 edges (avg confidence: 0.92)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d3f86e61`
...
## Communities (1279 total, 110 thin omitted)

### Community 0 - "company_api.py"
Cohesion: 0.03
Nodes (124): account_lifecycle(), AccountLifecycleResponse, auto_recommend_skills(), cancel_onboarding(), create_company(), delete_company_endpoint(), _DoctorCheck, _DoctorReport (+116 more)

### Community 1 - "backend/server.py"
Cohesion: 0.02
Nodes (201): admin_seed(), AgentStatusEntry, AgentStatusResponse, AgentToolCallEntry, ApiKeyCreate, AuthorizeReposBody, BrainTestRequest, _build_agent_status_snapshot() (+193 more)

### Community 2 - "Task"
Cohesion: 0.03
Nodes (150): classify_domain(), agent/workflow.py — Persisted workflow state machine. Implements the Autonomous…, Return the best-matching domain for a task title+description., autonomy_tick(), Execute ONE pending task synchronously. Called by the cron workflow every 2…, Hand the 'connect & verify the repo' work to the agency's own agents. The task…, _seed_connect_task(), Task (+142 more)

### Community 3 - "test_llm_router_queue_cache.py"
Cohesion: 0.02
Nodes (86): int, Test hook — clear all usage accounting., reset(), CacheManager, cosine_similarity(), _Entry, LRUCache, payload_key() (+78 more)

### Community 4 - "proxy.py"
Cohesion: 0.03
Nodes (169): get_agency(), get_sam(), middleware, admin_control(), admin_create_key(), admin_create_user(), admin_delete_user(), admin_list_users() (+161 more)

### Community 5 - "SQLiteStore"
Cohesion: 0.02
Nodes (82): DetectedSystem, KnowledgeItem, Structured knowledge about the company, systems, or processes., A business system detected on a company's website or in their stack., Get the most confident evidence description., A company website with detected systems and stack inference., A company repository with detected technologies and metadata., Extract the owner from the full name. (+74 more)

### Community 6 - "TaskSpec"
Cohesion: 0.03
Nodes (137): kimi_bridge_runtime_config(), Return Kimi bridge config for external runtimes (Hermes, Goose, Aider). Returns…, AiderAdapter, Any, TaskResult, runtimes/adapters/aider.py — Aider adapter (TIER 3 — specialized). Aider…, Run aider non-interactively via `--message` flag., Adapter for Aider — TIER 3 specialized git-aware code editor. (+129 more)

### Community 7 - "test_ceo_dispatcher.py"
Cohesion: 0.04
Nodes (69): get_ceo_dispatcher(), Return the shared CEODispatcher singleton., Reset the singleton (test helper)., reset_ceo_dispatcher(), get_ceo_fallback_stats(), Increment the named counter (silently ignores unknown reasons)., Return a snapshot of the CEO fallback counters., Zero all CEO fallback counters (useful for testing). (+61 more)

### Community 8 - "ExecutionRequest"
Cohesion: 0.05
Nodes (44): Execute work through the 11-phase golden path., Called by APScheduler when a cron fires. Dispatches to the orchestrator. This…, _scheduler_on_fire(), workflow_orchestrator_execute(), OrchestratorSupervisor, Any, Emit an alert to the activity feed and log., Deterministic supervisor for the orchestrator. Runs as a background coroutine.… (+36 more)

### Community 9 - "api.js"
Cohesion: 0.01
Nodes (29): approveGovernanceRequest(), createMcpServer(), createQuickNote(), deleteMcpServer(), deleteModel(), denyGovernanceRequest(), downloadSeoExport(), exportSeoAudit() (+21 more)

### Community 10 - "TaskExecutionCoordinator"
Cohesion: 0.05
Nodes (48): _brain_is_configured(), _gate_outward_facing_enabled(), _is_brain_connection_error(), Any, BaseException, TaskSpec, One-line human explanation of why this task needs human approval. Reads risk…, Best-effort label of who will run this task once approved. Returns… (+40 more)

### Community 11 - "LLMRouter"
Cohesion: 0.03
Nodes (71): Attempt, count, describe(), The operator-facing reason string for an unfixable status., Read the environment variables named in ``env_names`` into a key list. Order is…, resolve_keys(), LLMRouter, Any (+63 more)

### Community 12 - "ImprovementLoop"
Cohesion: 0.06
Nodes (63): DetectedIssue, ImprovementLoop, ImprovementLoopState, IssueCategory, IssueSeverity, _now(), Any, Enum (+55 more)

### Community 13 - "AgentRunner"
Cohesion: 0.04
Nodes (54): AgentRunner, _check_extra_kwargs(), _enforce_signature(), Any, Path, Raise TypeError if fn's signature drifts from the locked contract (Pydantic…, Raise TypeError on unknown kwarg (runtime extra='forbid' for non-Pydantic…, Append an event to the durable session log if a store is wired in. (+46 more)
...
### Community 15 - "test_llm_router_strategies.py"
Cohesion: 0.06
Nodes (56): HealthConfig, Strategy selection and degradation behaviour., Circuit breaker + health tracking thresholds., RoutingConfig, HealthTracker, _Outcome, ProviderHealth, Any (+48 more)
...
Cohesion: 0.05
Nodes (43): normalise(), Collapse the volatile parts of *message* so recurrences group together. ``Task…, Stable dedup key over the *normalised* message., Find agent phases that started but never finished.…, signature_for(), summarise_phases(), Recurring operational failures must diagnose and file themselves. The gap these…, The reported scenario, end to end: four real timeouts, one incident. (+35 more)

### Community 18 - "tests/conftest.py"
Cohesion: 0.05
...
### Community 19 - "LLMRequest"
Cohesion: 0.02
Nodes (146): ProviderConfig, One configured endpoint. ``kind`` selects the adapter: ``openai`` (any OpenAI-…, packages/llm/providers/anthropic.py — Anthropic Messages API adapter. Anthropic…, classify_error(), LLMProvider, OpenAICompatible, ABC, Any (+138 more)

### Community 20 - "E2BSandboxSession"
Cohesion: 0.04
Nodes (75): MCPUnavailableError, agent/mcp_client.py — Async MCP client for the mcp-server Docker container.…, Raised when the MCP server is unreachable or the circuit is open., E2BSandboxSession, _inject_token(), maybe_attach_e2b(), Any, services/e2b_sandbox.py — E2B Firecracker micro-VM sandbox session. Implements… (+67 more)

### Community 21 - "test_ceo_micromanager.py"
Cohesion: 0.05
Nodes (86): _coerce_subtasks(), decompose(), _env_flag(), _env_int(), _extract_json_object(), fallback_decomposition(), MicroManagerConfig, next_tier() (+78 more)

### Community 22 - "brain_config.py"
Cohesion: 0.03
Nodes (85): _active_primary_provider(), BrainConfig, BrainConfigStore, default_brain_config(), is_north_mini_code_default(), provider_base_url(), _provider_env_value(), provider_key_rotation_enabled() (+77 more)

### Community 23 - "SelfHealingAgent"
Cohesion: 0.04
Nodes (68): FailureCategory, heal_signature(), HealingEvent, HealState, _now(), Any, Enum, str (+60 more)

### Community 24 - "AutonomyTracker"
Cohesion: 0.05
...
### Community 25 - "test_governance_sandbox.py"
Cohesion: 0.03
Nodes (84): events_from_identity(), Any, Convenience: build and record an event in one call., Extract the identity-derived audit fields from an AgentIdentity. Kept here…, record_event(), build_docker_run_argv(), detect_backend(), DockerBackend (+76 more)

### Community 26 - "test_governance_enforcement.py"
Cohesion: 0.05
Nodes (70): BudgetTracker, GovernanceGate, Holds live session budgets, bounded so it cannot leak. Sessions end without…, The one seam through which governed actions pass., AgentIdentity, _coerce_text(), new_session_id(), Any (+62 more)

### Community 27 - "PolicyEngine"
Cohesion: 0.04
Nodes (76): _egress_policy_reason(), Return why governance policy blocks *host*, or None. Runs strictly *after* the…, _action_matches(), _as_list(), Decision, GroupPolicy, _host_matches(), Mode (+68 more)

### Community 28 - "test_ceo_router.py"
Cohesion: 0.07
Nodes (44): build_ceo_router(), Any, APIRouter, backend/ceo_router.py — observability and manual control for the CEO. Surfaces…, Reject non-admin callers for routes that spend provider budget. Delegates to…, _require_admin(), _env_flag(), _env_int() (+36 more)

### Community 29 - "test_user_research_skill.py"
Cohesion: 0.04
...
### Community 30 - "RuntimeCapabilityRegistry"
Cohesion: 0.04
Nodes (38): Any, Return health status for all registered runtimes., Return routing decision audit log (newest first)., Actively wake every sleeping/circuit-open runtime. The default health service…, True if the runtime is healthy enough for the router to select it., Return cached health snapshot for a runtime (sync, non-blocking)., Return all registered runtimes with their cached health status., Return the active routing policy as a plain dict. (+30 more)
...
### Community 32 - "test_unit8_model_catalog.py"
Cohesion: 0.04
Nodes (77): Force a catalog mirror rebuild + persist (admin only). Rebuilds the catalog…, sync_catalog_route(), all_provider_ids(), _provider_ids_from_literal(), provider_key_present(), Return every provider id recognised by the brain config system. Iterates the…, True when the env var for *provider*'s key is set (or it's Ollama)., Return the provider ids allowed by the ``BrainProvider`` Literal. Reads the… (+69 more)

### Community 33 - "MongoDBStore"
Cohesion: 0.05
...
### Community 34 - "MCPClient"
Cohesion: 0.04
Nodes (37): MCPClient, Any, RuntimeError, Thin async MCP client with open/close circuit breaker. Thread-safe only within…, Full URL of the JSON-RPC endpoint this client posts to., Build the request headers shared by ``_rpc`` and ``notify``. ``Accept`` lists…, Propagate the calling agent's identity across the process boundary. The MCP…, Attach the agent identity whose actions this client executes. (+29 more)

### Community 35 - "services/seo_audit.py"
Cohesion: 0.05
Nodes (56): BaseModel, field_validator, A single occurrence of a check firing on a specific URL., Snapshot of one crawled page with the on-page facts the checks used., Aggregated report row - Screaming Frog CSV compatible., Site-level facts discovered during the crawl., An agent-delegable remediation work package derived from the findings. Findings…, Lightweight listing entry for past audits. (+48 more)
...
Cohesion: 0.07
Nodes (82): BrainFailoverExhausted, failover_chat_completion(), RuntimeError, Every provider in the failover chain failed — the terminal error. Carries the…, Run one chat completion across the brain-failover chain. Tries each healthy…, _free_tier(), _hit_ids(), _many_providers() (+74 more)

### Community 38 - "ToolRegistry"
Cohesion: 0.04
Nodes (45): get_tool_registry(), _infer_parameters_from_func(), Any, Path, Register a tool definition., Decorator to register a function as an agent tool. Usage::…, Remove a tool from the registry. Returns True if removed., Look up a tool by name. (+37 more)

### Community 39 - "loop.py"
Cohesion: 0.05
Nodes (55): loop.py — AgentRunner: plan → execute → verify loop with locked tool signatures., Governance seam: judge the call, run it, audit the outcome. Deliberately a thin…, Condense a tool result down to what belongs in an audit row. A tool result can…, # NOTE: "ollama_base" is kept for backwards compatibility; this runner only…, Feed LLM token/cost spend into the governance session budget. Kept separate…, Charge sub-agent nesting depth and enforce the ``max_depth`` ceiling. Isolates…, _summarise_tool_result(), _load() (+47 more)

### Community 40 - "test_brain_config_api.py"
Cohesion: 0.05
...
### Community 41 - "WorkspaceTools"
Cohesion: 0.04
Nodes (51): repowise.py — RepowiseIntelligence: context packing and dependency analysis., Path, tools.py — WorkspaceTools: read/write/search and diff application (risky…, Precise string replacement — F1 roadmap item (Codebuff/Claude Code-style edit).…, Return a previously saved memory value, or an empty string if absent., Persist a key/value pair to the user's profile store., Return the first *lines* lines of a file. Just-in-time retrieval: the executor…, Return a lightweight index of files with line counts and sizes. This is the… (+43 more)

### Community 42 - "CompanyGraphStore"
Cohesion: 0.03
Nodes (46): Company, The core company entity - root of the Company Graph., requires_db, Get a company by ID. Args: company_id: Company ID Returns: Company instance or…, Update a company. Args: company_id: Company ID **kwargs: Fields to update…, List companies with optional filtering. Args: owner_id: Filter by owner ID…, Initialize the service. Args: store: Optional CompanyGraphStore instance. If…, CompanyGraphStore (+38 more)

### Community 43 - "test_llm_router_resilience.py"
Cohesion: 0.03
Nodes (69): Backoff policy for retryable failures., RetryConfig, BreakerState, Enum, str, _digest(), KeyRing, KeyState (+61 more)

### Community 44 - "RenderOpsMonitor"
Cohesion: 0.06
...
### Community 45 - "test_model_router.py"
Cohesion: 0.03
...
### Community 47 - "AgentSessionStore"
Cohesion: 0.06
...
Cohesion: 0.04
Nodes (43): _accumulate_usage(), _assistant_messages(), _child_env(), _iter_events(), _kill_and_reap(), _message_text(), PrimeAgentAdapter, Any (+35 more)

### Community 50 - "get_db"
Cohesion: 0.03
Nodes (96): auth_me(), auto_recommend_skills(), brain_failover_status(), _check_storage_health(), cost_attribution_stats(), discover_remote_skills(), doctor_health(), get_active_provider() (+88 more)

### Community 51 - "BrainWatchdog"
Cohesion: 0.04
Nodes (60): get_brain_config_store(), Return the process-wide ``BrainConfigStore`` singleton., Any, packages/ai/self_heal.py — automatic brain self-healing. When the active brain…, Background tick that runs self_heal_brain_and_unblock_tasks(). Called from the…, One-shot self-healing pass. 1. Checks if the active brain provider is in a…, self_heal_brain_and_unblock_tasks(), _self_heal_tick() (+52 more)
...
### Community 53 - "test_mcp_registry.py"
Cohesion: 0.05
Nodes (47): get_mcp_client(), Return the module-level MCPClient. Reads MCP_SERVER_BASE_URL at call time (not…, _internal_configured(), list_specs(), MCPServerSpec, _not_dialable(), _playwright_configured(), _playwright_spec() (+39 more)

### Community 54 - "test_memory_guard.py"
Cohesion: 0.13
...
### Community 55 - "AnthropicProvider"
Cohesion: 0.04
...
### Community 56 - "AgentJobManager"
Cohesion: 0.03
Nodes (86): PreflightIssue, PreflightReport, BaseModel, AgentJob, AgentJobManager, make_isolated_workspace(), _now(), Any (+78 more)
...
### Community 58 - "test_agent_runner.py"
Cohesion: 0.05
Nodes (66): AgentPhaseError, Exception, Raised when a named agent phase (planning, verification, etc.) fails., AgentPlan, _make_runner(), MonkeyPatch, Path, A phase that hangs and is eventually cancelled, or errors outright, must still… (+58 more)

### Community 59 - "TokenBudget"
Cohesion: 0.05
...
### Community 60 - "agent/workspace.py"
Cohesion: 0.05
...
### Community 64 - "seo_portfolio_bridge.py"
Cohesion: 0.05
...
### Community 65 - "test_governance_api.py"
Cohesion: 0.07
Nodes (45): get_approval_store(), Replace the process-wide gate. Tests only., reset_gate(), _client(), parametrize, TestClient, Tests for the governance HTTP surface and the AgentRunner integration. The…, Policy is a git-reviewed file. An HTTP mutation route would make "who changed… (+37 more)

### Community 66 - "direct_chat.py"
Cohesion: 0.06
Nodes (58): DirectChatDoctor, Any, doctor.py — Agent-side doctor diagnostics: environment, provider, and workspace…, Translate technical preflight issues into a conversational assistant reply., translate_error_to_conversational(), AcceptedJob, AgentJobEnvelope, CompletedJob (+50 more)

### Community 67 - "RepowiseIntelligence"
Cohesion: 0.05
...
Cohesion: 0.06
Nodes (66): audit(), Append an audit log entry. Never logs raw secrets — only secret IDs / masked…, complete_wizard(), _delete_wizard_state(), detect_configured_providers(), detect_hardware_for_wizard(), detect_models_for_wizard(), _detect_ollama_models() (+58 more)

### Community 74 - "detector.py"
Cohesion: 0.06
...
### Community 75 - "_resolve_brain_provider"
Cohesion: 0.06
...
### Community 77 - "_FakeCommandResult"
Cohesion: 0.14
Nodes (6): _FakeAsyncSandboxClass, _FakeCommandResult, _FakeCommands, _FakeFiles, _FakeSandbox, Any

### Community 78 - "models/company_graph.py"
Cohesion: 0.02
Nodes (113): CompanyCreateRequest, CompanyGraphResponse, CompanyGraphSnapshot, CompanyUpdateRequest, Evidence, BaseModel, Company Graph - Canonical Core Model for the Autonomous AI Agency This module…, A point-in-time snapshot of a Company Graph for history and rollback. (+105 more)

### Community 79 - "workflow_orchestrator.py"
Cohesion: 0.08
...
### Community 82 - "get_task_store"
Cohesion: 0.06
Nodes (59): _purge_backlog_core(), Shared purge implementation for the admin endpoint and the boot hook., _blocked_retire_age_sec(), _heal_blocked_backlog(), _heal_brain_failover(), _heal_purge_backlog(), _heal_stuck_tasks(), _heal_task_duplicates() (+51 more)

### Community 83 - "validate_policy_text"
Cohesion: 0.04
Nodes (44): build_governance_router(), Any, APIRouter, backend/governance_router.py — read and operate the governance layer. Mounted…, Reject non-admin callers. Mirrors the RBAC check used elsewhere in this backend…, _require_admin(), _audit_proposal(), _baseline_loosened() (+36 more)

### Community 84 - "call_llm"
Cohesion: 0.04
Nodes (54): _agent_timeout_fallback_response(), _append_agent_session_message(), _build_auto_skill_guidance(), _build_direct_chat_schedule_suggestion(), _build_direct_chat_tags(), _build_direct_chat_task_suggestion(), _build_provider_router(), _builtin_provider_records() (+46 more)

### Community 85 - "V5App.jsx"
Cohesion: 0.05
Nodes (33): getActivity(), HubTabs(), Spinner(), ActivationGate(), activityToAlert(), AlertsBell(), priorityConfig, _relativeTime() (+25 more)
...
### Community 89 - "test_repo_connection.py"
Cohesion: 0.06
...
### Community 90 - "RenderMCPClient"
Cohesion: 0.05
Nodes (39): _as_list(), _coerce_payload(), Any, RuntimeError, packages/integrations/render_mcp.py — Render platform access over MCP. The…, Return tool output as Python data. MCP tool results arrive either as…, Normalise a tool payload into a list of dicts. Upstream tools variously return…, Unwrap a nested envelope such as ``{"service": {...}}`` when present. (+31 more)

### Community 91 - "test_procedural_memory.py"
Cohesion: 0.05
...
### Community 94 - "resolve_e2b_config"
Cohesion: 0.05
...
### Community 97 - "llm/router.py"
Cohesion: 0.02
Nodes (153): FailoverResult, A successful completion plus the accounting its callers need., get_budget(), packages/llm/budget.py — token and cost accounting with spend alerts. Tracks…, The process-wide budget tracker., get_cache(), packages/llm/cache.py — layered caching. Five independent layers, each with its…, The process-wide cache manager. (+145 more)
...
### Community 100 - "test_startup_warmup.py"
Cohesion: 0.04
...
### Community 101 - "OnboardingScreen.jsx"
Cohesion: 0.05
...
### Community 103 - "services/background.py"
Cohesion: 0.04
...
### Community 106 - "test_sam_voice.py"
Cohesion: 0.07
...
### Community 107 - "Platform Guide — the full tour"
Cohesion: 0.11
...
### Community 108 - "test_provider_router.py"
Cohesion: 0.06
...
### Community 109 - "test_colibri_provider.py"
Cohesion: 0.12
...
### Community 116 - "models/seo_audit.py"
Cohesion: 0.08
Nodes (25): models/seo_audit.py - SEO / GEO / AIO Audit Contracts Typed Pydantic models for…, Request to remediate auto-fixable findings in a local code repository., One concrete remediation performed (or proposed) by the fixer., Result of a fixer run., SeoFixAction, SeoFixRequest, SeoFixResult, _humanize_filename() (+17 more)

### Community 117 - "failover_client.py"
Cohesion: 0.04
Nodes (57): _auto_disable(), _build_request(), _describe_registry(), _disabled_ids(), _is_billing_refusal(), _is_ollama(), _key_pool(), _log_exhaustion() (+49 more)
...
### Community 119 - "test_web_reach.py"
Cohesion: 0.08
Nodes (47): get_web_reach(), _load_script_module(), Any, ModuleType, Response, agent/web_reach.py — Web Reach: zero-key internet access for agents. Gives…, Dynamically load a pure-stdlib helper module from .github/scripts/. Returns…, Zero-key internet access: pages, YouTube transcripts, search, RSS. Every public… (+39 more)
...
### Community 124 - "test_issue_intake.py"
Cohesion: 0.08
Nodes (47): _capability_tags(), create_task_from_oldest_open_issue(), intake_issue(), _issue_labels(), issue_source_id(), map_issue_to_task(), Any, Task (+39 more)

### Community 125 - "facade.py"
Cohesion: 0.09
...
### Community 126 - "tasks/api.py"
Cohesion: 0.06
Nodes (78): BackgroundTasks, add_comment(), approve_checkpoint(), approve_execution(), clarify_task(), create_task(), _current_user(), delete_task() (+70 more)

### Community 127 - "run_task"
Cohesion: 0.05
...
### Community 128 - "test_response_cache.py"
Cohesion: 0.10
...
### Community 134 - "FreeBuffAgent"
Cohesion: 0.08
Nodes (33): free_nvidia_models(), FreeBuffAgent, _nvidia_api_key(), Return the curated list of free NVIDIA NIM models FreeBuff may use., Codebuff-style coding agent pinned to free NVIDIA NIM models. FreeBuff is a…, List the free NVIDIA NIM models a user may pick (e.g. via Telegram)., True when *model* is in the curated free NVIDIA NIM set., Coerce *requested* to a free NVIDIA model. Returns *requested* when it is… (+25 more)

### Community 135 - "configuration-reference.md"
Cohesion: 0.08
...
### Community 136 - "FeatureMaturity"
Cohesion: 0.07
Nodes (23): __init__.py — Feature flag/matrix package., FeatureMaturity, FeatureUnavailableError, Enum, Exception, str, features/matrix.py — Feature maturity tiers and support matrix. Single source…, Feature maturity classification. (+15 more)

### Community 137 - "test_brain_failover.py"
Cohesion: 0.06
Nodes (47): ProviderHealth, Enum, Reset the singleton (for tests)., Circuit-breaker state for a provider., reset_failover_manager(), _clean_env(), _FakeAsyncClient, _FakeResponse (+39 more)
...
### Community 139 - "ChatResponse"
Cohesion: 0.07
Nodes (14): CerebrasProvider, Cerebras provider adapter — free, fast LLM (qwen-3-coder-480b)., GroqProvider, OllamaProvider, Ollama provider adapter — local LLM inference., Check health of all configured providers., ChatResponse, HealthStatus (+6 more)

### Community 140 - "AgentScheduler"
Cohesion: 0.06
...
### Community 143 - "WorkflowEngine"
Cohesion: 0.08
Nodes (46): approve(), build(), cancel(), _engine(), get_agent_team(), get_artifact_content(), get_events(), get_run() (+38 more)

### Community 144 - "ReactScratchpad"
Cohesion: 0.06
...
### Community 145 - "fmtErr"
Cohesion: 0.07
Nodes (26): chatSend(), fmtErr(), getAgentChatJob(), getDefaultBackendUrl(), getMe(), getSession(), listSessions(), login() (+18 more)

### Community 146 - "activation_api.py"
Cohesion: 0.09
...
Cohesion: 0.06
Nodes (34): _fake_artifact(), _make_engine(), tests/test_crispy_workflow.py — CRISPY workflow engine hardening tests. Tests…, Provide isolated DB + artifact + workspace paths., Create a WorkflowEngine with isolated storage., TestAbortOnFailure, TestPhaseSequence, TestPhaseSequenceError (+26 more)

### Community 150 - "portfolio_intelligence.py"
Cohesion: 0.06
Nodes (49): generate_backlog_retro(), generate_standup(), Agentic Agile — autonomous ceremonies (standup, retro, sprint planning). Where…, Derive a retrospective from the task tracker when no sprint is active. DONE /…, A daily standup digest derived from the task tracker. ``sprint_health`` is…, Build a :class:`StandupReport` from ``.claude/state/active-tasks.md``. Reads…, StandupReport, InitiativeStatus (+41 more)

### Community 151 - "useSafeData"
Cohesion: 0.05
Nodes (34): API, changeUserRole(), createApiKey(), createSchedule(), deleteApiKey(), pauseSchedule(), resumeSchedule(), setUserOnboarding() (+26 more)

### Community 152 - "clear_cooldowns"
Cohesion: 0.06
Nodes (48): clear_cooldowns(), get_dead_models(), _is_model_dead(), is_provider_on_cooldown(), mark_provider_failed(), Snapshot of active dead-model entries {provider_id/model: expiry_ts}. Also…, Put provider_id on cooldown for *cooldown_seconds* (default:…, Return True if provider_id is currently on cooldown. (+40 more)

### Community 153 - "test_trend_watcher.py"
Cohesion: 0.07
...
### Community 154 - "._log_event"
Cohesion: 0.11
Nodes (18): Path, PhaseType, WorkflowRun, Append an event to the workflow event log., Create a new WorkflowRun and begin pre-gate phase execution. The run is…, Return current WorkflowRun snapshot or None., Approve the plan — lifts the ApprovalGate and resumes execution. Raises…, Reject the plan — marks run as failed. (+10 more)

### Community 155 - "test_trend_scoping.py"
Cohesion: 0.10
...
### Community 156 - "TestHarnessAdapter"
Cohesion: 0.04
Nodes (28): get_harness_adapter(), harness_active(), harness_catalog(), Return orchestrator queue depth, active runs, and supervisor state (#522)., #522 + #505: Reliability startup — schedule hydration, orchestrator restore,…, Return the full ECC harness catalog with capabilities. Public — no auth…, Return the currently active ECC harnesses with session metrics. Authenticated —…, _startup_reliability_hooks() (+20 more)
...
Cohesion: 0.03
Nodes (104): allow_paid_brain(), BrainResolution, BrainConfigPatch, get_brain_config(), invalidate_brain_config_cache(), Convenience wrapper used by the agent loop + brain resolver., Convenience wrapper used by the admin API endpoints., Clear the singleton's cache (used by tests + brain_policy invalidation). (+96 more)
...
### Community 160 - "persist_plan_spec"
Cohesion: 0.07
...
### Community 161 - "ContextWindowManager"
Cohesion: 0.08
...
### Community 162 - "app_settings.py"
Cohesion: 0.11
Nodes (29): all_settings(), _as_bool(), _as_int(), ephemeral_ttl_hours(), ephemeral_ttl_hours_cached(), get_setting(), _maybe_schedule_refresh(), onboarding_gate_enabled() (+21 more)

### Community 163 - "lifespan"
Cohesion: 0.05
Nodes (30): _keepalive_self_ping(), lifespan(), Run the FreeBuff Telegram bot, restarting it on unexpected exit., Ping our own public URL so a free-tier web service doesn't sleep. Render free…, Start the Telegram bot (and keep-alive) inside the web process when enabled.…, _start_in_web_bot_tasks(), _telegram_bot_supervisor(), get_store() (+22 more)

### Community 164 - "ProvidersScreen.jsx"
Cohesion: 0.05
Nodes (29): createProvider(), deleteProvider(), getBrainProviders(), getLocalBrainState(), getProviderPolicy(), getRenderHealth(), getRenderOpsStatus(), postLocalBrainToggle() (+21 more)

### Community 165 - "test_slop_gate.py"
Cohesion: 0.07
...
### Community 166 - "_StubProvider"
Cohesion: 0.09
Nodes (26): _disable_unless_key_serves_other_models(), _models_to_try(), Order the models to attempt on *provider*, correcting a stale catalogue. Cache-…, Auto-disable *provider*, unless its key demonstrably serves other models. "No…, _mock_get(), _ok(), asyncio, A stale model catalogue must not be mistaken for a dead account.… (+18 more)

### Community 167 - "activation.py"
Cohesion: 0.08
...
### Community 170 - "TaskBoardScreen.jsx"
Cohesion: 0.05
...
### Community 171 - "probe_catalogues.py"
Cohesion: 0.11
Nodes (29): _auth_headers(), _chat_targets(), _dump_matching(), _kind(), list_models(), _list_or_report(), main(), _parse_args() (+21 more)

### Community 172 - "Workspace"
Cohesion: 0.05
Nodes (20): Any, Path, mcp_server/workspace.py — Isolated workspace manager for the MCP server. Each…, Run a shell command inside the workspace via an explicit shell binary., Resolve rel against root, reject path traversal., Run a subprocess. Never uses shell=True., Manages a single isolated workspace directory., Canonical root path (follows macOS /var → /private/var symlinks). (+12 more)

### Community 173 - "KeyPool"
Cohesion: 0.04
Nodes (42): provider_api_keys(), Every API key configured for *provider*, primary first. Reads ``base_env`` then…, api_keys_for(), _digest(), KeyPool, _KeyState, _PoolState, Per-provider API key rotation — the one lever that adds capacity. Every other… (+34 more)
...
### Community 175 - "test_pr923_fixes.py"
Cohesion: 0.07
...
### Community 176 - "StreamingDeltaReconstructor"
Cohesion: 0.07
...
### Community 177 - "RuntimeHealth"
Cohesion: 0.05
Nodes (61): Check whether Docker is available and report the adapter's runtime health.…, Health status snapshot for a runtime., Return a health snapshot. Must not raise; return available=False instead., RuntimeHealth, Return the last-known health for *runtime_id* (may be stale)., Return True if the runtime is available (not circuit-open)., Return health snapshots for all known runtimes., Force an immediate health check of all runtimes and return results. (+53 more)

### Community 178 - "pr_approval_gate.py"
Cohesion: 0.08
Nodes (32): _card_keyboard(), _card_text(), _dedupe_key(), default_run_sweep(), _gh_get(), _gh_token(), interval_sec(), load_notified() (+24 more)

### Community 179 - "test_telegram_freebuff.py"
Cohesion: 0.07
...
Cohesion: 0.06
Nodes (39): Browser admin UI for login, service control, key management, and diagnostics., Update or append a KEY=value line in the .env file., register_admin_gui(), _save_env_var(), get_output_filter(), Get or create the singleton OutputFilter instance., _check_rate_limit(), default_keys_path() (+31 more)
...
### Community 183 - "PromptCacheManager"
Cohesion: 0.06
...
### Community 185 - "_fixture"
Cohesion: 0.02
Nodes (109): parse_event_stream(), Reduce a ``--mode json`` NDJSON stream to a :class:`ParsedRun`. Kept a module-…, base_url(), mobile_page(), proxy_url(), Config, pytest_configure(), conftest.py — pytest fixtures and configuration for the E2E test suite.… (+101 more)

### Community 186 - "Usage"
Cohesion: 0.06
Nodes (31): AlertHandler, BudgetTracker, Counter, _Dimensions, _month(), Any, Register a callback fired when a spend threshold is crossed., Fold a new key into "other" once the dimension is at its cap. (+23 more)

### Community 187 - "test_audit.py"
Cohesion: 0.07
...
### Community 188 - "test_brain_resolver.py"
Cohesion: 0.12
...
### Community 190 - "cleanup_stale_jobs"
Cohesion: 0.08
Nodes (18): cleanup_stale_jobs(), _is_stale(), Any, packages/scheduler/cleanup.py — schedule deduplication + stale removal.…, Remove a job from the store. Returns True on success, False on failure. Logs…, Check if a created_at timestamp is older than ttl_seconds. Handles multiple…, Remove stale run-once + stuck agency jobs from the durable store. Args: store:…, _safe_remove() (+10 more)

### Community 191 - "ProviderRouter"
Cohesion: 0.09
Nodes (17): _get_director(), _normalized_provider_type(), ProviderAttempt, ProviderRouter, Any, Response, Try all models for one provider. Returns ProviderResult on success, None on…, Parse a 429/503 ``Retry-After`` header → seconds, or None. Accepts either… (+9 more)

### Community 192 - "InternalAgentAdapter"
Cohesion: 0.07
Nodes (26): _best_cloud_primary_base(), InternalAgentAdapter, TaskResult, Built-in agent loop — Nvidia NIM primary, Ollama fallback., Return runtime dependencies required by this adapter. Returns:…, Determine availability of the internal agent runtime. Checks cloud providers in…, Execute a TaskSpec using the internal AgentRunner and convert the agent's…, Create an isolated execution context for a single task. Tries ``git worktree… (+18 more)

### Community 193 - "test_classify_dependabot_update.py"
Cohesion: 0.08
...
### Community 197 - "test_brain_availability_doctor.py"
Cohesion: 0.11
Nodes (32): Drop the singleton (test helper)., reset_ceo_ledger(), _doctor(), _P, _patch_providers(), asyncio, Tests for the public brain-availability diagnosis and the supervisor's use of…, Minimal provider stand-in matching what the summary reads. (+24 more)

### Community 198 - "TrendWatcher"
Cohesion: 0.14
...
### Community 199 - "portfolio_api.py"
Cohesion: 0.08
...
### Community 200 - "Part A — CodeRabbit review fixes for this PR (do first, small)"
Cohesion: 0.05
...
### Community 201 - "Docker Agent Runtimes Setup"
Cohesion: 0.05
...
### Community 202 - "anthropic_compat.py"
Cohesion: 0.09
...
### Community 204 - "governance/audit.py"
Cohesion: 0.07
Nodes (23): packages/governance/audit.py — the evidence trail for every governed action.…, Redact secret-shaped substrings, then truncate., Recursively strip secrets from an arbitrary argument structure. Fails…, scrub(), _scrub_inner(), _scrub_text(), _truncate(), Per-session consumption counters and their ceilings. Ceilings come from the… (+15 more)

### Community 205 - "_payload"
Cohesion: 0.08
...
### Community 207 - "test_process_quick_note_workflow.py"
Cohesion: 0.06
...
### Community 208 - "emit_chat_observation"
Cohesion: 0.09
...
### Community 209 - "Persistent Memory System"
Cohesion: 0.05
...
### Community 210 - "resolve_component_model"
Cohesion: 0.06
...
### Community 211 - "test_portfolio_intake.py"
Cohesion: 0.09
...
### Community 212 - "NotificationDispatcher"
Cohesion: 0.03
Nodes (65): NotificationDispatcher, Any, Path, service_manager.py — Telegram & Notification Integration Extension Extends the…, Start the Telegram bot. Returns True if started successfully., Signal the bot to stop and wait for graceful shutdown., Run the Telegram bot long-poll loop (inline, not subprocess)., Run the bot with stop-event awareness. (+57 more)

### Community 213 - "test_bedrock_provider.py"
Cohesion: 0.06
...
### Community 214 - "WorkspaceManifest"
Cohesion: 0.08
...
### Community 215 - "Agent Readiness Report"
Cohesion: 0.20
...
### Community 218 - "ai/router.py"
Cohesion: 0.08
Nodes (25): _dead_model_key(), _exponential_backoff_cooldown(), _mark_model_dead(), _notify_watchdog(), provider_router.py — auto-generated module docstring (user-research skill scan)., Notify the brain watchdog of a provider call outcome (fire-and-forget).…, # NOTE: 429 and 410 are handled specially in _try_one_provider (immediate, Compute exponential backoff cooldown for repeated 429 failures. Each… (+17 more)

### Community 219 - "compare_runtimes.py"
Cohesion: 0.07
...
### Community 225 - "chat_handlers.py"
Cohesion: 0.10
Nodes (34): _apply_chat_defaults(), _emit_safely(), _extract_exact_output(), _filter_fragment(), _filter_openai_sse_line(), handle_ollama_native_chat(), handle_openai_chat_completions(), _inject_default_system_prompt() (+26 more)

### Community 226 - "TestEstimateTokensForMessages"
Cohesion: 0.05
...
### Community 230 - "SamAgent"
Cohesion: 0.11
Nodes (16): Any, SAM voice agent — the voice-controlled interface to the agency., Process a voice command and return SAM's spoken response. Args: text: The…, Public snapshot of live agency state (used by the LiveKit worker tools)., Gather live agency state for SAM's situational awareness., Call the NVIDIA NIM LLM (free tier) for SAM's response., Rule-based fallback when the LLM is unavailable., A single voice conversation session with SAM. (+8 more)
...
### Community 232 - "openclaw_gateway.py"
Cohesion: 0.09
...
### Community 233 - "_get_provider_policy"
Cohesion: 0.07
...
### Community 235 - "[Unreleased]"
Cohesion: 0.05
Nodes (38): Added, Added, Added, Added, Added, Added, Added, Added (+30 more)

### Community 236 - "test_daily_2026_06_04.py"
Cohesion: 0.10
...
### Community 237 - "admin.py"
Cohesion: 0.10
Nodes (8): AdminAuthManager, AdminSession, AdminSessionStore, _is_truthy(), admin_auth.py — auto-generated module docstring (user-research skill scan)., WindowsCredentialAuthenticator, patch, TestWindowsAuth

### Community 238 - "ServiceDaemon"
Cohesion: 0.07
Nodes (26): configure(), get_status(), health(), BaseModel, get, post, Validate configured paths., Check if proxy is running. (+18 more)

### Community 239 - "daily_digest.py"
Cohesion: 0.23
...
### Community 240 - "NIMConnectionPool"
Cohesion: 0.09
...
### Community 241 - "TestCatalogFable51"
Cohesion: 0.09
...
### Community 242 - "test_e2b_task_wiring.py"
Cohesion: 0.08
...
### Community 243 - "CEODispatcher"
Cohesion: 0.04
Nodes (77): CEODispatcher, CEOResult, _complexity_rank(), _decompose_into_subtasks(), _merge_changed_files(), _offload(), Any, Semaphore (+69 more)

### Community 244 - "ContextPruner"
Cohesion: 0.09
...
Cohesion: 0.08
Nodes (27): Contract: WorkflowEngine cannot skip the gate state machine., Contract: No code path may advance past awaiting_approval unless gate.status ==…, Create a run and manually place it in awaiting_approval., Contract: Cannot approve a run in 'pending' state., Contract: Can approve a run in 'awaiting_approval' state., Contract: Rejecting a run marks it as failed., TestApprovalGateMandatory, _make_engine() (+19 more)

### Community 246 - "AgileManager"
Cohesion: 0.09
...
### Community 247 - "test_control_plane_api.py"
Cohesion: 0.04
Nodes (38): agent/scheduler.py — Scheduled Agent Jobs Cron-based job scheduler. Each job…, set_scheduler(), create_schedule(), delete_schedule(), get_schedule(), get_schedule_runs(), list_schedules(), BaseModel (+30 more)

### Community 248 - "_Collection"
Cohesion: 0.11
...
### Community 250 - "test_implement_agent_routing.py"
Cohesion: 0.07
...
### Community 251 - "test_daily_2026_07_27.py"
Cohesion: 0.07
...
### Community 253 - "test_verification_strategies.py"
Cohesion: 0.11
...
### Community 254 - "agile_sprints.py"
Cohesion: 0.08
Nodes (24): _bullets(), generate_sprint_retro(), plan_next_sprint(), Render a :class:`Retrospective` as a markdown section., Derive retro notes for ``sprint`` from its current metrics. Records…, The result of allocating portfolio capacity into a new sprint., Render the sprint plan as markdown., Allocate ``capacity`` of WSJF-ranked initiatives into a new sprint. Creates one… (+16 more)

### Community 255 - "nvidia_models.py"
Cohesion: 0.09
...
### Community 257 - "output_filter.py"
Cohesion: 0.08
...
### Community 259 - "REWRITE_PLAN.md — Phased Migration Strategy"
Cohesion: 0.06
...
### Community 261 - "test_persistent_memory.py"
Cohesion: 0.06
...
### Community 262 - "AdaptiveHalter"
Cohesion: 0.08
Nodes (12): AdaptiveHalter, Any, ★7 Adaptive Loop Halting — velocity-based agent run termination. Complements…, Return current halter state for logging / telemetry., Tracks step-level progress and signals when a run should halt early. The halter…, Ratio of applied steps to steps attempted (0.0–1.0). Returns 1.0 when no steps…, Record one step outcome; return a halt reason or None to continue. ``status``…, Unit tests for agent.adaptive_halting.AdaptiveHalter. (+4 more)

### Community 263 - "SecurityScanner"
Cohesion: 0.11
...
### Community 264 - "autonomous_fix.py"
Cohesion: 0.14
Nodes (17): _decline(), _extract_pytest_failure(), _fetch_failure_context(), _list_target_prs(), main(), _post_comment(), _pr_head(), _prior_attempt_count() (+9 more)

### Community 265 - "test_phase4_runtime_resilience.py"
Cohesion: 0.15
...
### Community 267 - "test_all_providers_discovery.py"
Cohesion: 0.17
...
### Community 268 - "test_llm_router_e2e.py"
Cohesion: 0.06
Nodes (55): get_tracker(), The process-wide health tracker., get_ring(), The process-wide key ring., get_metrics(), The process-wide metrics registry., _ok(), parametrize (+47 more)

### Community 269 - "SpecEntry"
Cohesion: 0.11
...
### Community 270 - "report_to_markdown"
Cohesion: 0.11
...
### Community 271 - "agent_runtime.py"
Cohesion: 0.10
...
### Community 275 - "test_platform_controls.py"
Cohesion: 0.08
...
### Community 277 - "local_controller.py"
Cohesion: 0.12
...
### Community 278 - "skill_bindings.py"
Cohesion: 0.09
...
### Community 279 - "test_live_server.py"
Cohesion: 0.22
...
### Community 280 - "WindowsServiceManager"
Cohesion: 0.18
...
### Community 281 - "ContextCompressor"
Cohesion: 0.11
...
### Community 284 - "ResourceWatchdog"
Cohesion: 0.10
...
### Community 285 - "get_skill_registry_safe"
Cohesion: 0.10
Nodes (30): get_skill_registry_safe(), Return the global SkillRegistry if set, else None. Used by onboarding and other…, _DoctorCheck, _DoctorReport, get_doctor_diagnostics(), get_doctor_report(), get_public_doctor(), _in_container() (+22 more)

### Community 286 - "Configuration Reference"
Cohesion: 0.06
...
### Community 287 - "test_rate_limiter.py"
Cohesion: 0.09
...
### Community 288 - "RateLimitTracker"
Cohesion: 0.10
...
### Community 289 - "test_provider_render_env.py"
Cohesion: 0.09
...
### Community 290 - "test_microagents.py"
Cohesion: 0.15
...
### Community 291 - "Security Analysis — local-llm-server"
Cohesion: 0.06
...
### Community 292 - "Langfuse Observability Guide"
Cohesion: 0.06
...
### Community 298 - "test_nvidia_model_discovery.py"
Cohesion: 0.06
...
### Community 301 - "test_workspace_isolation.py"
Cohesion: 0.16
...
### Community 302 - "seo_api.py"
Cohesion: 0.07
Nodes (48): build_seo_roadmap(), delegate_seo_findings(), _expire_stale_pending_report(), export_seo_audit(), get_seo_audit(), list_seo_audits(), plan_seo_sprint(), BaseModel (+40 more)

### Community 303 - "SkillLibrary"
Cohesion: 0.11
...
### Community 306 - "High-Agency Frontend Skill"
Cohesion: 0.06
Nodes (30): 10. FINAL PRE-FLIGHT CHECK, 1. ACTIVE BASELINE CONFIGURATION, 2. DEFAULT ARCHITECTURE & CONVENTIONS, 3. DESIGN ENGINEERING DIRECTIVES (Bias Correction), 4. CREATIVE PROACTIVITY (Anti-Slop Implementation), 5. PERFORMANCE GUARDRAILS, 6. TECHNICAL REFERENCE (Dial Definitions), 7. AI TELLS (Forbidden Patterns) (+22 more)

### Community 307 - "LlmProviderConfig"
Cohesion: 0.16
...
### Community 308 - "TestNormalizeResponseFormat"
Cohesion: 0.11
...
### Community 309 - "Quick-Note GitHub Issues Processing - Session Summary"
Cohesion: 0.06
...
### Community 310 - "test_failover_silent_exhaustion.py"
Cohesion: 0.11
...
### Community 314 - "test_force_cleanup_conditional_delete.py"
Cohesion: 0.10
...
### Community 315 - "test_autonomy_gate.py"
Cohesion: 0.12
...
### Community 316 - "test_rag_context.py"
Cohesion: 0.12
...
### Community 317 - "ProjectScaffolder"
Cohesion: 0.28
Nodes (14): ProjectScaffolder, Apply named project templates to a target directory. Usage:: s =…, Path, Tests for agent/scaffolding.py — Project Scaffolding., test_apply_cli_tool(), test_apply_fastapi_service(), test_apply_overwrites_when_flag_set(), test_apply_python_library() (+6 more)

### Community 318 - "generate_context.py"
Cohesion: 0.12
...
### Community 323 - "test_claude_setup_audit.py"
Cohesion: 0.16
...
### Community 324 - "test_scheduler_hydration_bounded.py"
Cohesion: 0.09
...
### Community 325 - "OrchestratorQueue"
Cohesion: 0.07
...
### Community 326 - "test_internal_agent_did_work.py"
Cohesion: 0.12
...
### Community 327 - "test_mcp_governance.py"
Cohesion: 0.11
...
### Community 328 - "test_purge_backlog.py"
Cohesion: 0.09
Nodes (18): auth_headers(), FakeTaskStore, MonkeyPatch, tests/test_purge_backlog.py — 2026-07-03 crash-loop remediation. Covers: - POST…, Drive _maybe_boot_purge with fakes; return (purged, marker_writes). ``core``…, A failed purge must NOT record the nonce — it retries next boot., A PARTIAL purge (error markers inside the summary) must not record the nonce…, Minimal in-memory stand-in for tasks.store.TaskStore. (+10 more)

### Community 329 - "TestMCPClientStructuredOutput"
Cohesion: 0.13
Nodes (11): MCPToolResult, Result from ``call_tool_structured()``. ``structured`` is populated when the…, Prefer structured data; fall back to text when unavailable., asyncio, tests/test_daily_automation_2026_07_13.py — Daily automation tests…, Unit tests for agent.mcp_client.MCPToolResult., Tests for MCPClient.call_tool_structured() using an async mock., call_tool() (legacy) is unchanged. (+3 more)

### Community 330 - "TerminalPanel"
Cohesion: 0.13
...
### Community 331 - "Python Dependencies (`requirements.txt`)"
Cohesion: 0.07
...
### Community 332 - "Technical Debt Register — local-llm-server"
Cohesion: 0.07
...
### Community 333 - "model_discovery.py"
Cohesion: 0.15
Nodes (18): cached_models(), discover_models(), _fresh_entry(), _models_url(), _parse_ids(), Any, Ask a provider which models the configured API key may actually use.…, Return the cached list for *provider_id* without any network call. The… (+10 more)

### Community 334 - "FeatureEntry"
Cohesion: 0.09
...
### Community 335 - "SetupWizardPage.js"
Cohesion: 0.10
...
### Community 337 - "decide"
Cohesion: 0.12
Nodes (15): decide(), Decision, issue_number_from_branch(), main(), Return the issue number a context branch was generated for, if any., Decide how to recover the *issue* behind an orphaned draft PR. *issue* is the…, _issue(), parametrize (+7 more)

### Community 338 - "CostAttributor"
Cohesion: 0.10
...
### Community 339 - "test_agent_scripts_share_one_model_list.py"
Cohesion: 0.10
...
### Community 340 - "test_crispy_burn_in.py"
Cohesion: 0.07
...
### Community 341 - "test_e2b_data_flow.py"
Cohesion: 0.07
...
### Community 342 - "test_skill_registry_boot_refresh.py"
Cohesion: 0.12
...
### Community 347 - "Deploy: FreeBuff Telegram bot (24×7)"
Cohesion: 0.07
...
### Community 348 - "Claude Code + Qwen Local Setup"
Cohesion: 0.07
...
### Community 349 - "ProviderConsole.jsx"
Cohesion: 0.08
...
### Community 350 - "test_google_provider_models.py"
Cohesion: 0.18
...
### Community 351 - "traffic_director.py"
Cohesion: 0.11
Nodes (19): provider_max_parallel(), provider_max_tpm(), Return the operator-configured tokens/min cap for *provider*. Reads…, Return the operator-configured in-flight request cap for *provider*. Reads…, Return the configured traffic-distribution strategy (lower-cased). Reads…, routing_strategy(), active_strategy(), provider_id_of() (+11 more)

### Community 352 - "ApprovalStore"
Cohesion: 0.07
...
### Community 353 - "get_feature_matrix"
Cohesion: 0.08
...
### Community 356 - "isolated_telegram_config"
Cohesion: 0.11
...
### Community 357 - "_captured_request_headers"
Cohesion: 0.13
...
### Community 358 - "WorkspaceManager"
Cohesion: 0.06
...
### Community 361 - "test_phase6_workflow.py"
Cohesion: 0.13
...
### Community 362 - "VoiceCommandInterface"
Cohesion: 0.14
...
### Community 363 - "test_agent_free_brain.py"
Cohesion: 0.06
Nodes (31): livenim, is_anthropic_model(), True when *model* names a paid Anthropic/Bedrock-Claude model. Covers native…, Resolve the free NVIDIA NIM brain from env, or ``None`` if unconfigured.…, resolve_free_nvidia_brain(), _opus_model(), Return an Opus model ID iff the operator explicitly opted into a paid brain.…, _FakeAsyncClient (+23 more)

### Community 364 - "Performance Analysis — local-llm-server"
Cohesion: 0.08
...
### Community 365 - "SeoCheckDefinition"
Cohesion: 0.12
...
### Community 366 - "test_dashboard_cache.py"
Cohesion: 0.14
...
### Community 367 - "LLM Router — troubleshooting"
Cohesion: 0.08
...
### Community 368 - "control_registry.py"
Cohesion: 0.14
...
### Community 371 - "test_tasks_awaiting_approval_api.py"
Cohesion: 0.17
Nodes (23): quick_notes_submit(), _QuickNoteBody, Submit a quick-note URL or instruction from the dashboard FAB., Set the global task store instance (e.g., during app startup with MongoDB)., set_task_store(), _inmem_store(), Quick-notes must become real Tasks so agents pick them up. Previously a quick-…, test_quick_note_creates_task() (+15 more)

### Community 372 - "test_telegram_approval_e2e.py"
Cohesion: 0.12
...
### Community 373 - "test_brain_migration_writes_a_live_model.py"
Cohesion: 0.10
...
### Community 374 - "test_daily_automation_2026_08_03.py"
Cohesion: 0.11
...
### Community 375 - "test_provider_enable_disable.py"
Cohesion: 0.09
...
### Community 376 - "test_telegram_mutating_commands.py"
Cohesion: 0.08
...
### Community 384 - "implement_agent.py"
Cohesion: 0.12
Nodes (21): build_tool_calling_router(), main(), _nvidia_candidates(), _openai_tools_to_anthropic(), Any, Safely insert an entry under ## [Unreleased] without touching the rest of the…, Convert OpenAI function-calling tool schemas to Anthropic tool schemas., Run the implementation agent loop using Claude Opus via Anthropic SDK. Returns… (+13 more)

### Community 385 - "governance.py"
Cohesion: 0.11
...
### Community 387 - "test_north_mini_code.py"
Cohesion: 0.09
...
### Community 391 - "TestClassifyPlainText"
Cohesion: 0.08
...
### Community 392 - "test_service_token.py"
Cohesion: 0.08
...
### Community 397 - "Local AI Stack with Docker"
Cohesion: 0.08
...
### Community 398 - "Traffic Distribution Across Providers"
Cohesion: 0.14
...
### Community 399 - "Implementation Prompt: Rich TaskBoard + Agile Sprint Integration"
Cohesion: 0.08
...
### Community 400 - "Telegram Bot Setup"
Cohesion: 0.08
...
### Community 402 - "video_transcript.py"
Cohesion: 0.12
...
### Community 403 - "control_overrides.py"
Cohesion: 0.12
...
### Community 405 - "Native operations"
Cohesion: 0.09
...
### Community 406 - "CompanyAgencyService"
Cohesion: 0.09
Nodes (19): CompanyAgencyService, _is_runtime_available_sync(), _pick_available_runtime(), Any, SpecialistFamily, services/company_agency.py — Company Agency Orchestration Service After…, Orchestrates specialist activation, runtime startup, and 24x7 scheduling for a…, Return the best available runtime for a specialist family. Checks available… (+11 more)

### Community 407 - "test_regression.py"
Cohesion: 0.12
...
### Community 408 - "test_agency_fix.py"
Cohesion: 0.08
...
### Community 410 - "test_webui_provider_priority.py"
Cohesion: 0.11
Nodes (36): AdminIdentity, _bootstrap(), Path, ProviderManager, WorkspaceManager, tests/test_webui_provider_priority.py — Priority + reorder + brain-policy…, The /policy/brain endpoint must return the resolved brain + the paid policy…, The /providers/role-tags endpoint surfaces brain/sub/fallback roles consistent… (+28 more)

### Community 411 - "refine"
Cohesion: 0.17
...
### Community 412 - "_status_snapshot"
Cohesion: 0.15
...
### Community 413 - "Agent Governance Guide"
Cohesion: 0.09
...
### Community 414 - "The fifteen strategies"
Cohesion: 0.09
...
### Community 418 - "TestModelRegistryUpdates"
Cohesion: 0.14
...
### Community 420 - "analyze"
Cohesion: 0.12
Nodes (15): Analysis, analyze(), _classify(), _failure_table(), main(), Return the exhaustion :class:`Analysis` for a run's captured *output*., The verdict plus the human-readable justification behind it., Classify *text* with the repo's own classifier. Imported lazily:… (+7 more)

### Community 421 - "extract_failures"
Cohesion: 0.21
...
### Community 422 - "SyntheticDataPipeline"
Cohesion: 0.13
...
### Community 423 - "brain_failover.py"
Cohesion: 0.06
Nodes (54): brain_providers(), Every configured provider with its health AND its on/off state. Powers the…, auto_disable(), _billing_signals(), disabled_provider_ids(), packages/llm/disabled.py — bridge to the durable provider on/off switch. The…, Provider ids currently switched off. Empty when the store is unreachable., Persist a provider as disabled, through the store that already owns it. (+46 more)

### Community 424 - "test_all_features.py"
Cohesion: 0.09
Nodes (9): TestActivity, TestCompany, TestDashboard, TestDoctor, TestOnboarding, TestSecrets, TestSetup, TestTasks (+1 more)

### Community 425 - "test_cerebras_catalogue.py"
Cohesion: 0.13
...
### Community 426 - "test_monitor_lib.py"
Cohesion: 0.11
...
### Community 428 - "test_mostly_failed_steps.py"
Cohesion: 0.12
...
### Community 430 - "test_telegram_task_callback.py"
Cohesion: 0.12
Nodes (15): _Captured, Load telegram_bot fresh in each test, with env vars reset., telegram_bot(), _parked_task(), asyncio, Task, Telegram inline-button callbacks for the task pre-execution gate. Regression:…, A non-admin tapping Approve must get a modal (show_alert), not silence.… (+7 more)

### Community 431 - "HarnessEnrichment"
Cohesion: 0.14
...
### Community 432 - "classify_direct_chat_intent"
Cohesion: 0.13
...
### Community 433 - "AdaptivePermissions"
Cohesion: 0.29
Nodes (13): AdaptivePermissions, agent/permissions.py — Adaptive Permission Classifier Reads the session…, Infer permission level from a list of chat messages (session transcript).…, _msgs(), Tests for agent/permissions.py — Adaptive Permissions., test_assessment_as_dict(), test_confidence_increases_with_more_signals(), test_full_access_from_risky_signals() (+5 more)

### Community 434 - "._connect"
Cohesion: 0.10
...
### Community 435 - "test_prompt_injection_boundary.py"
Cohesion: 0.15
Nodes (20): build_compaction_prompt(), build_execution_prompt(), build_planning_prompt(), build_tool_prompt(), build_verification_prompt(), Any, prompts.py — Prompt builders for planner, executor, and verifier roles., tests/test_prompt_injection_boundary.py — untrusted-content trust boundary.… (+12 more)

### Community 436 - "CoworkSession"
Cohesion: 0.16
Nodes (3): CoworkSession, A shared AI coding session with multiple human contributors. Manages turn-…, TestCoworkSession

### Community 437 - "LocalBrainStore"
Cohesion: 0.16
...
### Community 438 - "Artifact"
Cohesion: 0.09
Nodes (29): AgentRole, When coder == reviewer model, swarm should log a warning., TestSlice, workflow/artifact_store.py — Durable artifact persistence. Artifacts are stored…, _extract_slices_from_plan(), workflow/engine.py — WorkflowEngine: CRISPY phase sequencer. The engine is the…, Extract slice definitions from a plan.md artifact. Looks for sections matching:…, Reset the singleton (test helper). (+21 more)

### Community 439 - "Harness"
Cohesion: 0.14
...
### Community 440 - "DecisionsStore"
Cohesion: 0.30
Nodes (3): DecisionsStore, Any, Connection

### Community 441 - "TestRouterIntegration"
Cohesion: 0.31
...
### Community 443 - "open_phase_report"
Cohesion: 0.10
...
### Community 444 - "TestLegacyRouterCacheTTL"
Cohesion: 0.13
...
### Community 445 - "test_anthropic_refusal_fallback.py"
Cohesion: 0.19
...
### Community 446 - "test_portfolio_intelligence.py"
Cohesion: 0.10
...
### Community 447 - "test_telegram_diag_endpoint.py"
Cohesion: 0.09
...
### Community 449 - "test_issue_triage.py"
Cohesion: 0.17
...
### Community 451 - "V3 API Migration Plan — LLM Relay Platform"
Cohesion: 0.10
...
### Community 453 - "system_instruction"
Cohesion: 0.06
...
### Community 458 - "run_trend_analysis"
Cohesion: 0.18
...
### Community 459 - "test_unit5_ui_provider_surface.py"
Cohesion: 0.10
...
### Community 462 - "PersistentMemoryStore"
Cohesion: 0.24
...
### Community 463 - "Skill: modularity-review"
Cohesion: 0.10
...
### Community 464 - "Design Audit"
Cohesion: 0.10
Nodes (19): Code Quality, Color and Surfaces, Component Patterns, Content, Design Audit, Fix Priority, How This Works, Iconography (+11 more)

### Community 465 - "Findings"
Cohesion: 0.10
...
### Community 469 - "Docker AI Governance Audit — Final Report"
Cohesion: 0.10
...
### Community 470 - "1. Capability-by-capability"
Cohesion: 0.10
...
### Community 472 - "Dynamic Model Routing"
Cohesion: 0.10
...
### Community 474 - "ControlsScreen.jsx"
Cohesion: 0.15
...
### Community 475 - "PortfolioScreen.jsx"
Cohesion: 0.11
...
### Community 479 - "ProviderCircuit"
Cohesion: 0.13
Nodes (11): CircuitState, ProviderCircuit, Enum, Attempt to move from OPEN to HALF_OPEN after recovery timeout., Check if a request can be made through this circuit., Per-provider circuit breaker state machine., TestProviderCircuit, parametrize (+3 more)
...
### Community 483 - "TaskDispatcher"
Cohesion: 0.08
Nodes (24): Background dispatcher for task execution., Re-queue BLOCKED tasks that have cooled down and are ready for retry., Polls for queued task work and executes it through the coordinator. Crash…, Re-queue tasks stranded by a prior crash or hard-kill., TaskDispatcher, _make_task(), asyncio, Task (+16 more)

### Community 484 - "PerformanceAnalytics"
Cohesion: 0.12
...
### Community 486 - "test_tasks_cache_ttl_env.py"
Cohesion: 0.21
...
### Community 487 - "test_voice_pipeline.py"
Cohesion: 0.14
...
### Community 490 - "test_connector_registry.py"
Cohesion: 0.12
...
### Community 491 - "_extract_tech_relevance"
Cohesion: 0.17
...
### Community 495 - "Skill: fabric-patterns"
Cohesion: 0.11
...
### Community 496 - "Analysis & Synthesis Instructions"
Cohesion: 0.11
Nodes (18): 1. Define the Atmosphere, 2. Map the Color Palette, 3. Establish Typography Rules, 4. Define the Hero Section, 5. Describe Component Stylings, 6. Define Layout Principles, 7. Define Responsive Rules, 8. Encode Motion Philosophy (+10 more)

### Community 497 - "Production Readiness Assessment — local-llm-server"
Cohesion: 0.11
...
### Community 498 - "_ensure_tasks_source_id_unique_index"
Cohesion: 0.14
...
### Community 499 - "Skill: fabric-patterns"
Cohesion: 0.11
Nodes (18): 1. Ensure Pattern Directory Exists, 2. List Available Patterns, 3. Retrieve a Pattern, 4. Apply a Pattern with Variables, 5. Stitch Patterns Together, 6. Create New Patterns, Acceptance Checks, Directory Structure (+10 more)

### Community 500 - "db/__init__.py"
Cohesion: 0.14
...
### Community 501 - "Admin Dashboard Guide"
Cohesion: 0.11
...
### Community 502 - "Implementation Plan"
Cohesion: 0.11
...
### Community 504 - "Delegation Plan (agent-ready work packages)"
Cohesion: 0.11
...
### Community 505 - "test_p0_roadmap_a4_a5_b2.py"
Cohesion: 0.15
...
### Community 506 - "build_workflow.py"
Cohesion: 0.33
Nodes (18): _c(), _get(), _header(), main(), _make_headers(), _phase_icon(), _post(), _print_phases() (+10 more)

### Community 507 - "context_plan_gate.py"
Cohesion: 0.16
Nodes (17): evaluate(), evaluate_path(), main(), _parse_args(), PlanDecision, Namespace, Path, Did the planner actually retrieve the source it reasoned about? (+9 more)

### Community 508 - "run_bot"
Cohesion: 0.12
Nodes (18): _configure(), _default(), main(), Set an env var only when the operator hasn't already provided one., get_webhook_info(), Any, Call a Telegram Bot API method and return the parsed JSON (best-effort).…, Fetch Telegram's live getWebhookInfo, distilled to the fields that diagnose a… (+10 more)

### Community 509 - "test_brain_patch_service_token.py"
Cohesion: 0.18
...
### Community 510 - "TestSelfHealingInfrastructureClassification"
Cohesion: 0.19
...
### Community 511 - "test_fabric_patterns.py"
Cohesion: 0.11
...
### Community 513 - "test_schedule_persistence.py"
Cohesion: 0.15
...
### Community 514 - "validate_session_id"
Cohesion: 0.16
...
### Community 515 - "ErrorInterceptorMiddleware"
Cohesion: 0.18
...
### Community 520 - "Comprehensive Skill Index (By Category)"
Cohesion: 0.11
...
### Community 521 - "Agent Skill: Principal UI/UX Architect & Motion Choreographer (Awwwards-Tier)"
Cohesion: 0.11
Nodes (17): 1. Meta Information & Core Directive, 2. THE "ABSOLUTE ZERO" DIRECTIVE (STRICT ANTI-PATTERNS), 3. THE CREATIVE VARIANCE ENGINE, 4. HAPTIC MICRO-AESTHETICS (COMPONENT MASTERY), 5. MOTION CHOREOGRAPHY (FLUID DYNAMICS), 6. PERFORMANCE GUARDRAILS, 7. EXECUTION PROTOCOL, 8. PRE-OUTPUT CHECKLIST (+9 more)

### Community 522 - "Component Map"
Cohesion: 0.11
...
### Community 524 - "test_minimax_bug_fixes.py"
Cohesion: 0.13
...
### Community 525 - "Architecture Overview — local-llm-server"
Cohesion: 0.11
...
### Community 526 - "Pending Activities — Implementation Playbook"
Cohesion: 0.11
...
### Community 528 - "Part A — Health Report"
Cohesion: 0.11
...
### Community 529 - "get_skill_bindings"
Cohesion: 0.10
Nodes (24): build_matrix(), _families(), main(), Any, Map family -> sorted list of test files that mention it (quoted token)., Return one row per family, derived entirely from code., render_markdown(), _test_evidence_index() (+16 more)

### Community 530 - "agency_fix.py"
Cohesion: 0.20
...
### Community 531 - "sync_readme_gallery.py"
Cohesion: 0.22
...
### Community 532 - "test_p0_roadmap_b3_b4_b5.py"
Cohesion: 0.16
Nodes (9): _deep_merge(), Deep merge two dicts. Override values take precedence., get_synthetic_pipeline(), Return the module-level SyntheticDataPipeline singleton., A single instruction/response pair for fine-tuning., Convert to Alpaca format: {instruction, input, output}., TrainingSample, TestDeepMerge (+1 more)

### Community 533 - "OrchestratorCheckpointStore"
Cohesion: 0.10
...
### Community 534 - "Any"
Cohesion: 0.22
Nodes (5): Any, Add a step result. Returns the sample if accepted, None if filtered out., Bulk-add samples from an agent session's step results. Each step result with…, Return pipeline statistics., Convert to ShareGPT format: {conversations: [{from, value}]}.

### Community 535 - "LocalLLMSetup"
Cohesion: 0.16
...
### Community 536 - "test_company_api.py"
Cohesion: 0.11
...
### Community 537 - "test_langfuse_agency_wide.py"
Cohesion: 0.12
...
### Community 538 - "TestStopSlopChecker"
Cohesion: 0.11
...
### Community 539 - "test_llm_router_disabled.py"
Cohesion: 0.19
Nodes (18): is_unfixable(), Whether this failure needs a human rather than a retry. Two shapes qualify. A…, _ok(), parametrize, The router must honour the durable provider on/off switch (ADR-008).…, The operator's off-switch has to mean something to the router., Turning everything off must fail loudly, not quietly route anyway., Only a human can fix these — a self-healing breaker would retry forever. (+10 more)

### Community 540 - "test_telegram_webhook.py"
Cohesion: 0.14
...
### Community 541 - "handle_workflow_ide_chat"
Cohesion: 0.18
...
### Community 545 - "_mock_provider_records"
Cohesion: 0.14
...
### Community 546 - "SKILL: Industrial Brutalism & Tactical Telemetry UI"
Cohesion: 0.12
...
### Community 547 - "Skill: data-quality-audit"
Cohesion: 0.12
...
### Community 548 - "What "Slop" Looks Like"
Cohesion: 0.12
...
### Community 549 - "local_brain_router.py"
Cohesion: 0.19
...
### Community 551 - "Section-by-Section Acceptance Criteria"
Cohesion: 0.12
...
### Community 553 - "provider_max_rpm"
Cohesion: 0.17
...
### Community 554 - "redact_connection_url"
Cohesion: 0.17
...
### Community 555 - "agent_readiness_audit.py"
Cohesion: 0.21
...
### Community 558 - "TestAListingFailureDoesNotVetoTheAnswer"
Cohesion: 0.17
...
### Community 559 - "test_daily_automation_2026_07_11.py"
Cohesion: 0.15
...
### Community 560 - "test_frontend_deployment_guards.py"
Cohesion: 0.18
...
### Community 561 - "test_health_endpoints.py"
Cohesion: 0.17
...
### Community 562 - "test_keepalive.py"
Cohesion: 0.18
...
### Community 563 - "test_openclaw_endpoints.py"
Cohesion: 0.12
...
### Community 566 - "test_skill_registry.py"
Cohesion: 0.13
...
### Community 567 - "cowork_session.py"
Cohesion: 0.15
...
### Community 568 - "hermes_prompt.py"
Cohesion: 0.19
...
### Community 570 - "MemoryMiddleware"
Cohesion: 0.17
...
### Community 574 - "Skill: repowise-intelligence"
Cohesion: 0.12
...
### Community 575 - "ARCHITECTURE.md — Target Architecture"
Cohesion: 0.12
...
### Community 576 - "_valid_login_state"
Cohesion: 0.24
...
### Community 577 - "Skill: repowise-intelligence"
Cohesion: 0.12
Nodes (15): 1. Graph Intelligence (Dependency Graph), 2. Git Intelligence, 3. Documentation Intelligence, 4. Decision Intelligence, Acceptance Checks, Directory Structure, Example Usage, Implementation Approach (+7 more)

### Community 578 - "The 10-Step Workflow"
Cohesion: 0.12
...
### Community 579 - "Nothing is blocked on an agent. Two things need a human."
Cohesion: 0.12
...
### Community 580 - "Contributing to local-llm-server"
Cohesion: 0.12
...
### Community 581 - "run"
Cohesion: 0.19
Nodes (13): CreateIssue, build_body(), _failures(), find_tracking_issue(), _gh_ops(), main(), Reconcile the probe summary to exactly one tracking issue. Returns an action…, Split a probe summary into (unreachable providers, unservable models).… (+5 more)

### Community 582 - "refresh_agent_built_proof.py"
Cohesion: 0.20
...
### Community 583 - "CEO Micro-Management"
Cohesion: 0.12
...
### Community 584 - "467 Brutal Audit — File-by-File Status"
Cohesion: 0.12
...
### Community 585 - "Runbook — Apply the Fast Free NVIDIA Brain to Render (TASK 2)"
Cohesion: 0.12
...
### Community 586 - "operational_incidents.py"
Cohesion: 0.12
Nodes (17): gather_render_evidence(), get_operational_incident_tracker(), _iso_from_monotonic(), agent/operational_incidents.py — recurring operational failures, auto-…, Pull recent Render logs and summarise them for the issue body. This is the…, Current UTC wall-clock as an ISO-8601 string., Best-effort wall-clock for a monotonic timestamp taken earlier., Return the shared tracker, creating it on first use. (+9 more)

### Community 587 - "test_task_pre_execution_gate.py"
Cohesion: 0.26
...
### Community 588 - "test_task_source_id_race.py"
Cohesion: 0.17
...
### Community 592 - "test_telegram_auto_approve.py"
Cohesion: 0.21
...
### Community 593 - "ManagedAgentDreams"
Cohesion: 0.22
...
### Community 594 - "test_agency_workflows_carry_the_failover_chain.py"
Cohesion: 0.18
...
### Community 597 - "test_dockerfile_ships_root_modules.py"
Cohesion: 0.17
...
### Community 598 - "test_local_brain_state.py"
Cohesion: 0.12
...
### Community 599 - "DailyDigestAggregatorTests"
Cohesion: 0.19
...
### Community 600 - "TestNoNvidiaFallbackIsRetired"
Cohesion: 0.09
...
### Community 601 - "test_phase5_doctor.py"
Cohesion: 0.08
...
### Community 602 - "test_refresh_agent_built_proof.py"
Cohesion: 0.12
...
### Community 604 - "ensure_self_company"
Cohesion: 0.08
Nodes (38): autonomy_status(), Public autonomy readiness probe — no authentication required. A live deploy…, Fire-and-forget self-bootstrap; never blocks or crashes startup., _schedule_self_bootstrap(), get_company_agency_service(), Get the singleton CompanyAgency service instance., Delete a company and all its associated data. The store only clears the…, Stop schedules and remove the registered agents for a company. Best-effort: a… (+30 more)
...
### Community 606 - "CollaborationContext"
Cohesion: 0.17
...
### Community 607 - "Skill: agent-harness"
Cohesion: 0.13
...
### Community 608 - "Skill: checkpoint-strategy"
Cohesion: 0.13
...
### Community 610 - "Skill: local-ai-query"
Cohesion: 0.13
...
### Community 611 - "Skill: parallel-agents"
Cohesion: 0.13
...
### Community 612 - "Skill: parallel-worktrees"
Cohesion: 0.13
...
### Community 613 - "Design System: Taste Standard"
Cohesion: 0.13
...
### Community 616 - "Skill: user-research"
Cohesion: 0.13
...
### Community 617 - "Agency Core — Progress & Resume Log"
Cohesion: 0.13
...
### Community 618 - "Attention Mechanisms Internals"
Cohesion: 0.13
...
### Community 621 - "_push_down_where"
Cohesion: 0.14
...
### Community 625 - "ClaudeCodeAdapter"
Cohesion: 0.19
...
### Community 626 - "test_task_self_repo_auto_commit.py"
Cohesion: 0.16
Nodes (15): coordinator(), _mock_gh(), parametrize, tests/test_task_self_repo_auto_commit.py — TaskExecutionCoordinator._build_spec…, A task with company_id set must go through the existing E2B company-repo…, Task types not in the ship-code set (e.g. "custom_research") must NOT get…, SELF_REPO_AUTO_COMMIT_ENABLED=false is the rollback lever — even with valid…, If no GitHub repo/token is configured, the task must stay report-only rather… (+7 more)
...
### Community 629 - "TestBrainConfigUpdates"
Cohesion: 0.22
...
### Community 630 - "DecisionsStoreTests"
Cohesion: 0.11
...
### Community 631 - "test_dockerfile_ships_config_dir.py"
Cohesion: 0.14
...
### Community 633 - "WebsiteScanner"
Cohesion: 0.04
Nodes (69): main(), Returns (url, ok, summary)., _scan_one(), _is_safe_url(), _looks_like_bot_challenge(), Any, BeautifulSoup, Replicates builtwith.builtwith() data-driven logic natively using the… (+61 more)

### Community 634 - "_TFIDFIndex"
Cohesion: 0.16
...
### Community 635 - "KnowledgeScreen.jsx"
Cohesion: 0.13
Nodes (15): createWikiPage(), deleteSource(), getCompanyGraph(), ingestSource(), actorColors, AddSourceForm(), buildGraphElements(), CompanyGraphPanel() (+7 more)

### Community 636 - "StopSlopChecker"
Cohesion: 0.14
...
### Community 638 - "Skill: lr-schedule-advisor"
Cohesion: 0.14
...
### Community 642 - "Checks Performed"
Cohesion: 0.14
...
### Community 643 - "Skill: training-stability-monitor"
Cohesion: 0.14
...
### Community 644 - "admin_digest_router.py"
Cohesion: 0.22
...
### Community 645 - "Skill: branch-cleanup"
Cohesion: 0.14
...
### Community 646 - "Skill: perplexity — Web Research via Perplexity API"
Cohesion: 0.14
...
### Community 649 - "Quick-Note Issues Processing Summary"
Cohesion: 0.14
...
### Community 650 - "Implementation Plan — DB-persisted, UI-switchable Brain (no redeploy)"
Cohesion: 0.14
...
### Community 652 - "Render MCP — autonomous platform debugging and environment monitoring"
Cohesion: 0.14
...
### Community 653 - "Runbook: Auto-Resume After Cooldown / Interruption"
Cohesion: 0.14
...
### Community 654 - "SEO / GEO / AIO Audit Engine"
Cohesion: 0.14
...
### Community 656 - "overrides"
Cohesion: 0.14
Nodes (14): @tootallnate/once, overrides, bfj, css-select, http-proxy-agent, jsonpath, nth-check, postcss (+6 more)

### Community 657 - "SkillsScreen.jsx"
Cohesion: 0.12
Nodes (13): autoRecommendCompanySkills(), deleteCompany(), discoverRemoteSkills(), listCompanies(), listCompanySkills(), CompaniesPanel(), SkillsScreen, CATEGORY_COLORS (+5 more)

### Community 658 - "PersistentQueue"
Cohesion: 0.19
...
### Community 659 - "_parse_reset_epoch"
Cohesion: 0.21
...
### Community 661 - "AppShell.jsx"
Cohesion: 0.13
Nodes (11): getAccountLifecycle(), AppShell(), MOBILE_PRIMARY, NAV_ITEMS, EphemeralBanner(), formatRemaining(), ALIASES, APP_LABEL (+3 more)

### Community 662 - "TestBrainFailoverBackoff"
Cohesion: 0.23
...
### Community 665 - "test_critical_flows.py"
Cohesion: 0.29
...
### Community 666 - "TestAnthropicToolListCaching"
Cohesion: 0.34
...
### Community 667 - "test_openclaw_gateway.py"
Cohesion: 0.14
...
### Community 668 - "test_provider_state_durability.py"
Cohesion: 0.04
Nodes (22): fake_mongo(), _FakeCollection, _FakeDb, isolated_state(), _live_mongo_url(), Operator provider state must survive a redeploy. The per-provider kill switch…, Tests must never mutate a shared operational store., The storage layer's localhost default is a placeholder, not config. Treating it… (+14 more)

### Community 669 - "_override_user"
Cohesion: 0.25
...
### Community 671 - "test_tasks_reconciler_todo_requeue.py"
Cohesion: 0.20
...
### Community 674 - "Skill: Brain Dump"
Cohesion: 0.15
...
### Community 677 - "Skill: duplicate-thread"
Cohesion: 0.15
...
### Community 678 - "Skill: Email Triage"
Cohesion: 0.15
...
### Community 681 - "Skill: graphify — Knowledge Graph Token Optimization"
Cohesion: 0.15
...
### Community 682 - "Skill: prompt-library"
Cohesion: 0.15
...
### Community 683 - "Skill: prompt-transparency"
Cohesion: 0.15
...
### Community 685 - "Skill: scope-guard"
Cohesion: 0.15
...
### Community 688 - "test_daily_automation_2026_07_09.py"
Cohesion: 0.16
...
### Community 690 - "Skill: graphify — Knowledge Graph Token Optimization"
Cohesion: 0.15
Nodes (12): Acceptance Checks, Claude's query protocol (use this instead of Read tool for exploration):, Graph Artifacts — What to Commit, How to Use the Graph (Token Savings Protocol), Installation (one-time per machine), Instead of reading raw files:, Key commands:, Relationship to repowise-intelligence Skill (+4 more)

### Community 691 - "Skill: platform-setup — Autonomous Agency Bootstrap"
Cohesion: 0.15
...
### Community 692 - "Device compatibility and model picks"
Cohesion: 0.15
...
### Community 693 - "Autonomy Uplift — Living Roadmap & Detailed Implementation Specs"
Cohesion: 0.15
...
### Community 694 - "OpenClaw — iOS Control of the Agency (Single-Service Free-Tier Deploy)"
Cohesion: 0.15
...
### Community 695 - "BrainCard.jsx"
Cohesion: 0.19
Nodes (11): getBrainConfig(), patchBrainConfig(), testBrainModel(), BrainCard(), errText(), PROVIDER_LABEL_FALLBACK, providerLabel(), ROLE_LABELS (+3 more)
...
### Community 697 - "ApplyReviewAgent"
Cohesion: 0.22
...
### Community 699 - "_is_bedrock_model_id"
Cohesion: 0.27
...
### Community 701 - "Agent Transparency Report"
Cohesion: 0.15
...
### Community 702 - "update_provider_policy"
Cohesion: 0.19
...
### Community 704 - "clear_wizard_state_cache"
Cohesion: 0.21
...
### Community 706 - "TestAgentRunnerSafety"
Cohesion: 0.19
...
### Community 708 - "TestDecisionsBotLinks"
Cohesion: 0.17
...
### Community 709 - "test_deploy_trigger_covers_image.py"
Cohesion: 0.21
...
### Community 710 - "test_ai_insights.py"
Cohesion: 0.20
...
### Community 711 - "TestKillSwitchDurability"
Cohesion: 0.15
...
### Community 712 - "test_quick_note_engine.py"
Cohesion: 0.17
...
### Community 713 - "test_freebuff_bot.py"
Cohesion: 0.11
Nodes (18): _embedded(), _embedded_run(), _fb_models(), _fb_run(), _freebuff_max_steps(), Return the free model list (embedded or via proxy)., Execute a FreeBuff task (embedded or via proxy). Shape: {result: {...}}., Run FreeBuffAgent in-process against a fresh clone, committing + opening a PR.… (+10 more)

### Community 714 - "validate_job_id"
Cohesion: 0.19
...
### Community 715 - "skill_registry.py"
Cohesion: 0.17
...
### Community 717 - "AGENTS.md — Codebase Map & Operations Reference"
Cohesion: 0.07
...
### Community 722 - "Skill: system-prompt-audit"
Cohesion: 0.17
...
### Community 723 - "Skill: task-alive-updates"
Cohesion: 0.17
...
### Community 726 - "platform_controls_router.py"
Cohesion: 0.10
...
### Community 727 - "Skill: agent-browser — Real Chrome Browser Automation"
Cohesion: 0.17
...
### Community 730 - "Skill: dev-browser — Browser Automation via Sandboxed JS"
Cohesion: 0.17
...
### Community 732 - "Main proxy (`proxy.py`)"
Cohesion: 0.14
...
### Community 733 - "Agent Orchestration Design"
Cohesion: 0.17
...
### Community 734 - "Universality: case-coverage matrix"
Cohesion: 0.17
...
### Community 735 - "Workspace Isolation Architecture"
Cohesion: 0.17
...
### Community 741 - "is_anthropic_base_url"
Cohesion: 0.18
...
### Community 744 - "Kimi Web-Bridge Service"
Cohesion: 0.17
...
### Community 745 - "test_admin_local_brain_router.py"
Cohesion: 0.29
...
### Community 746 - "test_agile_api.py"
Cohesion: 0.17
...
### Community 747 - "test_app_settings.py"
Cohesion: 0.21
...
### Community 748 - "test_brain_default_consistency.py"
Cohesion: 0.24
...
### Community 749 - "TestBrainFailoverModelUpdates"
Cohesion: 0.18
...
### Community 752 - "test_task_clarification.py"
Cohesion: 0.17
...
### Community 755 - "_extractive_compress"
Cohesion: 0.18
...
### Community 756 - "test_llm_router_tpm.py"
Cohesion: 0.06
Nodes (43): estimate_tokens(), FitResult, message_tokens(), prune(), Any, packages/llm/context.py — keeping conversations inside the context window. The…, Truncate oversized tool results and drop exact duplicate turns. Tool results…, Keep system messages, the first turn, and the newest turns that fit. Returns… (+35 more)

### Community 758 - "Instructions"
Cohesion: 0.18
...
### Community 759 - "Skill: pro-workflow"
Cohesion: 0.18
...
### Community 762 - "Skill: resource-panel"
Cohesion: 0.18
...
### Community 763 - "Skill: sandboxed-exec"
Cohesion: 0.18
...
### Community 765 - "ECC Harness Patterns Skill"
Cohesion: 0.18
...
### Community 768 - "Stop-Slop Quality Skill"
Cohesion: 0.18
...
### Community 769 - "Agency Core — Ruthless Architecture Audit & Migration Plan"
Cohesion: 0.18
...
### Community 770 - "AUTONOMY_CHARTER.md"
Cohesion: 0.18
...
### Community 771 - "Tailored Onboarding, Editable Companies & Dynamic Roles"
Cohesion: 0.18
...
### Community 772 - "Issue #467 — Section 1: Pulled State + PR Inventory"
Cohesion: 0.18
...
### Community 773 - "Autonomy Charter — Telegram-Gated Self-Running Agency"
Cohesion: 0.18
...
### Community 774 - "Context: Agentic Agile + Portfolio Management"
Cohesion: 0.18
...
### Community 775 - "Deploy to Google Cloud Run"
Cohesion: 0.18
...
### Community 777 - "Sampling Strategies Internals"
Cohesion: 0.18
...
### Community 778 - "LLM Router — architecture"
Cohesion: 0.18
...
### Community 779 - "Killer TODO Roadmap — local-llm-server"
Cohesion: 0.18
...
### Community 780 - "NVIDIA NIM — Free Tier Setup"
Cohesion: 0.18
...
### Community 781 - "What to clean up"
Cohesion: 0.18
...
### Community 782 - "Worker Service — Operations Runbook"
Cohesion: 0.18
...
### Community 783 - "test_bedrock_live.py"
Cohesion: 0.25
...
### Community 785 - "CheckRun"
Cohesion: 0.18
Nodes (5): TestCheckRun, Trigger verification for all applied-but-unverified slices., CheckRun, Any, Structured, execution-based verification result. Verifier agents produce ONLY…

### Community 786 - "run_proxy.sh"
Cohesion: 0.18
...
### Community 787 - "OperationalIncident"
Cohesion: 0.24
...
### Community 789 - "test_conftest_hermetic_env.py"
Cohesion: 0.18
...
### Community 790 - "test_empirical_verify.py"
Cohesion: 0.49
...
### Community 794 - "SavingsTracker"
Cohesion: 0.12
Nodes (9): filter_output(), get_savings_summary(), Any, agent/output_filter.py — LLM Output Compression & Token Savings Inspired by…, Convenience function: filter command output., Get token savings summary., Track cumulative token savings across filtering operations., One-line summary of savings (rtk gain style). (+1 more)
...
### Community 796 - "Protocol: Premium Utilitarian Minimalism UI Architect"
Cohesion: 0.20
...
### Community 797 - "The 5-Step Wrap-Up Ritual"
Cohesion: 0.20
...
### Community 798 - "admin_local_brain_router.py"
Cohesion: 0.22
...
### Community 799 - "_normalize_tool_choice"
Cohesion: 0.31
...
### Community 800 - "Agent: Reviewer (Verifier)"
Cohesion: 0.20
...
### Community 801 - "Skill: Agentic Agile"
Cohesion: 0.20
...
### Community 802 - "Skill: browserbase-ui-test — Adversarial UI Testing"
Cohesion: 0.20
...
### Community 803 - "Skill: financial-analyst (Agentic CFO)"
Cohesion: 0.20
...
### Community 804 - "Graphiti Temporal Context Skill"
Cohesion: 0.20
...
### Community 805 - "Skill: seo-audit-report"
Cohesion: 0.20
...
### Community 806 - "ADR-008: LLMRouter — the single multi-provider routing gateway"
Cohesion: 0.20
...
### Community 808 - "467 Golden Path — Locked Implementation Order"
Cohesion: 0.20
...
### Community 809 - "LLM Router — configuration guide"
Cohesion: 0.20
...
### Community 810 - "LLM Router — provider guide"
Cohesion: 0.20
...
### Community 811 - "CI Troubleshooting Runbook"
Cohesion: 0.20
...
### Community 812 - "capture_screens.py"
Cohesion: 0.29
...
### Community 813 - "build_tech_db.py"
Cohesion: 0.40
...
### Community 816 - "_resolve_push_token"
Cohesion: 0.17
...
### Community 819 - "kimi_bridge_provider_config"
Cohesion: 0.18
...
### Community 820 - "TestZeroAttemptDiagnostics"
Cohesion: 0.29
...
### Community 821 - "test_agent_chat_integration.py"
Cohesion: 0.23
...
### Community 822 - "TestSessionMemory"
Cohesion: 0.20
...
### Community 823 - "test_model_catalog_guard.py"
Cohesion: 0.29
...
### Community 825 - "mint_access_token"
Cohesion: 0.18
...
### Community 827 - "settings.py"
Cohesion: 0.08
Nodes (21): Groq provider adapter — free, fast LLM (deepseek-r1-distill-llama-70b)., NVIDIA NIM provider adapter — wraps the existing provider_router logic. This is…, packages.ai — provider abstraction, model registry, and failover manager., ProviderManager, Any, packages/ai/manager.py — ProviderManager. Single entry point for all LLM calls.…, Coordinates provider selection, failover, and health., Return providers sorted by priority (lowest = highest priority). (+13 more)

### Community 828 - "synthesize"
Cohesion: 0.36
...
### Community 831 - "_extract_workflow_relevance"
Cohesion: 0.33
...
### Community 833 - "Skill: changelog-enforcer"
Cohesion: 0.22
...
### Community 834 - "Skill: learn-rule"
Cohesion: 0.22
...
### Community 836 - "prompts/README.md"
Cohesion: 0.22
Nodes (4): Command: /resume, References, Usage, What It Does

### Community 837 - "Skill: Agentic Portfolio Management"
Cohesion: 0.22
...
### Community 838 - "Skill: changelog-enforcer"
Cohesion: 0.22
Nodes (8): Acceptance Checks, Changelog Location, Entry Format, Examples, Hook Behaviour, Instructions, Skill: changelog-enforcer, When to Use

### Community 839 - "Skill: cowork-session (Claude Cowork)"
Cohesion: 0.22
Nodes (8): Branch, Components, Purpose, Quick Start, Session Roles, Skill: cowork-session (Claude Cowork), Testing, When to Use

### Community 840 - "Skill: video-context — read a video without watching it"
Cohesion: 0.22
...
### Community 841 - "Active Task Tracker"
Cohesion: 0.22
...
### Community 843 - "ADR 003: Multi-Agent Orchestration with Plan-Execute-Verify Loop"
Cohesion: 0.22
...
### Community 844 - "Autonomous SDLC Loop (Agency Core, repo-agnostic)"
Cohesion: 0.22
...
### Community 845 - "The 8-Step Golden Path"
Cohesion: 0.22
...
### Community 846 - "Issue #1356: quick-note:https://searchengineland.com/turn-seo-backlog-into-roadmap-485713"
Cohesion: 0.22
...
### Community 847 - "PR #634 Implementation Tracker"
Cohesion: 0.22
...
### Community 848 - "KV Cache Internals"
Cohesion: 0.22
...
### Community 849 - "Platform Controls"
Cohesion: 0.22
...
### Community 850 - "Release Procedure"
Cohesion: 0.22
...
### Community 851 - "V2.0 Modernization — Runbook"
Cohesion: 0.22
...
### Community 857 - "TestModelsEndpointAliases"
Cohesion: 0.31
...
### Community 858 - "test_changelog_parity_guard.py"
Cohesion: 0.22
...
### Community 860 - "AgentsScreen.jsx"
Cohesion: 0.18
Nodes (12): createAgent(), AgentCard(), AgentsScreen(), BUILTIN_AGENT_DEFS, CEOCyclePanel(), mapBackendAgent(), NewAgentForm(), PIPELINE_MODES (+4 more)

### Community 861 - "TestGithubSignalHardening"
Cohesion: 0.22
...
### Community 867 - "CompanyGraph"
Cohesion: 0.03
Nodes (38): BusinessCategory, detect_company_id(), detect_repo_id(), DirectChatSession, handle_chat_message_with_context(), Direct chat session with Company Graph context binding., Bind a company to this chat session and load its Company Graph., Bind a repository to this chat session. (+30 more)

### Community 869 - "_score_turns"
Cohesion: 0.36
...
### Community 872 - "TestPoliciesGovernanceStableClaim"
Cohesion: 0.20
...
### Community 873 - "quality_checker.py"
Cohesion: 0.32
...
### Community 875 - "Competitor Analysis — Autonomous AI Agency"
Cohesion: 0.20
...
### Community 876 - "service_token.py"
Cohesion: 0.25
Nodes (8): _get_hashed_token(), _hash_token(), Request, services/service_token.py — Backend service-token authentication. Roadmap item…, FastAPI dependency: reject unauthenticated or non-admin callers. Use as::…, SHA-256 hash the plaintext token. We compare hashes (not plaintext) so the in-…, Return the hashed service token, or None if SERVICE_TOKEN is unset. Caches the…, require_service_token()

### Community 877 - "Agent: Implementer (Executor)"
Cohesion: 0.25
Nodes (8): Activation, Agent: Implementer (Executor), Constraints, Handoff, Preferred Model, Responsibilities, Role, Shared State

### Community 878 - "Agent: Judge (Release / QA Gate)"
Cohesion: 0.25
Nodes (7): Activation, Agent: Judge (Release / QA Gate), Enforcement, Output, Responsibilities, Role, Verdict Meanings

### Community 879 - "Agent: Planner (Architect)"
Cohesion: 0.25
Nodes (8): Activation, Agent: Planner (Architect), Failure Behaviour, Handoff, Output Format, Preferred Model, Responsibilities, Role

### Community 880 - "Skill: browserbase-browser — Real Browser Automation"
Cohesion: 0.25
...
### Community 887 - "Advisor Strategy — Local Proxy Handling"
Cohesion: 0.25
...
### Community 888 - "ceo-micromanagement.md"
Cohesion: 0.25
Nodes (4): P0 behavior change, Readiness contract, Runtime model, Runtime types

### Community 889 - "Feature Maturity / Support Matrix"
Cohesion: 0.25
...
### Community 892 - "Free NVIDIA brain + UI-controlled provider policy + no silent spend"
Cohesion: 0.25
...
### Community 893 - "Issue #362: Nvidia repo setup"
Cohesion: 0.25
...
### Community 894 - "Issue #364: quick-note:https://www.marktechpost.com/2026/06/01/meet-memory-os-a-6-layer-open-source-memory-stack-built-on-top-of-hermes-agent/"
Cohesion: 0.25
...
### Community 895 - "Issue #378: quick-note:https://www.marktechpost.com/2026/06/02/tinyfish-launches-bigset-an-open-source-multi-agent-system-that-builds-structured-live-datasets-from-plain-english-descriptions/"
Cohesion: 0.25
...
### Community 896 - "Issue #379: quick-note:https://searchengineland.com/schema-markup-optimize-agentic-web-479080"
Cohesion: 0.25
...
### Community 897 - "Issue #380: quick-note:https://cursor.com/blog/cloud-agent-lessons"
Cohesion: 0.25
...
### Community 898 - "Issue #381: quick-note:https://www.xda-developers.com/claude-code-with-opus-48-is-expensive-but-i-made-it-efficient-with-my-local-ai-workflow/"
Cohesion: 0.25
...
### Community 899 - "Issue #382: quick-note:https://claude.com/blog/how-coderabbit-used-claude-to-build-an-agent-orchestration-system"
Cohesion: 0.25
...
### Community 900 - "Issue #383: quick-note:https://www.marktechpost.com/2026/05/29/hexo-labs-open-sources-sia-a-self-improving-agent-that-updates-both-the-harness-and-the-model-weights/"
Cohesion: 0.25
...
### Community 901 - "Issue #416: feat: Self-hosted Codebuff (freebuff) on free NVIDIA models + Telegram bot phone control"
Cohesion: 0.25
...
### Community 902 - "Issue #485: [Trend Digest] Week of 2026-06-08"
Cohesion: 0.25
...
### Community 903 - "Issue #488: quick-note:https://github.com/cookiy-ai/user-research-skill"
Cohesion: 0.25
...
### Community 904 - "Issue #491: Implement whatever is necessary from https://github.com/BehiSecc/awesome-claude-skills"
Cohesion: 0.25
...
### Community 905 - "Issue #493: Use the https://github.com/mvanhorn/last30days-skill skill to get the trend updated"
Cohesion: 0.25
...
### Community 906 - "Issue #495: Read https://www.anthropic.com/news/claude-fable-5-mythos-5 and understand if mythos or fable can be added to the repo"
Cohesion: 0.25
...
### Community 907 - "Issue #504: EPIC: Autonomy hardening — live-verified defects 2026-06-10"
Cohesion: 0.25
...
### Community 908 - "Issue #581: Sprint tracker: pending work after brand rename + mobile-first pass"
Cohesion: 0.25
...
### Community 910 - "Issue #657: quick-note:https://github.com/earendil-works/pi"
Cohesion: 0.25
...
### Community 911 - "Issue #659: quick-note:https://github.com/nex-agi/Nex-N2"
Cohesion: 0.25
...
### Community 912 - "Issue #660: quick-note:https://github.com/getsentry/sentry-for-ai"
Cohesion: 0.25
...
### Community 913 - "Issue #661: quick-note:https://github.com/XiaomiMiMo/MiMo-Code"
Cohesion: 0.25
...
### Community 914 - "Issue #664: quick-note:https://github.com/Grominet95/jarvis-OS"
Cohesion: 0.25
...
### Community 915 - "Issue #666: quick-note:https://github.com/porokka/jarvis-os"
Cohesion: 0.25
...
### Community 916 - "Issue #670: quick-note:https://github.com/perplexityai/bumblebee"
Cohesion: 0.25
...
### Community 917 - "Issue #672: quick-note:https://github.com/Chachamaru127/claude-code-harness"
Cohesion: 0.25
...
### Community 918 - "Issue #676: quick-note:https://github.com/WeiboAI/VibeThinker"
Cohesion: 0.25
...
### Community 919 - "Issue #820: quick-note:https://github.com/cobusgreyling/loop-engineering"
Cohesion: 0.25
...
### Community 920 - "Positional Encoding Internals"
Cohesion: 0.25
...
### Community 921 - "TOP 6 — Highest-ROI Items (Validated by Opus Research Agent)"
Cohesion: 0.25
...
### Community 922 - "SECTION A — Agent Efficiency (Hermes / AOS / MYT)"
Cohesion: 0.25
...
### Community 923 - "SECTION C — Direct Chat Improvements (CBF / HRM)"
Cohesion: 0.25
...
### Community 924 - "Runbook — Instance Activation"
Cohesion: 0.25
...
### Community 925 - "Prime Agent Runtime"
Cohesion: 0.25
...
### Community 928 - "router/health.py"
Cohesion: 0.20
...
### Community 933 - "run_patched_colibri.py"
Cohesion: 0.36
...
### Community 937 - "TestItIsNotBuiltForOneVendor"
Cohesion: 0.25
...
### Community 938 - "test_compose_and_coordinate_api.py"
Cohesion: 0.36
...
### Community 939 - "test_generate_context_standing_instructions.py"
Cohesion: 0.32
...
### Community 940 - "test_local_brain_router_smoke.py"
Cohesion: 0.25
...
### Community 941 - "TestAgentRunnerPublicPlanMethod"
Cohesion: 0.22
...
### Community 944 - "test_provider_models_db_outage.py"
Cohesion: 0.25
...
### Community 945 - "test_pytest_failure_parser.py"
Cohesion: 0.23
...
### Community 949 - "test_serve_spa_prefixes.py"
Cohesion: 0.36
...
### Community 950 - "flesch_reading_ease"
Cohesion: 0.22
...
### Community 951 - "test_workflow_api_mount.py"
Cohesion: 0.20
...
### Community 955 - "_get_current_user"
Cohesion: 0.25
...
### Community 963 - "Changelog"
Cohesion: 0.29
Nodes (7): Added, Changed, Changelog, Fixed, Maintenance, Removed, Security

### Community 964 - "AI Engineering Insights Skill"
Cohesion: 0.29
...
### Community 978 - "claude-mem Plugin — Persistent Memory for All Sessions"
Cohesion: 0.29
...
### Community 979 - "Implementation plan + TO-DO (check off as you go)"
Cohesion: 0.29
...
### Community 982 - "Cloudflare = the real working app"
Cohesion: 0.29
...
### Community 990 - "e2e_smoke.py"
Cohesion: 0.57
Nodes (5): _chat(), check(), _health(), _models(), _req()

### Community 991 - "task_runner.py"
Cohesion: 0.33
...
### Community 994 - "test_daily_2026_06_14.py"
Cohesion: 0.38
...
### Community 995 - "TestSupportMatrixDocsSync"
Cohesion: 0.29
...
### Community 996 - "TestAnthropicWorkspaceIdCapture"
Cohesion: 0.33
...
### Community 997 - "TestGithubTokenSQLiteRegression"
Cohesion: 0.38
...
### Community 998 - "TestReasonsAreActionable"
Cohesion: 0.29
...
### Community 999 - "TestProvidersScreen"
Cohesion: 0.43
...
### Community 1000 - "Agent Autonomy Roadmap"
Cohesion: 0.25
...
### Community 1019 - "5. The five autonomous loops"
Cohesion: 0.33
...
### Community 1020 - "Master Goal Prompt — Autonomous Agency CEO"
Cohesion: 0.33
...
### Community 1021 - "Agency Core — Operational Knowledge (verified live, 2026-06-10/11)"
Cohesion: 0.33
...
### Community 1022 - "Pre-Mortem Analysis: Agency Core autonomy story (Cloudflare deployment)"
Cohesion: 0.33
...
### Community 1023 - "SECTION B — NVIDIA / Cloud Model Integration (Nemotron / NVD)"
Cohesion: 0.33
...
### Community 1024 - "SECTION D — Deployment & Infrastructure (CHM / NVD)"
Cohesion: 0.33
...
### Community 1025 - "StatusPill.jsx"
Cohesion: 0.47
Nodes (5): C, STATUS_META, StatusPill(), TONE_BG(), TONE_BORDER()

### Community 1026 - "resolve_hermes_base_url"
Cohesion: 0.47
...
### Community 1028 - "apply_phase1_changes.py"
Cohesion: 0.33
...
### Community 1045 - "test_agent_readiness_audit.py"
Cohesion: 0.18
...
### Community 1059 - "SECTION E — Autonomy & Self-Healing (AOS / MYT / ECC)"
Cohesion: 0.40
...
### Community 1060 - "SECTION F — Developer Experience (CBF / ECC)"
Cohesion: 0.40
...
### Community 1071 - "build_llama_cpp.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), W(), Warn()

### Community 1072 - "download_glm52_weights.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), Warn(), W()

### Community 1073 - "download_glm52_weights.sh script"
Cohesion: 0.70
Nodes (4): download_glm52_weights.sh script, fail(), ok(), warn()

### Community 1074 - "_fetch_pytest_failures.py"
Cohesion: 0.50
...
### Community 1075 - "setup_colibri.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), Warn(), W()

### Community 1076 - "setup_colibri.sh script"
Cohesion: 0.70
Nodes (4): setup_colibri.sh script, fail(), ok(), warn()

### Community 1077 - "status_colibri_server.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), W(), Warn()

### Community 1079 - "TestMobileNavigation"
Cohesion: 0.40
Nodes (3): Mobile-specific: hamburger menu, responsive layout., Verify key pages load in mobile viewport., TestMobileNavigation

### Community 1080 - "test_v5_screens_smoke.py"
Cohesion: 0.50
...
### Community 1082 - "test_agent_runtime_wrapper.py"
Cohesion: 0.70
...
### Community 1083 - "Continual Harness (`agent/harness_spec.py`)"
Cohesion: 0.25
...
### Community 1084 - "TestNoKeyEverReachesTheLog"
Cohesion: 0.40
...
### Community 1085 - "TestTheProbeIdentifiesItself"
Cohesion: 0.40
...
### Community 1086 - "test_event_log.py"
Cohesion: 0.45
...
### Community 1100 - "_resolve_default_executor_model"
Cohesion: 0.50
Nodes (3): Any, Resolve the default executor model via the catalog (UNIT 7). Was hardcoded to…, _resolve_default_executor_model()

### Community 1101 - "stop_colibri_server.ps1"
Cohesion: 0.83
Nodes (3): Fail(), Ok(), W()

### Community 1103 - "start_server.sh"
Cohesion: 0.50
Nodes (3): OLLAMA_HOST, OLLAMA_MODELS, start_server.sh script

### Community 1104 - "check_services"
Cohesion: 0.67
Nodes (3): check_services(), main(), Check if local services are running. Extends the original (proxy + Ollama)…

### Community 1105 - "_brain_provider_status"
Cohesion: 0.25
Nodes (8): _brain_provider_status(), get_brain_policy_route(), Return per-provider metadata for the GET endpoint. Iterates every provider in…, Return the discovered model list for *provider_id*, or ``[]`` if unknown., Return the active brain config + per-provider key-present flags. The response…, _served_models(), Force a cache refresh (used by tests + the GET /admin/api/policy/brain…, refresh_brain_config_cache()

### Community 1113 - "connectors_api.py"
Cohesion: 0.22
...
### Community 1114 - "test_no_exception_detail_leaks.py"
Cohesion: 0.50
...
### Community 1115 - "test_skills_route_order.py"
Cohesion: 0.67
...
### Community 1116 - "github"
Cohesion: 0.50
Nodes (3): github, enabled, silent

### Community 1141 - "_is_denied_path"
Cohesion: 0.33
Nodes (3): _is_denied_path(), Return a rejection reason, or "" if *path* is allowed., TestIsDeniedPath

### Community 1143 - "test_the_reserve_is_bounded_when_read_from_the_environment"
Cohesion: 0.67
...
### Community 1147 - "_start_ceo_agency"
Cohesion: 0.31
...
### Community 1254 - "parse_pytest_failures.py"
Cohesion: 0.50
Nodes (4): main(), Return the lines at or after pytest's first summary banner. Falls back to the…, _read(), _summary_region()

### Community 1255 - "Feature Support Matrix"
Cohesion: 0.33
Nodes (6): Admin API, Config Overrides, Feature Matrix, Feature Support Matrix, Gating Behavior, Maturity Tiers

### Community 1256 - "codebase-explorer.md"
Cohesion: 0.50
Nodes (3): Hard constraints, Method, Output

### Community 1257 - "docs-auditor.md"
Cohesion: 0.50
Nodes (3): Hard constraints, Output, What to check

### Community 1258 - "risk-reviewer.md"
Cohesion: 0.50
Nodes (3): Output, Rules of evidence, What you weigh

### Community 1259 - "verification-reviewer.md"
Cohesion: 0.50
Nodes (3): Output, Rules of evidence, What you evaluate

### Community 1260 - "Cost-aware routing evaluation"
Cohesion: 0.33
Nodes (5): Caveats, Cost-aware routing evaluation, How the metric resists gaming, Method, What's here

### Community 1261 - "openclaw_mobile_ui"
Cohesion: 0.33
...
### Community 1262 - "Who is this for?"
Cohesion: 0.40
...
### Community 1263 - "TestWorkflowIntegration"
Cohesion: 0.33
...
### Community 1265 - "CircuitBreakerOpenError"
Cohesion: 0.50
...
### Community 1268 - "TestModelRoleSeparation"
Cohesion: 0.40
...
### Community 1271 - "Privacy, security, and cost"
Cohesion: 0.50
Nodes (4): Privacy, security, and cost, Security posture, What it costs to run, Your data never leaves your server

### Community 1272 - "get_nim_pool"
Cohesion: 0.50
Nodes (3): get_nim_pool(), Return the module-level NIMConnectionPool singleton., asyncio
...
### Community 1275 - "Configuration reference"
Cohesion: 0.67
Nodes (3): Configuration reference, Provider priority chain, Running the brain on local Ollama (via a tunnel)

## Knowledge Gaps
- **3496 isolated node(s):** `duplicate.sh script`, `heartbeat.sh script`, `redact_secrets.sh script`, `docker`, `RENDER_API_KEY` (+3491 more)
  These have ≤1 connection - possible missing edges or undocumented components. (Counts symbols only; 13318 node(s) total have ≤1 connection when file, concept and rationale nodes are included.)
- **110 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `_fixture()` connect `_fixture` to `_Recorder`, `Task`, `test_llm_router_queue_cache.py`, `TaskSpec`, `TaskExecutionCoordinator`, `ImprovementLoop`, `AgentDefinition`, `test_llm_router_strategies.py`, `get_skill_bindings`, `tests/conftest.py`, `E2BSandboxSession`, `OrchestratorCheckpointStore`, `brain_config.py`, `SelfHealingAgent`, `test_company_api.py`, `PolicyEngine`, `test_ceo_router.py`, `test_llm_router_disabled.py`, `test_telegram_webhook.py`, `test_unit8_model_catalog.py`, `_mock_provider_records`, `services/seo_audit.py`, `test_failover_client_shared.py`, `cost_tracker.py`, `loop.py`, `test_llm_router_resilience.py`, `test_model_router.py`, `AgentProfile`, `PrimeAgentAdapter`, `BrainWatchdog`, `test_openclaw_endpoints.py`, `WorkflowRun`, `AgentJobManager`, `test_knowledge_sync.py`, `test_agent_tool_governance.py`, `test_sam_livekit.py`, `ChatHistoryStore`, `test_vision_routing.py`, `test_task_pre_execution_gate.py`, `_clean_director`, `models/company_graph.py`, `test_telegram_auto_approve.py`, `ResearchTask`, `test_autonomy_status.py`, `validate_policy_text`, `SQLiteStore`, `test_local_brain_state.py`, `TestClient`, `test_phase5_doctor.py`, `test_refresh_agent_built_proof.py`, `test_procedural_memory.py`, `resolve_e2b_config`, `OutputFilter`, `llm/router.py`, `test_startup_warmup.py`, `services/background.py`, `test_sam_voice.py`, `.record`, `test_provider_router.py`, `ClaudeCodeAdapter`, `test_task_self_repo_auto_commit.py`, `e2e/test_browser.py`, `models/seo_audit.py`, `test_context_rulebook.py`, `_start_ceo_agency`, `ArtifactStore`, `test_issue_intake.py`, `run_task`, `test_response_cache.py`, `UserRole`, `test_brain_failover.py`, `test_kimi_bridge_server.py`, `_step`, `WorkflowRun`, `clear_cooldowns`, `test_trend_watcher.py`, `test_openclaw_gateway.py`, `TestHarnessAdapter`, `test_provider_state_durability.py`, `resolve_active_brain`, `claim`, `persist_plan_spec`, `test_tasks_reconciler_todo_requeue.py`, `Workspace`, `KeyPool`, `test_new_features_e2e.py`, `test_daily_automation_2026_07_09.py`, `RuntimeHealth`, `test_telegram_freebuff.py`, `KeyStore`, `OllamaCircuitBreaker`, `_job_text`, `_Budget`, `test_brain_resolver.py`, `SchedulerStore`, `TestAgentRunnerSafety`, `test_features_api.py`, `test_video_transcript.py`, `test_brain_availability_doctor.py`, `TrendWatcher`, `test_freebuff_bot.py`, `test_process_quick_note_workflow.py`, `test_portfolio_intake.py`, `NotificationDispatcher`, `platform_controls_router.py`, `UsageEvent`, `TestEstimateTokensForMessages`, `TestClient`, `test_agile_api.py`, `test_app_settings.py`, `test_task_clarification.py`, `test_e2b_task_wiring.py`, `_clean_phases`, `ContextPruner`, `test_llm_router_tpm.py`, `test_control_plane_api.py`, `sam`, `test_implement_agent_routing.py`, `test_daily_2026_07_27.py`, `test_persistent_memory.py`, `SecurityScanner`, `BackgroundAgent`, `test_llm_router_e2e.py`, `test_platform_controls.py`, `get_skill_registry_safe`, `test_rate_limiter.py`, `test_nvidia_model_discovery.py`, `capture_screens.py`, `_resolve_push_token`, `test_catalogue_probe.py`, `TestNormalizeResponseFormat`, `analyze_page`, `test_scheduler_hydration_bounded.py`, `OrchestratorQueue`, `test_mcp_governance.py`, `test_purge_backlog.py`, `model_discovery.py`, `test_agent_scripts_share_one_model_list.py`, `test_crispy_burn_in.py`, `test_e2b_data_flow.py`, `test_skill_registry_boot_refresh.py`, `AgentSwarm`, `get_feature_matrix`, `isolated_telegram_config`, `test_agent_free_brain.py`, `test_dashboard_cache.py`, `test_tasks_awaiting_approval_api.py`, `test_provider_enable_disable.py`, `_undeclared`, `_get`, `test_service_token.py`, `test_harness_spec.py`, `test_regression.py`, `test_agency_fix.py`, `test_webui_provider_priority.py`, `TestTheWorkflowIsSafeAndReadOnly`, `test_monitor_lib.py`, `test_v4_api.py`, `test_ping.py`, `test_telegram_task_callback.py`, `test_telegram_diag_endpoint.py`, `session_retro.py`, `client`, `test_voice_pipeline.py`, `test_brain_patch_service_token.py`?**
  _High betweenness centrality (0.091) - this node is a cross-community bridge._
- **Why does `AgentRunner` connect `AgentRunner` to `backend/server.py`, `proxy.py`, `AdaptiveHalter`, `FreeBuffAgent`, `TaskSpec`, `test_brain_failover.py`, `BackgroundAgent`, `TestAgentRunnerExecution`, `ReactScratchpad`, `E2BSandboxSession`, `test_empirical_verify.py`, `ContextManager`, `PolicyEngine`, `Agency`, `MultiAgentSwarm`, `test_failover_client_shared.py`, `loop.py`, `WorkspaceTools`, `Workspace`, `TestAgentRunnerPublicPlanMethod`, `AgentSessionStore`, `StuckDetector`, `_resolve_push_token`, `test_daily_automation_2026_07_09.py`, `test_daily_automation_2026_07_11.py`, `WorkflowRun`, `test_agent_chat_integration.py`, `AgentJobManager`, `test_agent_runner.py`, `TokenBudget`, `test_agent_tool_governance.py`, `InternalAgentAdapter`, `test_governance_api.py`, `direct_chat.py`, `TestAgentRunnerSafety`, `LocalWorkspace`, `workflow_orchestrator.py`, `call_llm`, `UserMemoryStore`, `GitHubTools`, `test_agent_free_brain.py`, `CEODispatcher`, `ContextPruner`, `TestAgentLoopMCPIntegration`?**
  _High betweenness centrality (0.038) - this node is a cross-community bridge._
- **Why does `ProviderRouter` connect `ProviderRouter` to `implement_agent.py`, `backend/server.py`, `ProviderConfig`, `test_all_providers_discovery.py`, `test_bedrock_live.py`, `clear_cooldowns`, `resolve_active_brain`, `NvidiaProvider`, `kimi_bridge_provider_config`, `TestRouterIntegration`, `settings.py`, `TestLegacyRouterCacheTTL`, `test_anthropic_refusal_fallback.py`, `direct_chat.py`, `_payload`, `TrafficDirector`, `call_llm`, `test_bedrock_provider.py`, `ai/router.py`, `ProviderCircuit`, `is_anthropic_base_url`, `test_provider_router.py`, `test_colibri_provider.py`, `TestLegacyRouterServerFallback`, `failover_client.py`, `test_implement_agent_routing.py`?**
