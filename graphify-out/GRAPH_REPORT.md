...
## Corpus Check
- 1500 files · ~2,172,075 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 30356 nodes · 56724 edges · 1258 communities (1105 shown, 105 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 3331 edges (avg confidence: 0.92)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `07fed4da`
...
## Communities (1258 total, 105 thin omitted)

### Community 0 - "backend/server.py"
Cohesion: 0.02
Nodes (199): _agent_provider_failure_response(), _agent_timeout_fallback_response(), AgentStatusEntry, AgentStatusResponse, AgentToolCallEntry, _append_agent_session_message(), auth_me(), AuthorizeReposBody (+191 more)

### Community 1 - "LLMRequest"
Cohesion: 0.04
Nodes (104): ProviderConfig, One configured endpoint. ``kind`` selects the adapter: ``openai`` (any OpenAI-…, OpenAICompatible, Adapter for any endpoint speaking the OpenAI chat-completions shape. Adding a…, build_provider(), Normalise a configured ``kind`` to an adapter key., Instantiate the adapter for one provider config. Unknown kinds fall back to the…, resolve_kind() (+96 more)

### Community 2 - "TaskResult"
Cohesion: 0.04
Nodes (84): Resolve the model id for a component's role on a provider. Parameters…, resolve_component_model(), kimi_bridge_runtime_config(), Return Kimi bridge config for external runtimes (Hermes, Goose, Aider). Returns…, AiderAdapter, Any, TaskResult, runtimes/adapters/aider.py — Aider adapter (TIER 3 — specialized). Aider… (+76 more)

### Community 3 - "MongoDBStore"
Cohesion: 0.04
...
Cohesion: 0.03
Nodes (164): Describes a single worker's task and constraints., WorkerSpec, get_skill_registry_safe(), Return the global SkillRegistry if set, else None. Used by onboarding and other…, middleware, admin_control(), admin_create_user(), admin_login() (+156 more)

### Community 5 - "llm/router.py"
Cohesion: 0.05
Nodes (61): _load(), main(), Scheduled portfolio intelligence sweep. Run by `.github/workflows/portfolio-…, int, failover_chat_completion_via_router(), openai_body_from_response(), Any, packages/llm/compat.py — backwards-compatible bridges to the legacy call paths.… (+53 more)
...
### Community 7 - "get_company_graph_store"
Cohesion: 0.05
Nodes (58): autonomy_status(), Public autonomy readiness probe — no authentication required. A live deploy…, Fire-and-forget self-bootstrap; never blocks or crashes startup., _schedule_self_bootstrap(), CompanyAgencyService, get_company_agency_service(), _is_runtime_available_sync(), _pick_available_runtime() (+50 more)

### Community 8 - "TaskDispatcher"
Cohesion: 0.06
Nodes (38): _env_flag(), Read a boolean env var. Accepts 'true'/'1'/'yes' (case-insensitive)., Re-queue BLOCKED tasks that have cooled down and are ready for retry., Polls for queued task work and executes it through the coordinator. Crash…, Re-queue tasks stranded by a prior crash or hard-kill., TaskDispatcher, _make_task(), asyncio (+30 more)

### Community 9 - "test_llm_router_strategies.py"
Cohesion: 0.04
Nodes (98): count, HealthConfig, Strategy selection and degradation behaviour., Circuit breaker + health tracking thresholds., RoutingConfig, HealthTracker, _Outcome, ProviderHealth (+90 more)

### Community 10 - "BrainConfig"
Cohesion: 0.04
Nodes (73): BrainConfig, BrainConfigStore, default_brain_config(), provider_base_url(), BaseModel, Persist *cfg* to Mongo (primary) and sqlite (mirror). Either backend failing is…, Build a ``BrainConfig`` from a Mongo doc, dropping Mongo's ``_id``., Synchronous call-time resolver for an agent role model id. Precedence (highest… (+65 more)

### Community 11 - "test_unit8_model_catalog.py"
Cohesion: 0.04
Nodes (71): CatalogActiveBrain, CatalogMirror, CatalogProviderEntry, _include_router_providers(), invalidate_catalog_cache(), is_catalog_enabled(), ModelCatalogStore, Any (+63 more)

### Community 12 - "test_llm_router_resilience.py"
Cohesion: 0.03
Nodes (73): Backoff policy for retryable failures., RetryConfig, BreakerState, Enum, str, packages/llm/health.py — provider health tracking and circuit breaking. Two…, Test hook — clear all health state., reset() (+65 more)

### Community 13 - "_fixture"
Cohesion: 0.02
Nodes (102): base_url(), mobile_page(), proxy_url(), Config, pytest_configure(), conftest.py — pytest fixtures and configuration for the E2E test suite.…, A browser page pre-configured for mobile viewport (390×844 — iPhone 14)., setup_database_moks() (+94 more)

### Community 14 - "AgentJobManager"
Cohesion: 0.04
Nodes (43): check_kwargs(), Any, agent/contract_enforcement.py — Runtime signature locking (J) Provides…, # NOTE: limit has a default so it is accepted; owner_id is keyword-only., Raise TypeError on unknown kwarg (runtime extra='forbid'). Args: kwargs: The…, # NOTE: limit is NOT locked — it is a legitimate optional param that does not, AgentJob, AgentJobManager (+35 more)

### Community 15 - "PolicyEngine"
Cohesion: 0.03
Nodes (92): _egress_policy_reason(), agent/web_reach.py — Web Reach: zero-key internet access for agents. Gives…, Return why governance policy blocks *host*, or None. Runs strictly *after* the…, governance_enabled(), True when the governance layer should run at all. A single global off switch…, AgentIdentity, _coerce_text(), new_session_id() (+84 more)

### Community 16 - "Usage"
Cohesion: 0.04
Nodes (58): packages/llm/providers/anthropic.py — Anthropic Messages API adapter. Anthropic…, classify_error(), LLMProvider, ABC, Any, AsyncClient, packages/llm/providers/base.py — the provider contract and the generic adapter.…, Parse ``Retry-After`` (and common vendor variants) into seconds. (+50 more)

### Community 17 - "test_governance_sandbox.py"
Cohesion: 0.03
Nodes (84): Charge sub-agent nesting depth and enforce the ``max_depth`` ceiling. Isolates…, events_from_identity(), Any, Convenience: build and record an event in one call., Extract the identity-derived audit fields from an AgentIdentity. Kept here…, record_event(), build_docker_run_argv(), detect_backend() (+76 more)

### Community 18 - "test_llm_router_queue_cache.py"
Cohesion: 0.02
Nodes (127): Test hook — clear all usage accounting., reset(), CacheManager, cosine_similarity(), _Entry, get_cache(), LRUCache, payload_key() (+119 more)

### Community 19 - "test_user_research_skill.py"
Cohesion: 0.06
Nodes (39): get_tool_registry(), Return the module-level ToolRegistry singleton. On first call, registers built-…, analyze_qualitative(), auto_register(), _classify_sentiment(), _extract_keywords(), BaseModel, QualAnalysis (+31 more)
...
### Community 21 - "TaskStatus"
Cohesion: 0.03
Nodes (101): AgentDefinition, AgentStore, Any, field_validator, agents/store.py — Persistent store for user-defined agent configurations.…, CRUD store for AgentDefinition objects. Uses MongoDB when a `db` client is…, Return an agent by ID. If *owner_id* is provided, enforces that the agent…, Delete an agent. Returns True on success, False if not found/unauthorised. (+93 more)

### Community 22 - "CompanyGraphStore"
Cohesion: 0.02
Nodes (99): BusinessCategory, BusinessSystem, Company, CompanyGraph, KnowledgeItem, SystemType, Get the index of a phase in the workflow., The core company entity - root of the Company Graph. (+91 more)

### Community 23 - "test_ceo_dispatcher.py"
Cohesion: 0.04
Nodes (81): _merge_changed_files(), Collect changed_files across all specialists into a single de-duped list., ClassifyOutput, get_ceo_fallback_stats(), PlanOutput, CLASSIFY phase: domain and task type determination., PLAN phase: structured execution plan., SELECT_SPECIALIST phase: which specialist(s) handle this work. (+73 more)
...
### Community 25 - "Provider"
Cohesion: 0.08
Nodes (26): Cerebras provider adapter — free, fast LLM (qwen-3-coder-480b)., Groq provider adapter — free, fast LLM (deepseek-r1-distill-llama-70b)., NVIDIA NIM provider adapter — wraps the existing provider_router logic. This is…, Ollama provider adapter — local LLM inference., packages.ai — provider abstraction, model registry, and failover manager., ProviderManager, packages/ai/manager.py — ProviderManager. Single entry point for all LLM calls.…, Coordinates provider selection, failover, and health. (+18 more)
...
### Community 27 - "Task"
Cohesion: 0.03
Nodes (72): Task, Full task/issue document., Update the updated_at timestamp., Task, _gate_outward_facing_enabled(), _is_brain_connection_error(), _is_outward_facing(), Any (+64 more)

### Community 28 - "ExecutionRequest"
Cohesion: 0.05
Nodes (49): Execute work through the 11-phase golden path., Return orchestrator queue depth, active runs, and supervisor state (#522)., Called by APScheduler when a cron fires. Dispatches to the orchestrator. This…, #522 + #505: Reliability startup — schedule hydration, orchestrator restore,…, _scheduler_on_fire(), _startup_reliability_hooks(), workflow_orchestrator_execute(), workflow_orchestrator_status() (+41 more)

### Community 29 - "services/seo_audit.py"
Cohesion: 0.04
Nodes (54): field_validator, A single occurrence of a check firing on a specific URL., Aggregated report row - Screaming Frog CSV compatible., Site-level facts discovered during the crawl., Request to run an SEO/GEO/AIO audit against a website., SeoAuditRequest, SeoIssueInstance, SeoIssueReportRow (+46 more)

### Community 30 - "TestAddConversationCacheBreakpoints"
Cohesion: 0.06
...
Cohesion: 0.02
Nodes (133): AgentPhaseError, AgentRunner, _check_extra_kwargs(), _enforce_signature(), _note_phase_end(), _note_phase_start(), _nvidia_api_key(), Any (+125 more)

### Community 32 - "test_runtimes.py"
Cohesion: 0.07
Nodes (23): Return the single best adapter for *task_type*. If *preferred_runtime_id* is…, Maintains the catalogue of registered adapters and answers 'which runtimes can…, Return all adapters that can handle *task_type*, ordered by tier., RuntimeCapabilityRegistry, Admin-configurable routing policy. Defaults are conservative (local-first, no…, Routes a TaskSpec to the best available runtime following the configured…, Selects an available runtime for the given task type, preferring a specified…, Return the last *limit* routing decisions (newest first). (+15 more)

### Community 33 - "test_failover_client_shared.py"
Cohesion: 0.06
...
Cohesion: 0.04
Nodes (47): _NoopStore, Any, Exception, Approve a run paused at the ApprovalGate. The caller must re-invoke…, Inject additional instructions into an in-flight run (no state change). Backs…, Push a Telegram approval-gate notification when a run pauses (Charter G1).…, G5: resolve how a run should land from the company's DeliveryPolicy. Returns…, Persist first-merge consent once an operator approves a ``telegram_gate``. No-… (+39 more)

### Community 36 - "loop.py"
Cohesion: 0.05
Nodes (54): Agent subsystem — planner / executor / verifier loop., loop.py — AgentRunner: plan → execute → verify loop with locked tool signatures., # NOTE: "ollama_base" is kept for backwards compatibility; this runner only…, AgentEvent, AgentPlan, AgentRunRequest, AgentSession, AgentSessionCreateRequest (+46 more)

### Community 37 - "resolve_active_brain"
Cohesion: 0.04
Nodes (90): BrainResolution, BrainConfigPatch, get_brain_config(), invalidate_brain_config_cache(), Convenience wrapper used by the agent loop + brain resolver., Convenience wrapper used by the admin API endpoints., Clear the singleton's cache (used by tests + brain_policy invalidation)., Editable subset of ``BrainConfig`` sent by PATCH /admin/api/policy/brain. All… (+82 more)

### Community 38 - "get_runtime_manager"
Cohesion: 0.04
Nodes (77): e2b_status(), _enrich_runtimes(), get_decision_log(), get_policy(), get_runtime(), list_runtimes(), _load_rich_policy(), PolicyUpdateBody (+69 more)

### Community 39 - "scrub"
Cohesion: 0.08
Nodes (20): _luhn_ok(), True when ``digits`` (bare, no separators) satisfies the Luhn checksum., Recursively strip secrets from an arbitrary argument structure. Fails…, scrub(), tests/test_governance_audit_pii.py — PII redaction in the audit scrubber.…, TestCardRedaction, TestLuhn, TestNestedAndEventIntegration (+12 more)

### Community 40 - "ImprovementLoop"
Cohesion: 0.06
Nodes (58): DetectedIssue, get_improvement_loop(), ImprovementLoop, ImprovementLoopState, IssueCategory, IssueSeverity, _now(), Any (+50 more)

### Community 41 - "test_agent_tool_governance.py"
Cohesion: 0.08
Nodes (42): _drive(), governance_on(), _observations(), Any, MonkeyPatch, Path, The executor loop must not have a side door around the governance gate.…, Governance must not silently swallow the calls it permits. (+34 more)

### Community 42 - "Specialist"
Cohesion: 0.03
Nodes (75): Recommend skills relevant to the current task. Called from the tool-call loop…, provision_specialist(), Provision a new specialist for a company. Creates and provisions a specialist…, SpecialistFamily, Find all specialists of a specific family., Find specialists that can handle a task with given capabilities., Request to provision a specialist for a company., Result of provisioning a specialist. (+67 more)

### Community 43 - "direct_chat.py"
Cohesion: 0.05
Nodes (78): PreflightIssue, PreflightReport, Any, BaseModel, doctor.py — Agent-side doctor diagnostics: environment, provider, and workspace…, Translate technical preflight issues into a conversational assistant reply., translate_error_to_conversational(), AcceptedJob (+70 more)

### Community 44 - "BrainWatchdog"
Cohesion: 0.04
Nodes (64): emit_agency_observation(), Record an agency platform operation in Langfuse. Unlike…, get_brain_config_store(), provider_key_present(), Return the process-wide ``BrainConfigStore`` singleton., True when the env var for *provider*'s key is set (or it's Ollama)., Any, packages/ai/self_heal.py — automatic brain self-healing. When the active brain… (+56 more)

### Community 45 - "WorkspaceTools"
Cohesion: 0.07
...
### Community 46 - "test_sam_livekit.py"
Cohesion: 0.05
...
Cohesion: 0.06
Nodes (28): _child_env(), _kill_and_reap(), PrimeAgentAdapter, Terminate a subprocess and wait for it, ignoring races. ``asyncio.wait_for``…, Build the allowlisted environment for the CLI subprocess., Adapter for the Prime Agent / pi coding CLI., Return the path of the first available CLI binary, or None., TaskSpec (+20 more)

### Community 48 - "UserRole"
Cohesion: 0.06
Nodes (58): UserRole, _can_read(), _can_write(), create_secret(), _decrypt(), delete_secret(), _encrypt(), _get_master_key() (+50 more)

### Community 49 - "SelfHealingAgent"
Cohesion: 0.04
Nodes (75): FailureCategory, heal_signature(), HealingEvent, HealState, _now(), Any, Enum, str (+67 more)

### Community 50 - "test_model_router.py"
Cohesion: 0.05
...
### Community 53 - "test_governance_enforcement.py"
Cohesion: 0.07
Nodes (56): BudgetTracker, GovernanceGate, Holds live session budgets, bounded so it cannot leak. Sessions end without…, The one seam through which governed actions pass., Build an :class:`AgentIdentity` from whatever the caller knows. Total by design…, resolve_identity(), _engine(), Tests for the enforcement seam, audit trail, approvals, and budgets. The single… (+48 more)

### Community 54 - "services/background.py"
Cohesion: 0.04
Nodes (85): _dispatch_async(), _ErrorCaptureHandler, get_log_monitor(), LogMonitor, _note_recurrence(), Any, LogRecord, agent/log_monitor.py — Application Log Monitor Captures ERROR/CRITICAL log… (+77 more)

### Community 55 - "AgentSwarm"
Cohesion: 0.05
...
### Community 60 - "seo_portfolio_bridge.py"
Cohesion: 0.05
...
### Community 61 - "RepowiseIntelligence"
Cohesion: 0.06
...
Cohesion: 0.04
Nodes (68): _get_current_user_thunk(), _get_optional_user_thunk(), Request, create_refresh_token(), get_current_user(), get_optional_user(), github_repo_access(), JWTUserStateMiddleware (+60 more)

### Community 63 - "ChatHistoryStore"
Cohesion: 0.04
...
### Community 65 - "enforcement.py"
Cohesion: 0.05
Nodes (41): BudgetExceeded, classify(), get_gate(), guard_tool_call(), GuardResult, _host_of(), _is_write_tool(), _more_restrictive() (+33 more)

### Community 66 - "FeatureMatrix"
Cohesion: 0.05
...
### Community 71 - "TaskSpec"
Cohesion: 0.05
Nodes (41): ClaudeCodeAdapter, json_safe(), Any, TaskResult, Adapter for Claude Code CLI — FIRST CLASS autonomous coding runtime., TaskResult, TaskResult, Execute via OpenCode CLI: `opencode run --json <instruction>`. (+33 more)

### Community 72 - "test_webui_provider_priority.py"
Cohesion: 0.11
Nodes (35): _bootstrap(), Path, ProviderManager, WorkspaceManager, tests/test_webui_provider_priority.py — Priority + reorder + brain-policy…, The /policy/brain endpoint must return the resolved brain + the paid policy…, The /providers/role-tags endpoint surfaces brain/sub/fallback roles consistent…, Reset the brain_config + brain_policy singletons before each test. V2.0 Phase 2… (+27 more)

### Community 73 - "lifespan"
Cohesion: 0.08
Nodes (18): _keepalive_self_ping(), lifespan(), Run the FreeBuff Telegram bot, restarting it on unexpected exit., Ping our own public URL so a free-tier web service doesn't sleep. Render free…, Start the Telegram bot (and keep-alive) inside the web process when enabled.…, _start_in_web_bot_tasks(), _telegram_bot_supervisor(), Start the background self-heal loop. Called once at startup. (+10 more)

### Community 74 - "test_cost_aware_routing_eval.py"
Cohesion: 0.06
...
### Community 75 - "V5App.jsx"
Cohesion: 0.04
Nodes (40): API, getActivity(), HubTabs(), Spinner(), ActivationGate(), activityToAlert(), AlertsBell(), priorityConfig (+32 more)

### Community 76 - "brain_config.py"
Cohesion: 0.04
Nodes (85): _active_primary_provider(), _build_base_url_env_from_yaml(), _build_candidates_from_yaml(), _build_default_base_url_from_yaml(), _build_display_names_from_yaml(), _build_key_env_from_yaml(), _build_presets_from_yaml(), _build_tier_from_yaml() (+77 more)
...
### Community 80 - "claim"
Cohesion: 0.06
Nodes (32): claim(), clear_all_locks(), cooldown_clear(), cooldown_get(), cooldown_set(), _get_backend(), incr_window(), Shared-state abstraction — in-memory (default) and Redis backends. Provides… (+24 more)

### Community 81 - "seo_api.py"
Cohesion: 0.04
Nodes (61): build_seo_roadmap(), delegate_seo_findings(), _expire_stale_pending_report(), export_seo_audit(), get_seo_audit(), list_seo_audits(), plan_seo_sprint(), BaseModel (+53 more)
...
Cohesion: 0.05
Nodes (41): build_governance_router(), Any, APIRouter, backend/governance_router.py — read and operate the governance layer. Mounted…, Reject non-admin callers. Mirrors the RBAC check used elsewhere in this backend…, _require_admin(), _audit_proposal(), _baseline_loosened() (+33 more)
...
### Community 89 - "test_brain_config_api.py"
Cohesion: 0.05
...
### Community 91 - "test_unit6_resolve_component_model.py"
Cohesion: 0.06
Nodes (35): tests/test_unit6_resolve_component_model.py — UNIT 6 regression tests. Verifies…, When the DB cache is fresh AND provider matches the active primary, the DB-…, When the DB primary differs from the requested provider, the catalog preset for…, When `provider` is None, the DB primary's saved model wins., With no DB cache and no provider, the env var is consulted., An unknown role returns the safe default rather than raising., An unknown provider (no catalog preset) falls through to env / safe default., The 'default' role is treated as 'executor'. (+27 more)

### Community 92 - "TestClient"
Cohesion: 0.08
...
### Community 94 - "TestHarnessAdapter"
Cohesion: 0.05
...
### Community 95 - "test_startup_warmup.py"
Cohesion: 0.05
Nodes (46): _bootstrap_within_budget(), Await one warm-up step, deferring it to the background if it overruns.…, Run bootstrap without letting it hold a request open indefinitely. Returns…, _warmup_step(), defer_to_background(), Any, services/warmup.py — bounded startup warm-up steps. Extracted from…, Let an overrunning step finish out of band without leaking or warning twice. (+38 more)

### Community 96 - "models/company_graph.py"
Cohesion: 0.03
Nodes (92): ApprovalPolicy, CompanyCreateRequest, CompanyUpdateRequest, Connector, DetectedSystem, Evidence, OnboardingProgress, BaseModel (+84 more)

### Community 97 - "FreeBuffAgent"
Cohesion: 0.07
Nodes (41): free_nvidia_models(), FreeBuffAgent, Return the curated list of free NVIDIA NIM models FreeBuff may use., Codebuff-style coding agent pinned to free NVIDIA NIM models. FreeBuff is a…, List the free NVIDIA NIM models a user may pick (e.g. via Telegram)., True when *model* is in the curated free NVIDIA NIM set., check_rate_limit(), _enforce_rate_limit() (+33 more)

### Community 98 - "telegram_bot.py"
Cohesion: 0.07
Nodes (57): Convenience: resolve all four role models for a component. Returns a dict with…, resolve_component_role_models(), get_decisions_store(), Process-wide DecisionsStore singleton (resettable via db_path arg)., Return a Markdown-v1-safe preview string under ``max_chars``. Used by the…, sanitize_paste_for_preview(), _admin_headers(), _api_headers() (+49 more)

### Community 99 - "KeyStore"
Cohesion: 0.06
...
### Community 100 - "FinancialMetrics"
Cohesion: 0.06
...
Cohesion: 0.15
Nodes (50): BackgroundTasks, add_comment(), approve_checkpoint(), approve_execution(), clarify_task(), create_task(), _current_user(), delete_task() (+42 more)
...
### Community 108 - "models/seo_audit.py"
Cohesion: 0.09
Nodes (24): Root directory under which repo fixes are allowed to operate., Run the repo-aware auto-fixer against this company's workspace checkout.…, run_seo_fixes(), _workspace_root(), FsPath, BaseModel, models/seo_audit.py - SEO / GEO / AIO Audit Contracts Typed Pydantic models for…, Snapshot of one crawled page with the on-page facts the checks used. (+16 more)

### Community 109 - "ai_runner.py"
Cohesion: 0.07
...
### Community 110 - "test_sqlite_store.py"
Cohesion: 0.06
...
### Community 112 - "test_web_reach.py"
Cohesion: 0.08
Nodes (45): _load_script_module(), Any, ModuleType, Dynamically load a pure-stdlib helper module from .github/scripts/. Returns…, Zero-key internet access: pages, YouTube transcripts, search, RSS. Every public…, Read a web page as plain text, following the same fallback chain (direct ->…, GET *url*, re-validating every redirect hop against ``unsafe_target_reason`` —…, httpx-only fallback used when the .github/scripts helpers can't be loaded (e.g.… (+37 more)

### Community 113 - "v4_api.py"
Cohesion: 0.10
Nodes (40): _get_cached_tasks(), _get_tasks_cache_lock(), _load_improvement_state(), Any, BaseModel, get, Lock, post (+32 more)

### Community 114 - "AgileSprint"
Cohesion: 0.05
...
### Community 115 - "HTTPException"
Cohesion: 0.03
Nodes (119): admin_seed(), ApiKeyCreate, BrainTestRequest, clear_cost_attribution(), clear_response_cache(), create_api_key(), create_github_pr(), create_mcp_server() (+111 more)

### Community 116 - "settings.py"
Cohesion: 0.04
Nodes (26): packages.config — single source of truth for all configuration. Every module…, _env_int(), _get_settings(), packages/config/settings.py — typed configuration. This is the ONLY module in…, Read an int env var, falling back to *default* on a missing/bad value. Never…, Typed configuration loaded from environment variables., When True, the governance layer evaluates and audits agent actions. This is…, When True, approval-gated actions self-approve. Local dev only. (+18 more)
...
### Community 119 - "WorkspaceManager"
Cohesion: 0.05
...
### Community 121 - "ProviderConfig"
Cohesion: 0.04
Nodes (86): _acquire_provider_probe(), CommercialFallbackRequiredError, extract_openai_text(), is_commercial_provider(), _normalize_nvidia_base_url(), _openai_url(), provider_access_tier(), _provider_field() (+78 more)

### Community 122 - "failover_client.py"
Cohesion: 0.04
Nodes (54): _auto_disable(), _build_request(), _describe_registry(), _disabled_ids(), FailoverResult, _is_billing_refusal(), _is_ollama(), _key_pool() (+46 more)

### Community 123 - "ScheduledJob"
Cohesion: 0.08
Nodes (15): Any, Reconstruct a ScheduledJob from its as_dict() output., Capture the FastAPI main event loop so APScheduler's background thread can…, ScheduledJob, test_scheduled_job_roundtrips_through_dict(), count() returns 0 for an empty store., count() reflects the number of saved jobs., count() decreases after delete. (+7 more)

### Community 124 - "test_runtime_governance.py"
Cohesion: 0.08
Nodes (53): _audit_dispatch(), _blocked_result(), _governance_check(), _governance_identity(), Any, TaskResult, Build the failed TaskResult returned when policy denies a dispatch. A result…, Evaluate a runtime dispatch against policy; audit it either way. Returns… (+45 more)
...
### Community 127 - "test_context_rulebook.py"
Cohesion: 0.06
Nodes (53): Module, stmt, _bound_names(), _good_result(), _guard_statements(), _load(), ModuleType, parametrize (+45 more)

### Community 128 - "get_task_store"
Cohesion: 0.05
Nodes (75): _purge_backlog_core(), quick_notes_submit(), _QuickNoteBody, The task store the background services should use, wiring it if needed.…, Shared purge implementation for the admin endpoint and the boot hook., Submit a quick-note URL or instruction from the dashboard FAB., _task_store_for_background(), apply_from_db() (+67 more)

### Community 129 - "CEODispatcher"
Cohesion: 0.06
Nodes (51): CEODispatcher, CEOResult, _complexity_rank(), _decompose_into_subtasks(), _offload(), Any, Semaphore, services/ceo_dispatcher.py — Real CEO delegation layer. The CEO splits a… (+43 more)

### Community 130 - "resolve_e2b_config"
Cohesion: 0.06
...
### Community 131 - "render_ops.py"
Cohesion: 0.06
Nodes (32): _latest_metric_value(), _note_recurrence(), _parse_timestamp(), Any, datetime, services/render_ops.py — autonomous Render debugging + environment monitoring.…, Parse an RFC3339 timestamp from Render, tolerating a trailing ``Z``., Pull the most recent numeric sample out of a ``get_metrics`` payload. Render… (+24 more)

### Community 132 - "test_trend_scoping.py"
Cohesion: 0.09
...
### Community 138 - "is_anthropic_base_url"
Cohesion: 0.12
Nodes (11): is_anthropic_base_url(), True when ``base_url`` points at Anthropic's native Messages API. Anthropic's…, parametrize, Regression tests for the agent loop's multi-provider failover wire format.…, Registry base URLs must produce routes the provider actually serves., brain_failover must not drift from the catalog's base URLs., Only Anthropic's own API is native; Claude gateways stay OpenAI-shaped., The pieces the failover loop assembles for an Anthropic-native provider. (+3 more)

### Community 139 - "ProviderRouter"
Cohesion: 0.05
Nodes (38): build_tool_calling_router(), Return a router limited to providers that pass ``tools`` through intact. The…, _exponential_backoff_cooldown(), _get_director(), _normalized_provider_type(), _notify_watchdog(), _ollama_reasoning_effort(), ProviderRouter (+30 more)

### Community 140 - "BudgetTracker"
Cohesion: 0.08
Nodes (27): AlertHandler, BudgetTracker, Counter, _Dimensions, get_budget(), _month(), Any, packages/llm/budget.py — token and cost accounting with spend alerts. Tracks… (+19 more)

### Community 141 - "test_render_mcp.py"
Cohesion: 0.06
...
### Community 142 - "OnboardingScreen.jsx"
Cohesion: 0.05
...
### Community 144 - "test_kimi_bridge_server.py"
Cohesion: 0.05
...
### Community 145 - "test_issue_intake.py"
Cohesion: 0.08
...
### Community 150 - "validate_outbound_url"
Cohesion: 0.14
...
### Community 153 - "test_bedrock_provider.py"
Cohesion: 0.05
...
### Community 154 - "test_trend_watcher.py"
Cohesion: 0.06
Nodes (38): _FakeClient, _FakeResp, asyncio, Path, Tests for agent/trend_watcher.py, Ensure expanded keyword set covers key new categories., A release is scored by its notes, never the old blanket 0.95 that let five…, Only the newest release is force-surfaced; older routine patch releases in the… (+30 more)
...
### Community 157 - "test_prompt_injection_boundary.py"
Cohesion: 0.17
Nodes (18): build_compaction_prompt(), build_execution_prompt(), build_planning_prompt(), build_tool_prompt(), build_verification_prompt(), Any, prompts.py — Prompt builders for planner, executor, and verifier roles., tests/test_prompt_injection_boundary.py — untrusted-content trust boundary.… (+10 more)

### Community 158 - "PortfolioManager"
Cohesion: 0.05
...
### Community 160 - "test_slop_gate.py"
Cohesion: 0.07
...
### Community 161 - "test_mcp_registry.py"
Cohesion: 0.07
Nodes (27): Measure one server. Never raises — a probe failure is a status, not an error., Measure every declared server concurrently and return dashboard rows. Probes…, status_all(), _status_for(), _noop_async(), Any, asyncio, tests/test_mcp_registry.py — the single MCP catalogue and the screen it backs.… (+19 more)

### Community 162 - ".run"
Cohesion: 0.06
Nodes (42): Call-time resolver for an agent role model id. Delegates to…, Build a readable markdown report for the task comment. Includes the goal,…, _resolve_role_model(), build_spec_router(), Any, APIRouter, backend/spec_router.py — review/approve persisted plan specifications. Surfaces…, await_spec_approval() (+34 more)

### Community 163 - "test_response_cache.py"
Cohesion: 0.11
...
### Community 164 - "ContextWindowManager"
Cohesion: 0.08
...
### Community 166 - "DirectChatSession"
Cohesion: 0.14
...
### Community 167 - "probe_catalogues.py"
Cohesion: 0.07
Nodes (32): _auth_headers(), _chat_targets(), _dump_matching(), _kind(), list_models(), _list_or_report(), main(), _parse_args() (+24 more)

### Community 168 - "clear_cooldowns"
Cohesion: 0.06
Nodes (48): clear_cooldowns(), _dead_model_key(), get_dead_models(), _is_model_dead(), is_provider_on_cooldown(), _mark_model_dead(), mark_provider_failed(), Snapshot of active dead-model entries {provider_id/model: expiry_ts}. Also… (+40 more)

### Community 169 - "test_schedule_growth_invariants.py"
Cohesion: 0.08
...
### Community 170 - "AgentScheduler"
Cohesion: 0.06
Nodes (31): AgentScheduler, _now(), Register, list, trigger, and delete cron-scheduled agent jobs. Usage:: sched =…, Register a new job. Returns the created :class:`ScheduledJob`.…, Fire a job immediately (webhook / manual trigger)., Remove a job. Returns *True* if it existed., Update the display name of a job., Enable or disable a job without deleting it. (+23 more)
...
### Community 173 - "test_ceo_router.py"
Cohesion: 0.07
...
### Community 174 - "Any"
Cohesion: 0.10
Nodes (9): CompanyGraphSnapshot, Any, field_validator, A point-in-time snapshot of a Company Graph for history and rollback., Coerce unrecognised system_type values to 'custom' so the model never crashes…, Create a company graph snapshot (No-op shim for SQLite)., List snapshots for a company graph (No-op shim for SQLite)., Create a snapshot of a company graph. (+1 more)

### Community 175 - "KeyPool"
Cohesion: 0.06
...
### Community 178 - "AuditLog"
Cohesion: 0.04
Nodes (48): Resolve the JWT signing secret, with a *stable* fallback. Bug fix: the previous…, _resolve_jwt_secret(), Replace the process-wide store. Tests only., reset_approval_store(), AuditEvent, AuditLog, packages/governance/audit.py — the evidence trail for every governed action.…, Redact SSNs and Luhn-valid payment-card numbers from a string. Runs after the… (+40 more)

### Community 179 - "pr_approval_gate.py"
Cohesion: 0.08
Nodes (32): _card_keyboard(), _card_text(), _dedupe_key(), default_run_sweep(), _gh_get(), _gh_token(), interval_sec(), load_notified() (+24 more)

### Community 180 - "test_telegram_freebuff.py"
Cohesion: 0.07
...
### Community 181 - "activation.py"
Cohesion: 0.08
Nodes (44): activation_required(), ActivationResult, activation_status(), Public endpoint — returns instanceId and whether the instance is activated.…, _b64url_decode(), _b64url_encode(), _decode_jwt_unverified(), _generate_token_for_owner() (+36 more)

### Community 182 - "activation_api.py"
Cohesion: 0.09
Nodes (44): activate_instance(), ActivateRequest, ActivateResponse, activation_audit_log(), ActivationStatusResponse, _append_audit(), AuditLogEntry, change_user_role() (+36 more)

### Community 183 - "fmtErr"
Cohesion: 0.06
...
### Community 184 - "OllamaCircuitBreaker"
Cohesion: 0.08
...
### Community 185 - "PromptCacheManager"
Cohesion: 0.06
...
### Community 187 - "tasks/service.py"
Cohesion: 0.03
Nodes (100): Helpers that turn scheduler and playbook activity into real tasks., Background dispatcher for task execution., tasks — Task/issue management system. Provides a lightweight task/issue tracker…, ApprovalCheckpoint, ApprovalRequest, _coerce_ts(), CommentAddRequest, ExecutionApprovalRequest (+92 more)

### Community 188 - "NvidiaProvider"
Cohesion: 0.14
...
### Community 190 - "TaskBoardScreen.jsx"
Cohesion: 0.06
...
### Community 191 - "test_classify_dependabot_update.py"
Cohesion: 0.07
...
### Community 193 - "WorkspaceManifest"
Cohesion: 0.07
...
### Community 196 - "_ts_to_float"
Cohesion: 0.06
Nodes (33): Any, Fail loud in production if no persistent storage is configured. Telegram…, List tasks for a specific user with optional filters. ``include_system``…, Admin-only: list all tasks across all users. ``include_log`` mirrors…, Return tasks queued for agent execution, highest-priority first. Ordered by…, Return BLOCKED tasks that are candidates for auto-retry., Return a shallow copy of ``doc`` without the heavy list fields. The Mongo path…, Return tasks due within the next N hours (any user). (+25 more)

### Community 197 - "test_features_api.py"
Cohesion: 0.05
Nodes (4): _auth_override(), client(), _fake_auth(), Integration tests for all new feature API routes in proxy.py.

### Community 198 - "test_schedule_backlog_drain.py"
Cohesion: 0.08
...
### Community 199 - "test_video_transcript.py"
Cohesion: 0.05
...
### Community 200 - "test_operational_incidents.py"
Cohesion: 0.06
...
### Community 202 - "LLMRouter"
Cohesion: 0.07
Nodes (29): Attempt, Read the environment variables named in ``env_names`` into a key list. Order is…, resolve_keys(), LLMRouter, Any, AsyncClient, BaseException, One shared connection pool. Reconnects if it was closed. (+21 more)

### Community 203 - "_get_provider_policy"
Cohesion: 0.07
Nodes (43): _get_provider_policy(), get_provider_policy_route(), ProviderPolicyUpdate, Read the durable provider policy from DB, falling back to a safe default.…, Editable subset of the durable provider policy (paid-provider kill switch)., Persist the durable provider policy and return the new state. Also writes to…, Return the provider policy (paid-provider kill switch state)., _set_provider_policy() (+35 more)

### Community 204 - "Part A — CodeRabbit review fixes for this PR (do first, small)"
Cohesion: 0.05
...
### Community 205 - "Docker Agent Runtimes Setup"
Cohesion: 0.05
...
### Community 206 - "anthropic_compat.py"
Cohesion: 0.09
...
Cohesion: 0.06
Nodes (18): _MemCollection, _MemCursor, _MemDB, _MemDeleteResult, Any, services/scheduler_store.py — Durable scheduler persistence. Issue #505:…, Delete a persisted job., Return the total number of persisted jobs. (+10 more)

### Community 209 - "test_unit7_catalog_propagation.py"
Cohesion: 0.06
...
### Community 210 - "NotificationDispatcher"
Cohesion: 0.07
...
### Community 212 - "TestRecordUsageAndStats"
Cohesion: 0.05
...
### Community 219 - "TrendWatcher"
Cohesion: 0.16
Nodes (11): Any, AsyncClient, Path, Fetches AI trend signals from many public sources and surfaces relevant ones., Fetch all sources in parallel; return new alerts sorted by relevance., Fan trends out to onboarded companies whose stack matches (G4). For each…, Dispatch high-relevance alerts to the Hermes sidecar for action. Only…, TrendAlert (+3 more)

### Community 220 - "Kept Rules — the 44 that survive the audit"
Cohesion: 0.05
...
### Community 221 - "RuntimeManager"
Cohesion: 0.04
Nodes (23): CircuitState, Return the last-known health for *runtime_id* (may be stale)., Return True if the runtime is available (not circuit-open)., Return health snapshots for all known runtimes., Force an immediate health check of all runtimes and return results., Attempt to start a dead runtime subprocess before re-probing. Uses the local…, Reduce probe frequency for runtimes that have never come online., Async health polling service for all registered runtimes. (+15 more)

### Community 222 - "FeatureEntry"
Cohesion: 0.06
Nodes (16): FeatureEntry, FeatureUnavailableError, Any, BaseModel, Exception, One entry in the support matrix., Load canonical features and apply per-feature then bulk env overrides., Apply a config override string like 'stable', 'beta', 'disabled', 'enabled',… (+8 more)

### Community 223 - "InternalAgentAdapter"
Cohesion: 0.07
...
### Community 224 - "JCodeAdapter"
Cohesion: 0.07
Nodes (19): JCodeAdapter, Any, Path, Write .jcode/mcp.json in the workspace, pointing at our proxy's MCP endpoint.…, Adapter for jcode — TIER 2 high-performance Rust coding agent., _build_default_manager(), Construct the default RuntimeManager. Production runtime (InternalAgentAdapter)…, By default only InternalAgentAdapter is registered. (+11 more)
...
### Community 226 - "report_to_markdown"
Cohesion: 0.10
...
### Community 227 - "test_portfolio_intake.py"
Cohesion: 0.08
Nodes (34): Weighted Shortest Job First score — higher schedules sooner., map_initiative_to_task(), materialize_committed(), _portfolio_materialize_enabled(), portfolio_source_id(), Any, Task, tasks/portfolio_intake.py — Portfolio initiative → Task materializer. Converts… (+26 more)

### Community 228 - "WorkflowRun"
Cohesion: 0.07
Nodes (24): _fake_artifact(), _make_engine(), tests/test_crispy_workflow.py — CRISPY workflow engine hardening tests. Tests…, Provide isolated DB + artifact + workspace paths., Create a WorkflowEngine with isolated storage., TestAbortOnFailure, TestPhaseSequence, TestPhaseSequenceError (+16 more)

### Community 229 - "test_e2b_data_flow.py"
Cohesion: 0.07
Nodes (31): agent/mcp_client.py — Async MCP client for the mcp-server Docker container.…, fake_sandbox(), _FakeAsyncSandboxClass, _FakeCmdResult, _FakeCommands, _FakeFiles, _FakeSandbox, Any (+23 more)

### Community 230 - "control_overrides.py"
Cohesion: 0.12
...
### Community 234 - "test_one_model_catalogue.py"
Cohesion: 0.14
Nodes (12): _hardcoded_candidates(), Model ids belong in a catalogue, not in Python. Four files in this repo each…, A frozen record of the divergence found on 2026-08-28. Reconciling these eleven…, These two are the ones this work reconciled, and each was reconciled because…, A shrinking divergence is progress, but the list must be trimmed to match or it…, ``config/llm/models.yaml`` drives capability filtering. An entry for a retired…, ``PROVIDER_CANDIDATES`` as written in the module, before YAML overrides. Read…, The YAML wins at import. A fix applied only to the Python copy is a fix that… (+4 more)
...
### Community 236 - "TemporalContextGraph"
Cohesion: 0.10
...
### Community 238 - "test_daily_2026_06_04.py"
Cohesion: 0.10
...
### Community 239 - "TestEstimateTokensForMessages"
Cohesion: 0.05
...
### Community 245 - "PatternConsolidation"
Cohesion: 0.10
...
### Community 248 - "system_instruction"
Cohesion: 0.16
...
### Community 251 - "TestCatalogFable51"
Cohesion: 0.09
...
### Community 254 - "test_llm_router_disabled.py"
Cohesion: 0.09
...
### Community 257 - "test_brain_failover.py"
Cohesion: 0.11
...
### Community 259 - "test_daily_2026_07_27.py"
Cohesion: 0.07
...
### Community 261 - "test_verification_strategies.py"
Cohesion: 0.11
...
### Community 262 - "test_autonomous_agency_e2e.py"
Cohesion: 0.10
Nodes (19): generate_sprint_retro(), Derive retro notes for ``sprint`` from its current metrics. Records…, Enum, Agentic Agile — Sprint management with velocity tracking and burndown. Issue:…, Sprint retrospective notes and follow-up action items., Whether the retrospective has any recorded content., Lifecycle status of a sprint., Status of a user story within a sprint. (+11 more)

### Community 263 - "get_failover_manager"
Cohesion: 0.07
Nodes (39): brain_failover_status(), brain_providers(), openclaw_command(), _openclaw_instructions(), openclaw_reverse_proxy(), openclaw_status(), openclaw_websocket(), api_route (+31 more)

### Community 264 - "autonomous_fix.py"
Cohesion: 0.08
Nodes (26): _decline(), _extract_pytest_failure(), _fetch_failure_context(), _is_denied_path(), _list_target_prs(), main(), _post_comment(), _pr_head() (+18 more)

### Community 265 - "test_governance_api.py"
Cohesion: 0.07
Nodes (48): get_approval_store(), get_audit_log(), Return the process-wide audit log, created on first use., Replace the process-wide gate. Tests only., reset_gate(), _client(), parametrize, TestClient (+40 more)

### Community 266 - "Screens"
Cohesion: 0.06
...
### Community 267 - "REWRITE_PLAN.md — Phased Migration Strategy"
Cohesion: 0.06
...
### Community 268 - "test_background_services.py"
Cohesion: 0.08
...
### Community 270 - "test_persistent_memory.py"
Cohesion: 0.06
...
### Community 272 - "agent_runtime.py"
Cohesion: 0.09
...
### Community 273 - "Feature Guide"
Cohesion: 0.05
Nodes (34): 10. Langfuse Observability, 11. Coding Agent API, 12. Browser Admin UI, 13. Telegram Remote Control Bot, 14. Tunnel — Permanent Static URL via ngrok, 15. CORS Support, 16. Streaming Support, 17. Workspace Isolation (+26 more)

### Community 274 - "api_keys_for"
Cohesion: 0.08
...
### Community 275 - "control_registry.py"
Cohesion: 0.14
...
### Community 276 - "local_controller.py"
Cohesion: 0.12
...
### Community 277 - "test_live_server.py"
Cohesion: 0.22
...
### Community 278 - "test_all_providers_discovery.py"
Cohesion: 0.17
...
Cohesion: 0.09
Nodes (24): Contract: WorkflowEngine cannot skip the gate state machine., Contract: No code path may advance past awaiting_approval unless gate.status ==…, Create a run and manually place it in awaiting_approval., Contract: Cannot approve a run in 'pending' state., Contract: Can approve a run in 'awaiting_approval' state., Contract: Rejecting a run marks it as failed., TestApprovalGateMandatory, _make_engine() (+16 more)

### Community 280 - "test_llm_router_e2e.py"
Cohesion: 0.06
...
### Community 282 - "test_freebuff_bot.py"
Cohesion: 0.10
...
### Community 287 - "_execute_skill_impl"
Cohesion: 0.11
Nodes (23): Run an audit from synchronous code, loop-safe. Used by the skill-bindings…, run_audit_sync(), _execute_skill_impl(), _get_portfolio_manager(), Any, Live Graphify executor — queries the codebase knowledge graph. Order of…, Live council reviewer — deterministic, rules-based multi-perspective review…, Recommend skills based on detected systems and provisioned specialists. With no… (+15 more)
...
### Community 291 - "ResourceWatchdog"
Cohesion: 0.10
...
### Community 292 - "Configuration Reference"
Cohesion: 0.06
...
### Community 294 - "test_rate_limiter.py"
Cohesion: 0.09
...
### Community 295 - "RateLimitTracker"
Cohesion: 0.10
...
### Community 296 - "test_provider_render_env.py"
Cohesion: 0.09
...
### Community 297 - "CEOSupervisor"
Cohesion: 0.08
Nodes (24): get_ceo_dispatcher(), Return the shared CEODispatcher singleton., Reset the singleton (test helper)., reset_ceo_dispatcher(), get_ceo_ledger(), Return the shared :class:`CEOLedger`, constructing it on first use., CEOSupervisor, Any (+16 more)

### Community 298 - "AnthropicProvider"
Cohesion: 0.09
Nodes (23): AnthropicProvider, Any, AsyncClient, Translate OpenAI-shaped messages into Anthropic's system/turn split., OpenAI carries a tool result as role="tool" with a tool_call_id; Anthropic…, OpenAI puts a tool call alongside the assistant's text; Anthropic needs…, Return the cache_control block appropriate for this provider's TTL setting.…, Add a rolling cache_control breakpoint to the most-recent stable message. In a… (+15 more)

### Community 299 - "test_microagents.py"
Cohesion: 0.15
...
### Community 300 - "Security Analysis — local-llm-server"
Cohesion: 0.06
...
### Community 303 - "test_brain_availability_doctor.py"
Cohesion: 0.13
Nodes (29): brain_availability_summary(), Non-secret answer to "can the brain answer a request right now?". Three callers…, _doctor(), _P, _patch_providers(), asyncio, Tests for the public brain-availability diagnosis and the supervisor's use of…, Minimal provider stand-in matching what the summary reads. (+21 more)

### Community 304 - "BrainFailoverManager"
Cohesion: 0.10
Nodes (17): BrainFailoverManager, ProviderInfo, Any, Record a successful call — resets the circuit breaker., Permit one probe call without claiming the provider succeeded. This is the…, Seconds until the soonest cooling provider is probeable again. ``None`` when no…, True when a provider's cooldown window is wider than any it could legitimately…, Record a provider failure — opens the circuit breaker on threshold. (+9 more)

### Community 305 - "TestDiagCommand"
Cohesion: 0.09
...
### Community 306 - "test_nvidia_model_discovery.py"
Cohesion: 0.06
...
### Community 307 - "test_workspace_isolation.py"
Cohesion: 0.16
...
### Community 312 - "High-Agency Frontend Skill"
Cohesion: 0.06
Nodes (30): 10. FINAL PRE-FLIGHT CHECK, 1. ACTIVE BASELINE CONFIGURATION, 2. DEFAULT ARCHITECTURE & CONVENTIONS, 3. DESIGN ENGINEERING DIRECTIVES (Bias Correction), 4. CREATIVE PROACTIVITY (Anti-Slop Implementation), 5. PERFORMANCE GUARDRAILS, 6. TECHNICAL REFERENCE (Dial Definitions), 7. AI TELLS (Forbidden Patterns) (+22 more)

### Community 313 - "LlmProviderConfig"
Cohesion: 0.15
...
### Community 314 - "Quick-Note GitHub Issues Processing - Session Summary"
Cohesion: 0.06
...
### Community 315 - "test_failover_silent_exhaustion.py"
Cohesion: 0.10
...
### Community 317 - "test_mcp_governance.py"
Cohesion: 0.11
Nodes (29): _call(), client(), _engine(), Governance on the MCP HTTP surface — threat-model T11. Before this,…, Same Golden Rule guarantee as the in-process gate., No UI is attached to this surface, so holding the socket would hang it., Headers are a hint, not a credential — and the baseline holds anyway. A caller…, A display name with an em-dash must not take out the tool call. (+21 more)

### Community 318 - "workflow_orchestrator.py"
Cohesion: 0.08
...
### Community 323 - "chat_handlers.py"
Cohesion: 0.08
Nodes (40): _apply_chat_defaults(), _apply_reasoning_budget(), _emit_safely(), _extract_exact_output(), _filter_fragment(), _filter_openai_sse_line(), handle_ollama_native_chat(), handle_openai_chat_completions() (+32 more)

### Community 324 - "governance.py"
Cohesion: 0.10
...
### Community 325 - "output_filter.py"
Cohesion: 0.08
...
### Community 326 - "test_colibri_brain_shim.py"
Cohesion: 0.07
Nodes (44): colibri_enabled(), colibri_provider_config(), colibri_status(), ProviderConfig, providers/colibri.py — Free local GLM-5.2 brain served by JustVugg/colibri.…, Return True iff the operator opted in via ``COLIBRI_ENABLED=true``., Cheap status snapshot for tests + admin UI., Return the ``ProviderConfig`` for the local colibri server, or ``None`` when… (+36 more)

### Community 327 - "WorkspaceManager"
Cohesion: 0.10
Nodes (23): _fake_user_auth(), Path, test_admin_can_create_anthropic_provider_via_webui_admin_api(), test_admin_can_create_provider_via_webui_admin_api(), test_ui_providers_and_workspaces_use_app_state(), _atomic_write_json(), default_store_paths(), get_data_dir() (+15 more)

### Community 328 - "OrchestratorCheckpointStore"
Cohesion: 0.10
...
### Community 330 - "test_force_cleanup_conditional_delete.py"
Cohesion: 0.10
...
### Community 331 - "test_portfolio_intelligence.py"
Cohesion: 0.06
...
### Community 335 - "Agent Readiness Report"
Cohesion: 0.20
...
### Community 339 - "SteeringInjector"
Cohesion: 0.11
...
### Community 341 - "test_claude_setup_audit.py"
Cohesion: 0.16
...
### Community 345 - "test_purge_backlog.py"
Cohesion: 0.09
...
### Community 348 - "Artifact"
Cohesion: 0.06
Nodes (36): AgentRole, tests/test_workflow_models.py — Unit tests for workflow/models.py., TestApprovalGate, TestCheckRun, TestSlice, workflow/artifact_store.py — Durable artifact persistence. Artifacts are stored…, _extract_slices_from_plan(), workflow/engine.py — WorkflowEngine: CRISPY phase sequencer. The engine is the… (+28 more)

### Community 349 - "Python Dependencies (`requirements.txt`)"
Cohesion: 0.07
...
### Community 350 - "Technical Debt Register — local-llm-server"
Cohesion: 0.07
...
### Community 356 - "test_regression.py"
Cohesion: 0.10
...
### Community 357 - "test_agent_scripts_share_one_model_list.py"
Cohesion: 0.10
...
### Community 358 - "test_crispy_burn_in.py"
Cohesion: 0.07
...
### Community 359 - "test_skill_registry_boot_refresh.py"
Cohesion: 0.12
...
### Community 361 - "test_v4_reliability_regression.py"
Cohesion: 0.07
Nodes (23): agent/job_manager.py — Async agent job lifecycle manager. Manages agent jobs…, Fail preflight when the provider extension is configured but missing. Without…, Any, Exception, Structured, actionable preflight validation issue., Preflight result returned before a runtime task starts., Return a health snapshot. Must not raise; return available=False instead., Ensure the requested workspace exists and is writable. (+15 more)

### Community 362 - "SprintMetrics"
Cohesion: 0.10
...
### Community 363 - "get_scheduler"
Cohesion: 0.11
Nodes (28): legacy_scheduler_delete(), legacy_scheduler_get(), legacy_scheduler_trigger(), Force-dedup and clean stale schedules from the durable store. Admin-only…, scheduler_force_cleanup(), get_scheduler(), create_schedule(), delete_schedule() (+20 more)

### Community 364 - "Deploy: FreeBuff Telegram bot (24×7)"
Cohesion: 0.07
...
### Community 365 - "Claude Code + Qwen Local Setup"
Cohesion: 0.07
...
### Community 366 - "traffic_director.py"
Cohesion: 0.13
...
### Community 367 - "model_discovery.py"
Cohesion: 0.09
Nodes (23): cached_models(), dead_models(), discover_models(), _fresh_entry(), mark_dead(), _models_url(), _parse_ids(), Any (+15 more)

### Community 368 - "FeatureMaturity"
Cohesion: 0.08
Nodes (35): check_feature(), get_feature(), list_features(), Any, get, post, features/api.py — Admin API for the feature support matrix. Exposes: GET…, Return the full support matrix with summary. (+27 more)
...
### Community 371 - "skill_bindings.py"
Cohesion: 0.09
...
### Community 372 - "isolated_telegram_config"
Cohesion: 0.11
...
### Community 373 - "_captured_request_headers"
Cohesion: 0.13
...
### Community 374 - "test_nvidia_default_model.py"
Cohesion: 0.17
Nodes (8): _nvidia_default(), parametrize, The platform-wide NVIDIA default must not be a retired model.…, The literal fallback used when NVIDIA_DEFAULT_MODEL is unset., A retired id may still appear elsewhere (cost tables, per-role maps); what must…, The floor is only reached when discovery cannot run — which is exactly when…, TestTheDefaultIsNotDead, TestTheStaticFloorLeadsWithVerifiedIds

### Community 375 - "test_scheduler_hydration_bounded.py"
Cohesion: 0.09
...
### Community 377 - "VoiceCommandInterface"
Cohesion: 0.14
...
### Community 378 - "test_phase6_workflow.py"
Cohesion: 0.05
Nodes (64): DirectChatDoctor, Return True if the PR exists and is open or merged; False if 404., verify_pr_exists(), _append_transition(), classify_domain(), BaseModel, Enum, str (+56 more)

### Community 379 - "Performance Analysis — local-llm-server"
Cohesion: 0.08
...
### Community 381 - "LLM Router — troubleshooting"
Cohesion: 0.08
...
### Community 386 - "test_telegram_approval_e2e.py"
Cohesion: 0.12
...
### Community 387 - "test_brain_migration_writes_a_live_model.py"
Cohesion: 0.10
...
### Community 388 - "test_daily_automation_2026_08_03.py"
Cohesion: 0.11
...
### Community 389 - "test_provider_enable_disable.py"
Cohesion: 0.09
...
### Community 390 - "test_telegram_mutating_commands.py"
Cohesion: 0.08
...
### Community 393 - "webui/router.py"
Cohesion: 0.05
Nodes (40): allow_paid_brain(), get_brain_preference(), is_anthropic_model(), True only when the operator explicitly opted into a paid (Anthropic) brain.…, Return the operator's brain provider preference. Values: - ``"nvidia"`` —…, True when *model* names a paid Anthropic/Bedrock-Claude model. Covers native…, _opus_model(), Return an Opus model ID iff the operator explicitly opted into a paid brain.… (+32 more)

### Community 394 - "test_dashboard_cache.py"
Cohesion: 0.14
...
### Community 396 - "Session Handoff — 2026-06-15"
Cohesion: 0.08
...
### Community 397 - "TASK 4 — End-to-end approval-gate test"
Cohesion: 0.08
...
### Community 398 - "test_connector_registry.py"
Cohesion: 0.12
...
### Community 399 - "brain_failover.py"
Cohesion: 0.11
...
### Community 400 - "_InMemoryBackend"
Cohesion: 0.11
...
### Community 401 - "TestClassifyPlainText"
Cohesion: 0.08
...
### Community 402 - "SeoFixer"
Cohesion: 0.17
Nodes (9): _humanize_filename(), BeautifulSoup, Path, Derive readable alt text from an image path: 'img/hero-banner_2.jpg' -> 'Hero…, Applies (or proposes) automatic SEO remediations inside a repo checkout., Scan the repo, fix every enabled auto-fixable problem found., SeoFixer, _unified_diff() (+1 more)

### Community 403 - "test_service_token.py"
Cohesion: 0.08
...
### Community 407 - "TestStreamableHTTPTransport"
Cohesion: 0.13
...
### Community 409 - "Local AI Stack with Docker"
Cohesion: 0.08
...
### Community 410 - "Traffic Distribution Across Providers"
Cohesion: 0.14
...
### Community 411 - "Implementation Prompt: Rich TaskBoard + Agile Sprint Integration"
Cohesion: 0.08
...
### Community 412 - "Telegram Bot Setup"
Cohesion: 0.08
...
### Community 413 - "video_transcript.py"
Cohesion: 0.12
...
### Community 417 - "test_memory_guard.py"
Cohesion: 0.13
...
### Community 418 - "test_all_features.py"
Cohesion: 0.08
...
### Community 419 - "test_agency_fix.py"
Cohesion: 0.08
...
### Community 422 - "_status_snapshot"
Cohesion: 0.15
...
### Community 423 - "_resolve_user_github_token"
Cohesion: 0.09
Nodes (31): _DoctorCheck, _DoctorReport, get_doctor_diagnostics(), get_doctor_report(), get_public_doctor(), _in_container(), Path, Consolidated system health report: preflight checks + runtime health. Returns a… (+23 more)

### Community 424 - "Agent Governance Guide"
Cohesion: 0.09
...
### Community 425 - "The fifteen strategies"
Cohesion: 0.09
...
### Community 426 - "SetupWizardPage.js"
Cohesion: 0.13
...
### Community 428 - "implement_agent.py"
Cohesion: 0.13
Nodes (18): main(), _nvidia_candidates(), _openai_tools_to_anthropic(), Any, Safely insert an entry under ## [Unreleased] without touching the rest of the…, Convert OpenAI function-calling tool schemas to Anthropic tool schemas., Run the implementation agent loop using Claude Opus via Anthropic SDK. Returns…, Curated NVIDIA model ids, when NVIDIA is the provider that will answer. Needed… (+10 more)

### Community 429 - "PrioritizedTask"
Cohesion: 0.11
...
### Community 430 - "test_north_mini_code.py"
Cohesion: 0.09
...
### Community 432 - "WindowsServiceManager"
Cohesion: 0.18
...
### Community 433 - "analyze_quantitative"
Cohesion: 0.13
...
### Community 436 - "SyntheticDataPipeline"
Cohesion: 0.13
...
### Community 437 - "test_task_source_id_race.py"
Cohesion: 0.13
...
### Community 439 - "test_cerebras_catalogue.py"
Cohesion: 0.13
...
### Community 440 - "test_monitor_lib.py"
Cohesion: 0.11
...
### Community 442 - "test_mostly_failed_steps.py"
Cohesion: 0.12
...
### Community 444 - "HarnessEnrichment"
Cohesion: 0.14
...
### Community 445 - "classify_direct_chat_intent"
Cohesion: 0.13
...
### Community 449 - "AdaptivePermissions"
Cohesion: 0.18
...
### Community 455 - "open_phase_report"
Cohesion: 0.13
...
### Community 456 - "TestLegacyRouterCacheTTL"
Cohesion: 0.13
...
### Community 457 - "test_anthropic_refusal_fallback.py"
Cohesion: 0.19
...
### Community 458 - "test_telegram_diag_endpoint.py"
Cohesion: 0.09
...
### Community 460 - "PersistentMemoryStore"
Cohesion: 0.22
...
### Community 462 - "_ensure_tasks_source_id_unique_index"
Cohesion: 0.16
...
### Community 463 - "V3 API Migration Plan — LLM Relay Platform"
Cohesion: 0.10
...
### Community 464 - "test_chat_mode_regressions.py"
Cohesion: 0.15
...
### Community 465 - "TestAdapterMetadata"
Cohesion: 0.05
Nodes (23): _env_float(), HermesAdapter, Any, AsyncClient, TaskResult, Submit task to Hermes via its /tasks endpoint., Read a float env var, falling back to *default* on unset/garbage., Adapter for Hermes Agent — FIRST CLASS autonomous runtime. (+15 more)

### Community 466 - "AgentMessageBus"
Cohesion: 0.18
...
### Community 468 - "test_tasks_awaiting_approval_api.py"
Cohesion: 0.37
...
### Community 469 - "SQLiteStore"
Cohesion: 0.03
Nodes (57): Create a new company in SQLite., Update a company in SQLite., Delete a company and all associated data from SQLite., List companies from SQLite., Count total companies in SQLite., Reconstruct a Website from a SQLite row, preferring the full JSON blob (which…, Create a new website in SQLite. The full model is stored in ``data`` so scan…, Get a website by ID from SQLite. (+49 more)

### Community 470 - "test_local_controller.py"
Cohesion: 0.17
...
### Community 471 - "test_provider_state_durability.py"
Cohesion: 0.12
...
### Community 472 - "run_trend_analysis"
Cohesion: 0.18
...
### Community 473 - "all_provider_ids"
Cohesion: 0.08
...
### Community 476 - "Skill: modularity-review"
Cohesion: 0.10
...
### Community 477 - "Design Audit"
Cohesion: 0.10
Nodes (19): Code Quality, Color and Surfaces, Component Patterns, Content, Design Audit, Fix Priority, How This Works, Iconography (+11 more)

### Community 478 - "Findings"
Cohesion: 0.10
...
### Community 482 - "Docker AI Governance Audit — Final Report"
Cohesion: 0.10
...
### Community 483 - "1. Capability-by-capability"
Cohesion: 0.10
...
### Community 485 - "Dynamic Model Routing"
Cohesion: 0.10
...
### Community 492 - "PriorityTaskQueue"
Cohesion: 0.15
...
### Community 493 - "test_gh_brain_failover.py"
Cohesion: 0.11
...
### Community 496 - "TestBrainFailoverModelUpdates"
Cohesion: 0.12
Nodes (6): tests/test_daily_automation_2026_07_10.py — Daily automation tests…, Verify Llama 4 and Claude Sonnet 5 cross-provider aliases are registered., Verify the provider registry in brain_failover contains the 2026 model set., The rotation must equal the catalogue, which the probe keeps honest., TestBrainFailoverModelAliases, TestBrainFailoverModelUpdates

### Community 497 - "test_langfuse_agency_wide.py"
Cohesion: 0.12
...
### Community 498 - "test_tasks_cache_ttl_env.py"
Cohesion: 0.21
...
### Community 499 - "test_voice_pipeline.py"
Cohesion: 0.14
...
### Community 500 - "test_repowise_intelligence.py"
Cohesion: 0.11
...
### Community 502 - "test_brain_failover_413.py"
Cohesion: 0.13
...
### Community 503 - "_extract_tech_relevance"
Cohesion: 0.17
...
### Community 507 - "Analysis & Synthesis Instructions"
Cohesion: 0.11
Nodes (18): 1. Define the Atmosphere, 2. Map the Color Palette, 3. Establish Typography Rules, 4. Define the Hero Section, 5. Describe Component Stylings, 6. Define Layout Principles, 7. Define Responsive Rules, 8. Encode Motion Philosophy (+10 more)

### Community 508 - "Production Readiness Assessment — local-llm-server"
Cohesion: 0.11
...
### Community 510 - "TestNormalizeResponseFormat"
Cohesion: 0.10
...
### Community 511 - "Skill: fabric-patterns"
Cohesion: 0.11
Nodes (18): 1. Ensure Pattern Directory Exists, 2. List Available Patterns, 3. Retrieve a Pattern, 4. Apply a Pattern with Variables, 5. Stitch Patterns Together, 6. Create New Patterns, Acceptance Checks, Directory Structure (+10 more)

### Community 512 - "db/__init__.py"
Cohesion: 0.14
...
### Community 513 - "Admin Dashboard Guide"
Cohesion: 0.11
...
### Community 514 - "Implementation Plan"
Cohesion: 0.11
...
### Community 515 - "operational_incidents.py"
Cohesion: 0.13
Nodes (17): _diagnose_and_file(), gather_render_evidence(), get_operational_incident_tracker(), _iso_from_monotonic(), agent/operational_incidents.py — recurring operational failures, auto-…, Pull recent Render logs and summarise them for the issue body. This is the…, Attach evidence to *incident*, then hand it to the existing intake. The filing…, Current UTC wall-clock as an ISO-8601 string. (+9 more)

### Community 516 - "test_feature_maturity.py"
Cohesion: 0.14
Nodes (6): Reset the singleton (useful for testing)., reset_feature_matrix(), Tests for feature maturity / support matrix (Area B). Covers: - Matrix loads…, TestConfigOverrides, TestFeatureMatrixSingleton, TestFeaturesAPI

### Community 517 - "resolve_free_nvidia_brain"
Cohesion: 0.13
Nodes (17): livenim, Resolve the free NVIDIA NIM brain from env, or ``None`` if unconfigured.…, resolve_free_nvidia_brain(), test_resolve_free_nvidia_brain_from_env(), _live_models(), The free-brain default must be an id the endpoint actually serves. Two…, The ids the catalogue currently vouches for. Derived, not frozen: a hardcoded…, Default must be one of the live NIM namespaced IDs — never the bare name. (+9 more)

### Community 518 - "scripts/doctor.py"
Cohesion: 0.27
Nodes (17): NamedTuple, Check, check_core_deps(), check_env(), check_git(), check_mongo(), check_node(), check_ollama() (+9 more)

### Community 519 - "Delegation Plan (agent-ready work packages)"
Cohesion: 0.11
...
### Community 520 - "test_p0_roadmap_a4_a5_b2.py"
Cohesion: 0.15
...
### Community 521 - "parse_event_stream"
Cohesion: 0.09
...
### Community 524 - "test_brain_patch_service_token.py"
Cohesion: 0.18
...
### Community 525 - "TestSelfHealingInfrastructureClassification"
Cohesion: 0.19
...
### Community 526 - "test_fabric_patterns.py"
Cohesion: 0.11
...
### Community 528 - "validate_session_id"
Cohesion: 0.16
...
### Community 529 - "ErrorInterceptorMiddleware"
Cohesion: 0.19
...
### Community 533 - "Comprehensive Skill Index (By Category)"
Cohesion: 0.11
...
### Community 534 - "Agent Skill: Principal UI/UX Architect & Motion Choreographer (Awwwards-Tier)"
Cohesion: 0.11
Nodes (17): 1. Meta Information & Core Directive, 2. THE "ABSOLUTE ZERO" DIRECTIVE (STRICT ANTI-PATTERNS), 3. THE CREATIVE VARIANCE ENGINE, 4. HAPTIC MICRO-AESTHETICS (COMPONENT MASTERY), 5. MOTION CHOREOGRAPHY (FLUID DYNAMICS), 6. PERFORMANCE GUARDRAILS, 7. EXECUTION PROTOCOL, 8. PRE-OUTPUT CHECKLIST (+9 more)

### Community 535 - "Component Map"
Cohesion: 0.11
...
### Community 536 - "Architecture Overview — local-llm-server"
Cohesion: 0.11
...
### Community 537 - "Pending Activities — Implementation Playbook"
Cohesion: 0.11
...
### Community 539 - "Part A — Health Report"
Cohesion: 0.11
...
### Community 542 - "test_p0_roadmap_b3_b4_b5.py"
Cohesion: 0.20
...
### Community 544 - "_process_task_callback"
Cohesion: 0.18
...
### Community 545 - "test_company_api.py"
Cohesion: 0.11
...
### Community 546 - "TestStopSlopChecker"
Cohesion: 0.11
...
### Community 547 - "test_schedule_persistence.py"
Cohesion: 0.15
...
### Community 548 - "OperationalIncidentTracker"
Cohesion: 0.13
...
### Community 549 - "test_telegram_task_callback.py"
Cohesion: 0.12
...
### Community 550 - "test_tasks_reconciler_todo_requeue.py"
Cohesion: 0.20
...
### Community 551 - "test_telegram_webhook.py"
Cohesion: 0.14
...
### Community 552 - "handle_workflow_ide_chat"
Cohesion: 0.18
...
### Community 554 - "plan_research"
Cohesion: 0.15
Nodes (7): plan_research(), Any, field_validator, Compute the minimum sample size for a proportion estimate. Uses the standard…, Produce a structured research plan. The four Plan inputs that are typically…, _sample_size_for_proportion(), TestPlanResearch

### Community 555 - "_extract_tags"
Cohesion: 0.15
...
### Community 557 - "SKILL: Industrial Brutalism & Tactical Telemetry UI"
Cohesion: 0.12
...
### Community 558 - "Skill: data-quality-audit"
Cohesion: 0.12
...
### Community 559 - "What "Slop" Looks Like"
Cohesion: 0.12
...
### Community 560 - "local_brain_router.py"
Cohesion: 0.19
...
### Community 562 - "Section-by-Section Acceptance Criteria"
Cohesion: 0.12
...
### Community 566 - "redact_connection_url"
Cohesion: 0.17
...
### Community 567 - "kimi_bridge_provider_config"
Cohesion: 0.18
...
### Community 568 - "agent_readiness_audit.py"
Cohesion: 0.21
...
### Community 572 - "TestAListingFailureDoesNotVetoTheAnswer"
Cohesion: 0.17
...
### Community 575 - "test_health_endpoints.py"
Cohesion: 0.17
...
### Community 576 - "test_keepalive.py"
Cohesion: 0.18
...
### Community 577 - "test_openclaw_endpoints.py"
Cohesion: 0.12
...
### Community 579 - "test_skill_registry.py"
Cohesion: 0.13
...
### Community 580 - "test_agent_tools.py"
Cohesion: 0.19
...
### Community 581 - "hermes_prompt.py"
Cohesion: 0.19
...
### Community 583 - "MemoryMiddleware"
Cohesion: 0.17
...
### Community 585 - "Skill: repowise-intelligence"
Cohesion: 0.12
...
### Community 586 - "ARCHITECTURE.md — Target Architecture"
Cohesion: 0.12
...
### Community 587 - "_valid_login_state"
Cohesion: 0.24
...
### Community 588 - "Skill: repowise-intelligence"
Cohesion: 0.12
Nodes (15): 1. Graph Intelligence (Dependency Graph), 2. Git Intelligence, 3. Documentation Intelligence, 4. Decision Intelligence, Acceptance Checks, Directory Structure, Example Usage, Implementation Approach (+7 more)

### Community 589 - "The 10-Step Workflow"
Cohesion: 0.12
...
### Community 590 - "Nothing is blocked on an agent. Two things need a human."
Cohesion: 0.12
...
### Community 591 - "Contributing to local-llm-server"
Cohesion: 0.12
...
### Community 592 - "refresh_agent_built_proof.py"
Cohesion: 0.20
...
### Community 593 - "CEO Micro-Management"
Cohesion: 0.12
...
### Community 594 - "467 Brutal Audit — File-by-File Status"
Cohesion: 0.12
...
### Community 595 - "Runbook — Apply the Fast Free NVIDIA Brain to Render (TASK 2)"
Cohesion: 0.12
...
### Community 596 - "test_agent_chat_integration.py"
Cohesion: 0.23
...
### Community 601 - "test_telegram_auto_approve.py"
Cohesion: 0.23
...
### Community 602 - "ManagedAgentDreams"
Cohesion: 0.22
...
### Community 603 - "e2e/test_browser.py"
Cohesion: 0.21
...
### Community 604 - "test_agency_workflows_carry_the_failover_chain.py"
Cohesion: 0.18
...
### Community 605 - "test_autonomy_status.py"
Cohesion: 0.12
...
### Community 606 - "ai/registry.py"
Cohesion: 0.15
Nodes (17): Any, Send a chat request with automatic failover. Retry policy: 1. If ``model`` is…, all_models(), best_model_for(), get(), ModelInfo, models_by_provider(), packages/ai/registry.py — Model Registry. Centralized registry of all models… (+9 more)
...
### Community 608 - "test_local_brain_state.py"
Cohesion: 0.12
...
### Community 610 - "test_migrate_local_brain_env.py"
Cohesion: 0.38
...
### Community 611 - "test_phase5_doctor.py"
Cohesion: 0.08
...
### Community 612 - "TestBrainFailoverBackoff"
Cohesion: 0.23
...
### Community 613 - "test_refresh_agent_built_proof.py"
Cohesion: 0.12
...
### Community 614 - "test_telegram_service_webhook.py"
Cohesion: 0.18
...
### Community 616 - "test_workflow_orchestrator_scoping.py"
Cohesion: 0.18
...
### Community 618 - "CollaborationContext"
Cohesion: 0.21
...
### Community 619 - "Skill: agent-harness"
Cohesion: 0.13
...
### Community 620 - "Skill: checkpoint-strategy"
Cohesion: 0.13
...
### Community 622 - "Skill: local-ai-query"
Cohesion: 0.13
...
### Community 623 - "Skill: parallel-agents"
Cohesion: 0.13
...
### Community 624 - "Skill: parallel-worktrees"
Cohesion: 0.13
...
### Community 625 - "Design System: Taste Standard"
Cohesion: 0.13
...
### Community 627 - "Skill: user-research"
Cohesion: 0.13
...
### Community 628 - "Agency Core — Progress & Resume Log"
Cohesion: 0.13
...
### Community 629 - "Attention Mechanisms Internals"
Cohesion: 0.13
...
### Community 633 - "router/health.py"
Cohesion: 0.20
...
### Community 634 - "check_model_catalog_consistency.py"
Cohesion: 0.22
...
### Community 636 - "test_critical_flows.py"
Cohesion: 0.26
...
### Community 638 - "TestBrainConfigUpdates"
Cohesion: 0.22
...
### Community 639 - "DecisionsStoreTests"
Cohesion: 0.13
...
### Community 640 - "test_dockerfile_ships_config_dir.py"
Cohesion: 0.14
...
### Community 648 - "Skill: lr-schedule-advisor"
Cohesion: 0.14
...
### Community 652 - "Checks Performed"
Cohesion: 0.14
...
### Community 653 - "Skill: training-stability-monitor"
Cohesion: 0.14
...
### Community 654 - "test_new_features_e2e.py"
Cohesion: 0.29
...
### Community 655 - "admin_digest_router.py"
Cohesion: 0.22
...
### Community 656 - "Skill: branch-cleanup"
Cohesion: 0.14
...
### Community 657 - "Skill: perplexity — Web Research via Perplexity API"
Cohesion: 0.14
...
### Community 660 - "Quick-Note Issues Processing Summary"
Cohesion: 0.14
...
### Community 661 - "Main proxy (`proxy.py`)"
Cohesion: 0.14
...
### Community 662 - "Implementation Plan — DB-persisted, UI-switchable Brain (no redeploy)"
Cohesion: 0.14
...
### Community 665 - "Runbook: Auto-Resume After Cooldown / Interruption"
Cohesion: 0.14
...
### Community 669 - "_parse_reset_epoch"
Cohesion: 0.23
...
### Community 672 - "_resolve_push_token"
Cohesion: 0.17
...
### Community 674 - "TestAnthropicToolListCaching"
Cohesion: 0.34
...
### Community 675 - "plan_next_sprint"
Cohesion: 0.17
...
### Community 676 - "TestMCPToolsListCache"
Cohesion: 0.19
...
### Community 677 - "test_openclaw_gateway.py"
Cohesion: 0.14
...
### Community 678 - "TestDisabledReasonRendering"
Cohesion: 0.14
...
### Community 680 - "AGENTS.md — Codebase Map & Operations Reference"
Cohesion: 0.08
Nodes (22): Agent roles, AGENTS.md — Codebase Map & Operations Reference, Architecture, Claude Code subagents (cost-aware routing), Codebase map, Deployment, File-size exceptions, Further reading (+14 more)

### Community 681 - "EdgeType"
Cohesion: 0.18
...
### Community 683 - "Skill: Brain Dump"
Cohesion: 0.15
...
### Community 686 - "Skill: duplicate-thread"
Cohesion: 0.15
...
### Community 687 - "Skill: Email Triage"
Cohesion: 0.15
...
### Community 691 - "Skill: prompt-library"
Cohesion: 0.15
...
### Community 692 - "Skill: prompt-transparency"
Cohesion: 0.15
...
### Community 694 - "Skill: scope-guard"
Cohesion: 0.15
...
### Community 695 - "admin_update_task_router.py"
Cohesion: 0.22
...
### Community 697 - "Skill: graphify — Knowledge Graph Token Optimization"
Cohesion: 0.15
Nodes (12): Acceptance Checks, Claude's query protocol (use this instead of Read tool for exploration):, Graph Artifacts — What to Commit, How to Use the Graph (Token Savings Protocol), Installation (one-time per machine), Instead of reading raw files:, Key commands:, Relationship to repowise-intelligence Skill (+4 more)

### Community 698 - "Skill: platform-setup — Autonomous Agency Bootstrap"
Cohesion: 0.15
...
### Community 699 - "Device compatibility and model picks"
Cohesion: 0.15
...
### Community 700 - "Autonomy Uplift — Living Roadmap & Detailed Implementation Specs"
Cohesion: 0.15
...
### Community 701 - "OpenClaw — iOS Control of the Agency (Single-Service Free-Tier Deploy)"
Cohesion: 0.15
...
### Community 703 - "ApplyReviewAgent"
Cohesion: 0.22
...
### Community 705 - "test_doctor_service_token_check.py"
Cohesion: 0.23
...
### Community 706 - "verify_service_token"
Cohesion: 0.15
...
### Community 708 - "Agent Transparency Report"
Cohesion: 0.15
...
### Community 709 - "update_provider_policy"
Cohesion: 0.19
...
### Community 711 - "TestNoNvidiaFallbackIsRetired"
Cohesion: 0.22
...
### Community 713 - "TestTheGatewayRegistryOffersOnlyLiveModels"
Cohesion: 0.22
Nodes (6): parametrize, A sixth model source, found on 2026-08-28 while verifying a fix.…, The platform default must survive ``require_tools`` filtering. Undeclared…, Every ``fallback_model`` must name a model this registry knows. Removing the…, Checked against the catalogue that wins, not the copy that loses., TestTheGatewayRegistryOffersOnlyLiveModels

### Community 714 - "TestModelCostTableUpdates"
Cohesion: 0.26
...
### Community 715 - "TestMCPClientStructuredOutput"
Cohesion: 0.31
...
### Community 716 - "TestDecisionsBotLinks"
Cohesion: 0.21
...
### Community 717 - "test_deploy_trigger_covers_image.py"
Cohesion: 0.21
...
### Community 718 - "TestKillSwitchDurability"
Cohesion: 0.15
...
### Community 719 - "test_quick_note_engine.py"
Cohesion: 0.17
...
### Community 720 - "skill_registry.py"
Cohesion: 0.17
...
### Community 726 - "Skill: system-prompt-audit"
Cohesion: 0.17
...
### Community 727 - "Skill: task-alive-updates"
Cohesion: 0.17
...
### Community 730 - "company_api.py"
Cohesion: 0.04
Nodes (104): account_lifecycle(), AccountLifecycleResponse, auto_recommend_skills(), cancel_onboarding(), create_company(), delete_company_endpoint(), _DoctorCheck, _DoctorReport (+96 more)
...
### Community 744 - "test_task_brain_preflight.py"
Cohesion: 0.31
...
### Community 745 - "TestRouterIntegration"
Cohesion: 0.31
...
### Community 756 - "capability_registry.py"
Cohesion: 0.21
...
### Community 758 - "test_task_clarification.py"
Cohesion: 0.17
...
### Community 762 - "_extractive_compress"
Cohesion: 0.18
...
### Community 763 - "TestCompanyGraphModels"
Cohesion: 0.17
...
### Community 765 - "Skill: pro-workflow"
Cohesion: 0.18
...
### Community 768 - "Skill: resource-panel"
Cohesion: 0.18
...
### Community 769 - "Skill: sandboxed-exec"
Cohesion: 0.18
...
### Community 771 - "ECC Harness Patterns Skill"
Cohesion: 0.18
...
### Community 774 - "Stop-Slop Quality Skill"
Cohesion: 0.18
...
### Community 775 - "Agency Core — Ruthless Architecture Audit & Migration Plan"
Cohesion: 0.18
...
### Community 776 - "AUTONOMY_CHARTER.md"
Cohesion: 0.18
...
### Community 777 - "Tailored Onboarding, Editable Companies & Dynamic Roles"
Cohesion: 0.18
...
### Community 778 - "Issue #467 — Section 1: Pulled State + PR Inventory"
Cohesion: 0.18
...
### Community 779 - "Autonomy Charter — Telegram-Gated Self-Running Agency"
Cohesion: 0.18
...
### Community 780 - "Context: Agentic Agile + Portfolio Management"
Cohesion: 0.18
...
### Community 781 - "Deploy to Google Cloud Run"
Cohesion: 0.18
...
### Community 783 - "Sampling Strategies Internals"
Cohesion: 0.18
...
### Community 784 - "LLM Router — architecture"
Cohesion: 0.18
...
### Community 785 - "Killer TODO Roadmap — local-llm-server"
Cohesion: 0.18
...
### Community 786 - "NVIDIA NIM — Free Tier Setup"
Cohesion: 0.18
...
### Community 787 - "What to clean up"
Cohesion: 0.18
...
### Community 788 - "Worker Service — Operations Runbook"
Cohesion: 0.18
...
### Community 792 - "mint_access_token"
Cohesion: 0.18
...
### Community 793 - "capture_screens.py"
Cohesion: 0.25
...
### Community 795 - "build_tech_db.py"
Cohesion: 0.35
...
### Community 798 - "test_conftest_hermetic_env.py"
Cohesion: 0.18
...
### Community 800 - "test_empirical_verify.py"
Cohesion: 0.49
...
### Community 801 - "test_event_log.py"
Cohesion: 0.45
...
### Community 802 - "test_google_provider_models.py"
Cohesion: 0.18
...
### Community 805 - "Protocol: Premium Utilitarian Minimalism UI Architect"
Cohesion: 0.20
...
### Community 806 - "The 5-Step Wrap-Up Ritual"
Cohesion: 0.20
...
### Community 807 - "admin_local_brain_router.py"
Cohesion: 0.22
...
### Community 808 - "connectors_api.py"
Cohesion: 0.22
...
### Community 809 - "_normalize_tool_choice"
Cohesion: 0.31
...
### Community 810 - "Agent: Reviewer (Verifier)"
Cohesion: 0.20
...
### Community 811 - "Skill: Agentic Agile"
Cohesion: 0.20
...
### Community 812 - "Skill: browserbase-ui-test — Adversarial UI Testing"
Cohesion: 0.20
...
### Community 813 - "Skill: financial-analyst (Agentic CFO)"
Cohesion: 0.20
...
### Community 814 - "Graphiti Temporal Context Skill"
Cohesion: 0.20
...
### Community 815 - "Skill: seo-audit-report"
Cohesion: 0.20
...
### Community 816 - "ADR-008: LLMRouter — the single multi-provider routing gateway"
Cohesion: 0.20
...
### Community 818 - "467 Golden Path — Locked Implementation Order"
Cohesion: 0.20
...
### Community 819 - "Competitor Analysis — Autonomous AI Agency"
Cohesion: 0.20
...
### Community 820 - "Issue #1427: quick-note:https://github.com/bingreeky/JIT"
Cohesion: 0.20
...
### Community 821 - "LLM Router — configuration guide"
Cohesion: 0.20
...
### Community 822 - "LLM Router — provider guide"
Cohesion: 0.20
...
### Community 823 - "CI Troubleshooting Runbook"
Cohesion: 0.20
...
### Community 825 - "TestModelsEndpointAliases"
Cohesion: 0.31
...
### Community 826 - "enrich_quick_note_issues.py"
Cohesion: 0.36
...
### Community 828 - "sync_catalog_route"
Cohesion: 0.20
...
### Community 829 - "test_catalogue_probe.py"
Cohesion: 0.20
...
### Community 831 - "TestZeroAttemptDiagnostics"
Cohesion: 0.29
...
### Community 832 - "local_brain_provider_config"
Cohesion: 0.29
...
### Community 833 - "TestSessionMemory"
Cohesion: 0.20
...
### Community 834 - "test_model_catalog_guard.py"
Cohesion: 0.29
...
### Community 837 - "TestOneIdCanBelongToSeveralProviders"
Cohesion: 0.39
...
### Community 838 - "TestAnthropicPayloadStructuredOutput"
Cohesion: 0.29
...
### Community 839 - "test_workflow_api_mount.py"
Cohesion: 0.20
...
### Community 842 - "_redact_for_notification"
Cohesion: 0.24
...
### Community 844 - "_extract_workflow_relevance"
Cohesion: 0.33
...
### Community 846 - "TestPoliciesGovernanceStableClaim"
Cohesion: 0.20
...
### Community 848 - "Skill: learn-rule"
Cohesion: 0.22
...
### Community 850 - "prompts/README.md"
Cohesion: 0.22
Nodes (4): Command: /resume, References, Usage, What It Does

### Community 851 - "Skill: Agentic Portfolio Management"
Cohesion: 0.22
...
### Community 852 - "Skill: changelog-enforcer"
Cohesion: 0.22
Nodes (8): Acceptance Checks, Changelog Location, Entry Format, Examples, Hook Behaviour, Instructions, Skill: changelog-enforcer, When to Use

### Community 853 - "Skill: cowork-session (Claude Cowork)"
Cohesion: 0.22
Nodes (8): Branch, Components, Purpose, Quick Start, Session Roles, Skill: cowork-session (Claude Cowork), Testing, When to Use

### Community 854 - "Skill: video-context — read a video without watching it"
Cohesion: 0.22
...
### Community 855 - "Active Task Tracker"
Cohesion: 0.22
...
### Community 857 - "ADR 003: Multi-Agent Orchestration with Plan-Execute-Verify Loop"
Cohesion: 0.22
...
### Community 858 - "Autonomous SDLC Loop (Agency Core, repo-agnostic)"
Cohesion: 0.22
...
### Community 859 - "The 8-Step Golden Path"
Cohesion: 0.22
...
### Community 860 - "Issue #1356: quick-note:https://searchengineland.com/turn-seo-backlog-into-roadmap-485713"
Cohesion: 0.22
...
### Community 861 - "PR #634 Implementation Tracker"
Cohesion: 0.22
...
### Community 862 - "KV Cache Internals"
Cohesion: 0.22
...
### Community 863 - "Platform Controls"
Cohesion: 0.22
...
### Community 864 - "Release Procedure"
Cohesion: 0.22
...
### Community 865 - "V2.0 Modernization — Runbook"
Cohesion: 0.22
...
### Community 869 - "_FakePersistence"
Cohesion: 0.20
...
### Community 873 - "_autonomy_bg_cycle"
Cohesion: 0.28
Nodes (8): _autonomy_bg_cycle(), Background CEO cycle + task dispatch. Runs fire-and-forget., _brain_is_configured(), Best-effort, fail-open check that *some* usable LLM brain is configured.…, tests/test_server_autonomy_and_index_fixes.py — two production regressions. 1.…, Return the names ``func`` loads as globals that resolve to nothing. A…, test_autonomy_bg_cycle_has_no_undefined_globals(), _undefined_globals()

### Community 874 - "_get_current_user"
Cohesion: 0.25
...
### Community 876 - "test_scanner_deps_parity.py"
Cohesion: 0.31
...
### Community 877 - "test_serve_spa_prefixes.py"
Cohesion: 0.31
...
### Community 886 - "quality_checker.py"
Cohesion: 0.32
...
### Community 888 - "_brain_provider_status"
Cohesion: 0.25
...
### Community 889 - "TestPolicyAuthoringUiStableClaim"
Cohesion: 0.22
...
### Community 900 - "Advisor Strategy — Local Proxy Handling"
Cohesion: 0.25
...
### Community 904 - "Free NVIDIA brain + UI-controlled provider policy + no silent spend"
Cohesion: 0.25
...
### Community 905 - "Issue #362: Nvidia repo setup"
Cohesion: 0.25
...
### Community 906 - "Issue #364: quick-note:https://www.marktechpost.com/2026/06/01/meet-memory-os-a-6-layer-open-source-memory-stack-built-on-top-of-hermes-agent/"
Cohesion: 0.25
...
### Community 907 - "Issue #378: quick-note:https://www.marktechpost.com/2026/06/02/tinyfish-launches-bigset-an-open-source-multi-agent-system-that-builds-structured-live-datasets-from-plain-english-descriptions/"
Cohesion: 0.25
...
### Community 908 - "Issue #379: quick-note:https://searchengineland.com/schema-markup-optimize-agentic-web-479080"
Cohesion: 0.25
...
### Community 909 - "Issue #380: quick-note:https://cursor.com/blog/cloud-agent-lessons"
Cohesion: 0.25
...
### Community 910 - "Issue #381: quick-note:https://www.xda-developers.com/claude-code-with-opus-48-is-expensive-but-i-made-it-efficient-with-my-local-ai-workflow/"
Cohesion: 0.25
...
### Community 911 - "Issue #382: quick-note:https://claude.com/blog/how-coderabbit-used-claude-to-build-an-agent-orchestration-system"
Cohesion: 0.25
...
### Community 912 - "Issue #383: quick-note:https://www.marktechpost.com/2026/05/29/hexo-labs-open-sources-sia-a-self-improving-agent-that-updates-both-the-harness-and-the-model-weights/"
Cohesion: 0.25
...
### Community 913 - "Issue #416: feat: Self-hosted Codebuff (freebuff) on free NVIDIA models + Telegram bot phone control"
Cohesion: 0.25
...
### Community 914 - "Issue #485: [Trend Digest] Week of 2026-06-08"
Cohesion: 0.25
...
### Community 915 - "Issue #488: quick-note:https://github.com/cookiy-ai/user-research-skill"
Cohesion: 0.25
...
### Community 916 - "Issue #491: Implement whatever is necessary from https://github.com/BehiSecc/awesome-claude-skills"
Cohesion: 0.25
...
### Community 917 - "Issue #493: Use the https://github.com/mvanhorn/last30days-skill skill to get the trend updated"
Cohesion: 0.25
...
### Community 918 - "Issue #495: Read https://www.anthropic.com/news/claude-fable-5-mythos-5 and understand if mythos or fable can be added to the repo"
Cohesion: 0.25
...
### Community 919 - "Issue #504: EPIC: Autonomy hardening — live-verified defects 2026-06-10"
Cohesion: 0.25
...
### Community 920 - "Issue #581: Sprint tracker: pending work after brand rename + mobile-first pass"
Cohesion: 0.25
...
### Community 922 - "Issue #657: quick-note:https://github.com/earendil-works/pi"
Cohesion: 0.25
...
### Community 923 - "Issue #659: quick-note:https://github.com/nex-agi/Nex-N2"
Cohesion: 0.25
...
### Community 924 - "Issue #660: quick-note:https://github.com/getsentry/sentry-for-ai"
Cohesion: 0.25
...
### Community 925 - "Issue #661: quick-note:https://github.com/XiaomiMiMo/MiMo-Code"
Cohesion: 0.25
...
### Community 926 - "Issue #664: quick-note:https://github.com/Grominet95/jarvis-OS"
Cohesion: 0.25
...
### Community 927 - "Issue #666: quick-note:https://github.com/porokka/jarvis-os"
Cohesion: 0.25
...
### Community 928 - "Issue #670: quick-note:https://github.com/perplexityai/bumblebee"
Cohesion: 0.25
...
### Community 929 - "Issue #672: quick-note:https://github.com/Chachamaru127/claude-code-harness"
Cohesion: 0.25
...
### Community 930 - "Issue #676: quick-note:https://github.com/WeiboAI/VibeThinker"
Cohesion: 0.25
...
### Community 931 - "Issue #820: quick-note:https://github.com/cobusgreyling/loop-engineering"
Cohesion: 0.25
...
### Community 932 - "Positional Encoding Internals"
Cohesion: 0.25
...
### Community 933 - "TOP 6 — Highest-ROI Items (Validated by Opus Research Agent)"
Cohesion: 0.25
...
### Community 934 - "SECTION A — Agent Efficiency (Hermes / AOS / MYT)"
Cohesion: 0.25
...
### Community 935 - "SECTION C — Direct Chat Improvements (CBF / HRM)"
Cohesion: 0.25
...
### Community 936 - "Runbook — Instance Activation"
Cohesion: 0.25
...
### Community 937 - "Continual Harness (`agent/harness_spec.py`)"
Cohesion: 0.25
...
### Community 938 - "Prime Agent Runtime"
Cohesion: 0.25
...
### Community 941 - "security_fix_agent.py"
Cohesion: 0.46
...
### Community 952 - "TestItIsNotBuiltForOneVendor"
Cohesion: 0.25
...
### Community 953 - "test_compose_and_coordinate_api.py"
Cohesion: 0.36
...
### Community 954 - "test_generate_context_standing_instructions.py"
Cohesion: 0.32
...
### Community 955 - "test_local_brain_router_smoke.py"
Cohesion: 0.25
...
### Community 958 - "test_provider_models_db_outage.py"
Cohesion: 0.25
...
### Community 962 - "TOOLS.md — Available Tools for AI Agents"
Cohesion: 0.25
...
### Community 963 - "CLAUDE.md — agent/"
Cohesion: 0.29
Nodes (6): Adding a new tool, CLAUDE.md — agent/, Security surface, Skills worth invoking here, Testing, What this package does

### Community 964 - "OperationalIncident"
Cohesion: 0.36
Nodes (8): _format_incident(), OperationalIncident, One failure mode that recurred often enough to warrant diagnosis., Build the issue body: what recurred, plus the gathered evidence., The in-process view is authoritative — it needs no external service., test_incident_body_names_the_stuck_phase_when_evidence_has_one(), test_incident_body_says_so_when_render_evidence_is_missing(), test_the_incident_body_leads_with_the_in_process_phase()

### Community 966 - "Full-Output Enforcement"
Cohesion: 0.29
Nodes (6): Banned Output Patterns, Baseline, Execution Process, Full-Output Enforcement, Handling Long Outputs, Quick Check

### Community 967 - "summarise.sh"
Cohesion: 0.48
Nodes (5): bottom(), divider(), row(), summarise.sh script, top()

### Community 968 - "updater.py"
Cohesion: 0.43
...
### Community 969 - "platform_controls_router.py"
Cohesion: 0.10
...
### Community 973 - "Changelog"
Cohesion: 0.29
Nodes (7): Added, Changed, Changelog, Fixed, Maintenance, Removed, Security

### Community 974 - "AI Engineering Insights Skill"
Cohesion: 0.29
...
### Community 988 - "claude-mem Plugin — Persistent Memory for All Sessions"
Cohesion: 0.29
...
### Community 989 - "Implementation plan + TO-DO (check off as you go)"
Cohesion: 0.29
...
### Community 992 - "Cloudflare = the real working app"
Cohesion: 0.29
...
### Community 993 - "Agent Autonomy Roadmap"
Cohesion: 0.25
...
### Community 994 - "Feature Maturity / Support Matrix"
Cohesion: 0.25
...
### Community 1002 - "check_changelog_parity.py"
Cohesion: 0.43
...
### Community 1003 - "check_doc_images.py"
Cohesion: 0.48
...
### Community 1007 - "test_daily_2026_06_14.py"
Cohesion: 0.38
...
### Community 1008 - "TestAgentRunnerExecution"
Cohesion: 0.33
...
### Community 1011 - "TestGithubTokenSQLiteRegression"
Cohesion: 0.38
...
### Community 1012 - "TestReasonsAreActionable"
Cohesion: 0.29
...
### Community 1013 - "TestProvidersScreen"
Cohesion: 0.43
...
### Community 1018 - "InitiativeProgress"
Cohesion: 0.33
...
### Community 1019 - "openclaw_mobile_ui"
Cohesion: 0.33
...
### Community 1034 - "5. The five autonomous loops"
Cohesion: 0.33
...
### Community 1035 - "Master Goal Prompt — Autonomous Agency CEO"
Cohesion: 0.33
...
### Community 1036 - "Agency Core — Operational Knowledge (verified live, 2026-06-10/11)"
Cohesion: 0.33
...
### Community 1037 - "Pre-Mortem Analysis: Agency Core autonomy story (Cloudflare deployment)"
Cohesion: 0.33
...
### Community 1038 - "SECTION B — NVIDIA / Cloud Model Integration (Nemotron / NVD)"
Cohesion: 0.33
...
### Community 1039 - "SECTION D — Deployment & Infrastructure (CHM / NVD)"
Cohesion: 0.33
...
### Community 1040 - "test_seo_audit_pending_expiry.py"
Cohesion: 0.43
...
### Community 1044 - "apply_phase1_changes.py"
Cohesion: 0.33
...
### Community 1048 - "TestSupportMatrixDocsSync"
Cohesion: 0.29
...
### Community 1056 - "TestDisabledProvidersAreNotFalselyReportedUnreachable"
Cohesion: 0.33
...
### Community 1077 - "SECTION E — Autonomy & Self-Healing (AOS / MYT / ECC)"
Cohesion: 0.40
...
### Community 1078 - "SECTION F — Developer Experience (CBF / ECC)"
Cohesion: 0.40
...
### Community 1081 - "TestDirectChatAgentExecution"
Cohesion: 0.33
...
### Community 1082 - "TestWorkflowIntegration"
Cohesion: 0.33
...
### Community 1083 - "knowledgeGraphTab.test.js"
Cohesion: 0.40
Nodes (4): { describe, test, expect }, fs, path, src

### Community 1084 - "loginFlowNoTimeout.test.js"
Cohesion: 0.40
Nodes (4): apiSource, { describe, test, expect }, fs, path

### Community 1085 - "test_company_stale_id_recovery.test.js"
Cohesion: 0.40
Nodes (4): { describe, test, expect }, fs, path, src

### Community 1086 - "worker_no_cache.test.js"
Cohesion: 0.40
Nodes (4): { describe, test, expect }, fs, path, workerSource

### Community 1087 - "governance/__init__.py"
Cohesion: 0.40
Nodes (3): __getattr__(), Any, packages/governance — agent identity, policy, approvals, audit, sandboxes. The…

### Community 1088 - "inspect-agent-runtime.sh"
Cohesion: 0.60
Nodes (3): fail(), inspect-agent-runtime.sh script, usage()

### Community 1089 - "Prompt Library Changelog"
Cohesion: 0.40
Nodes (4): Added, Format, Prompt Library Changelog, [Unreleased]

### Community 1090 - "_add_colibri_shim_changelog_entry.py"
Cohesion: 0.50
...
### Community 1091 - "build_llama_cpp.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), W(), Warn()

### Community 1092 - "download_glm52_weights.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), Warn(), W()

### Community 1093 - "download_glm52_weights.sh script"
Cohesion: 0.70
Nodes (4): download_glm52_weights.sh script, fail(), ok(), warn()

### Community 1094 - "_fetch_pytest_failures.py"
Cohesion: 0.50
...
### Community 1095 - "setup_colibri.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), Warn(), W()

### Community 1096 - "setup_colibri.sh script"
Cohesion: 0.70
Nodes (4): setup_colibri.sh script, fail(), ok(), warn()

### Community 1097 - "status_colibri_server.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), W(), Warn()

### Community 1098 - "start_tunnel.py"
Cohesion: 0.50
...
### Community 1102 - "nvidia_live_test.py"
Cohesion: 0.40
...
### Community 1104 - "test_agent_runtime_wrapper.py"
Cohesion: 0.70
...
### Community 1106 - "TestNoKeyEverReachesTheLog"
Cohesion: 0.40
...
### Community 1107 - "TestTheProbeIdentifiesItself"
Cohesion: 0.40
...
### Community 1112 - "TestModelRoleSeparation"
Cohesion: 0.40
...
### Community 1125 - "cost_for_tokens"
Cohesion: 0.50
...
### Community 1146 - "github"
Cohesion: 0.50
Nodes (3): github, enabled, silent

### Community 1171 - "test_the_reserve_is_bounded_when_read_from_the_environment"
Cohesion: 0.67
...
- **3521 isolated node(s):** `duplicate.sh script`, `heartbeat.sh script`, `redact_secrets.sh script`, `docker`, `RENDER_API_KEY` (+3516 more)
  These have ≤1 connection - possible missing edges or undocumented components. (Counts symbols only; 13422 node(s) total have ≤1 connection when file, concept and rationale nodes are included.)
- **105 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `_fixture()` connect `_fixture` to `test_feature_maturity.py`, `test_llm_router_strategies.py`, `BrainConfig`, `parse_event_stream`, `test_brain_patch_service_token.py`, `test_llm_router_resilience.py`, `AgentJobManager`, `PolicyEngine`, `_Recorder`, `test_unit8_model_catalog.py`, `test_llm_router_queue_cache.py`, `test_task_store_fails_loud_in_production.py`, `Agency`, `TaskStatus`, `E2BSandboxSession`, `Task`, `services/seo_audit.py`, `AgentRunner`, `test_company_api.py`, `test_failover_client_shared.py`, `WorkflowRun`, `OperationalIncidentTracker`, `resolve_active_brain`, `test_tasks_reconciler_todo_requeue.py`, `test_telegram_task_callback.py`, `ImprovementLoop`, `test_agent_tool_governance.py`, `test_telegram_webhook.py`, `direct_chat.py`, `BrainWatchdog`, `test_sam_livekit.py`, `PrimeAgentAdapter`, `UserRole`, `SelfHealingAgent`, `test_model_router.py`, `test_sam_voice.py`, `services/background.py`, `AgentSwarm`, `reset_kv_state`, `facade.py`, `ChatHistoryStore`, `test_openclaw_endpoints.py`, `TaskSpec`, `test_webui_provider_priority.py`, `ResearchTask`, `claim`, `seo_api.py`, `validate_policy_text`, `TestClient`, `test_ai_insights.py`, `SQLiteStore`, `routed`, `test_procedural_memory.py`, `test_telegram_auto_approve.py`, `config.py`, `e2e/test_browser.py`, `test_autonomy_status.py`, `TestHarnessAdapter`, `test_startup_warmup.py`, `test_local_brain_state.py`, `models/company_graph.py`, `test_phase5_doctor.py`, `KeyStore`, `_clean_phases`, `test_refresh_agent_built_proof.py`, `test_telegram_service_webhook.py`, `test_knowledge_sync.py`, `models/seo_audit.py`, `ArtifactStore`, `ProviderConfig`, `test_context_rulebook.py`, `resolve_e2b_config`, `run_task`, `test_new_features_e2e.py`, `timedelta`, `test_kimi_bridge_server.py`, `test_issue_intake.py`, `_step`, `BackgroundAgent`, `test_trend_watcher.py`, `.on_task_complete`, `_resolve_push_token`, `.run`, `MCPClient`, `test_openclaw_gateway.py`, `clear_cooldowns`, `test_ceo_router.py`, `AuditLog`, `test_telegram_freebuff.py`, `OllamaCircuitBreaker`, `_job_text`, `CEOLedger`, `test_doctor_service_token_check.py`, `_Budget`, `test_features_api.py`, `test_video_transcript.py`, `test_platform_controls.py`, `SchedulerStore`, `NotificationDispatcher`, `test_process_quick_note_workflow.py`, `nvidia_models.py`, `test_portfolio_intake.py`, `WorkflowRun`, `test_e2b_data_flow.py`, `test_task_brain_preflight.py`, `TestEstimateTokensForMessages`, `test_agile_api.py`, `test_app_settings.py`, `TestClient`, `_resolve_brain_provider`, `test_task_clarification.py`, `test_llm_router_disabled.py`, `test_control_plane_api.py`, `test_daily_2026_07_27.py`, `test_persistent_memory.py`, `SecurityScanner`, `api_keys_for`, `test_llm_router_e2e.py`, `capture_screens.py`, `test_freebuff_bot.py`, `OutputFilter`, `E2BAdapter`, `test_rate_limiter.py`, `test_nvidia_model_discovery.py`, `test_catalogue_probe.py`, `test_mcp_governance.py`, `session_retro.py`, `TestMongoGate`, `test_colibri_brain_shim.py`, `OrchestratorCheckpointStore`, `analyze_page`, `model_router.py`, `OrchestratorQueue`, `test_purge_backlog.py`, `ContextPruner`, `test_regression.py`, `test_agent_scripts_share_one_model_list.py`, `_start_ceo_agency`, `test_crispy_burn_in.py`, `test_skill_registry_boot_refresh.py`, `traffic_director.py`, `model_discovery.py`, `isolated_telegram_config`, `TestSwarmRoleRouting`, `test_scheduler_hydration_bounded.py`, `test_provider_enable_disable.py`, `_undeclared`, `webui/router.py`, `test_dashboard_cache.py`, `test_service_token.py`, `test_harness_spec.py`, `test_agency_fix.py`, `_resolve_user_github_token`, `TestTheWorkflowIsSafeAndReadOnly`, `test_monitor_lib.py`, `test_v4_api.py`, `test_ping.py`, `platform_controls_router.py`, `test_telegram_diag_endpoint.py`, `test_provider_state_durability.py`, `client`, `test_gh_brain_failover.py`, `test_voice_pipeline.py`, `test_brain_failover_413.py`, `test_runtimes_health_endpoint.py`, `cost_tracker.py`, `TestNormalizeResponseFormat`?**
  _High betweenness centrality (0.107) - this node is a cross-community bridge._
- **Why does `AgentRunner` connect `AgentRunner` to `backend/server.py`, `CEODispatcher`, `TaskResult`, `proxy.py`, `test_autonomous_agency_e2e.py`, `webui/router.py`, `test_governance_api.py`, `AgentJobManager`, `PolicyEngine`, `test_governance_sandbox.py`, `ReactScratchpad`, `BackgroundAgent`, `E2BSandboxSession`, `E2BAdapter`, `_resolve_push_token`, `ContextManager`, `MultiAgentSwarm`, `.run`, `loop.py`, `test_failover_client_shared.py`, `WorkflowRun`, `test_empirical_verify.py`, `MCPClient`, `test_agent_tool_governance.py`, `Specialist`, `direct_chat.py`, `WorkspaceTools`, `StuckDetector`, `TestAgentLoopMCPIntegration`, `test_daily_automation_2026_07_11.py`, `workflow_orchestrator.py`, `TokenBudget`, `test_agent_chat_integration.py`, `LocalWorkspace`, `ContextPruner`, `InternalAgentAdapter`, `FreeBuffAgent`, `UserMemoryStore`, `TestAgentRunnerExecution`, `GitHubTools`, `test_brain_failover_413.py`, `AdaptiveHalter`?**
  _High betweenness centrality (0.035) - this node is a cross-community bridge._
- **Why does `ProviderRouter` connect `ProviderRouter` to `backend/server.py`, `is_anthropic_base_url`, `test_all_providers_discovery.py`, `test_bedrock_live.py`, `test_bedrock_provider.py`, `Provider`, `clear_cooldowns`, `direct_chat.py`, `implement_agent.py`, `kimi_bridge_provider_config`, `NvidiaProvider`, `test_colibri_brain_shim.py`, `TestAnthropicPayloadStructuredOutput`, `TestLegacyRouterCacheTTL`, `test_anthropic_refusal_fallback.py`, `test_chat_mode_regressions.py`, `TestLegacyRouterServerFallback`, `_payload`, `TrafficDirector`, `TestRouterIntegration`, `ProviderConfig`, `failover_client.py`?**
