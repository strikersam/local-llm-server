...
- **Remote admin API** — JSON endpoints for programmatic management (+ optional static frontend)
...
- **Remote admin frontend** (`remote-admin/`) — static site deployable anywhere
...
├── remote-admin/                 # Optional static admin frontend
