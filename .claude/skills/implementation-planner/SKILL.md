...
1. Read the relevant module `CLAUDE.md` if one exists.
...
4. Update `.claude/state/agent-state.json` with completed steps.
...
4. If blocked, write the blocker to `.claude/state/NEXT_ACTION.md` and stop cleanly.
